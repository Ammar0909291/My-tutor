...
| english | 216 | 206 | 205/216 through Batch 26 (full per-batch narrative in git commit messages and prior revisions of this file), plus Batch 27 (1, autonomous /loop, level-27 frontier BATCH COMPLETE: `eng.composition.academic-writing-conventions`) — see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md` for the live frontier; 10 concepts remain |
