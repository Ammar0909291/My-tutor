...
| english | 216 | 209 | 206/216 through Batch 27 (full per-batch narrative in git commit messages and prior revisions of this file), plus Batch 28 (3, autonomous /loop, level-28 frontier BATCH COMPLETE: `eng.composition.plagiarism-and-citation-ethics`, `eng.composition.editing-for-style`, `eng.communication.academic-writing-advanced`) — see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md` for the live frontier; 7 concepts remain |
