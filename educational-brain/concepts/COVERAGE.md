...
| english | 216 | 197 | 106/216 authored across ~46+ batches tracked via commit messages plus 7 concepts reconciled in from a parallel feature branch 2026-08-11 plus Batch 10 (4), Batch 11 (5), Batch 12 (9 total across 3 parts, autonomous /loop, BATCH COMPLETE: `eng.listening.following-instructions`, `eng.listening.note-taking-while-listening`, `eng.linguistics.phonology-intro`, `eng.linguistics.morphology-intro`, `eng.reading.close-reading`, `eng.speaking.asking-and-answering-questions`, `eng.speaking.non-verbal-communication`, `eng.speaking.storytelling-orally`, `eng.writing.paragraph-structure`), Batch 13 (7, autonomous /loop, level-13 frontier BATCH COMPLETE: `eng.linguistics.historical-linguistics-intro`, `eng.linguistics.syntax-theory-intro`, `eng.listening.listening-comprehension-strategies`, `eng.literature.narrative-elements`, `eng.reading.critical-reading`, `eng.speaking.discussion-skills`, `eng.writing.topic-sentences`), Batch 14 (12, autonomous /loop, level-14 frontier BATCH COMPLETE: `eng.reading.evaluating-sources`, `eng.writing.supporting-details`, `eng.listening.critical-listening`, `eng.speaking.public-speaking-basics`, `eng.literature.plot-structure`, `eng.literature.character-development`, `eng.literature.setting-and-atmosphere`, `eng.literature.point-of-view`, `eng.literature.drama-basics`, `eng.linguistics.semantics-intro`, `eng.linguistics.language-families`, `eng.linguistics.language-acquisition-intro`), Batch 15 (10, autonomous /loop, level-15 frontier BATCH COMPLETE: `eng.reading.reading-across-genres`, `eng.writing.transitions-and-cohesion`, `eng.speaking.presentation-skills`, `eng.literature.theme-and-message`, `eng.literature.foreshadowing-and-suspense`, `eng.literature.dramatic-structure`, `eng.literature.prose-fiction`, `eng.linguistics.pragmatics-intro`, `eng.linguistics.psycholinguistics-intro`, `eng.communication.media-literacy`), Batch 16 (9, autonomous /loop, level-16 frontier BATCH COMPLETE: `eng.writing.narrative-writing`, `eng.writing.descriptive-writing`, `eng.writing.expository-writing`, `eng.writing.persuasive-writing-basics`, `eng.speaking.debate-skills`, `eng.literature.literary-devices-overview`, `eng.literature.prose-nonfiction`, `eng.linguistics.discourse-analysis-intro`, `eng.linguistics.sociolinguistics-intro`), Batch 17 (10, autonomous /loop, level-17 frontier BATCH COMPLETE: `eng.writing.the-writing-process`, `eng.writing.creative-writing-forms`, `eng.literature.metaphor-and-simile`, `eng.literature.irony`, `eng.literature.poetry-basics`, `eng.linguistics.applied-linguistics-intro`, `eng.linguistics.dialectology`, `eng.linguistics.corpus-linguistics-intro`, `eng.communication.discourse-markers-advanced`, `eng.communication.cross-cultural-communication`), Batch 18 (7, autonomous /loop, level-18 frontier BATCH COMPLETE: `eng.writing.outlining-and-planning`, `eng.literature.symbolism`, `eng.literature.imagery`, `eng.literature.poetic-forms`, `eng.literature.literary-genres-overview`, `eng.linguistics.bilingualism-and-multilingualism`, `eng.linguistics.computational-linguistics-intro`), Batch 19 (5, autonomous /loop, level-19 frontier BATCH COMPLETE: `eng.writing.drafting`, `eng.literature.meter-and-rhyme`, `eng.literature.short-story-study`, `eng.literature.literary-periods-survey`, `eng.linguistics.translation-studies-intro`), Batch 20 (3, autonomous /loop, level-20 frontier BATCH COMPLETE: `eng.writing.revising-for-content`, `eng.literature.novel-study`, `eng.literature.literary-criticism-intro`), Batch 21 (3, autonomous /loop, level-21 frontier BATCH COMPLETE: `eng.writing.editing-and-proofreading`, `eng.literature.comparative-literature-intro`, `eng.writing.essay-structure` — the last of these a major topological hub unlocking the entire remaining `eng.composition.*`/`eng.communication.*` chain), Batch 22 (2, autonomous /loop, level-22 frontier BATCH COMPLETE: `eng.writing.thesis-statements`, `eng.composition.audience-and-purpose` — the first two nodes of the newly-unlocked composition chain), Batch 23 (3, autonomous /loop, level-23 frontier BATCH COMPLETE: `eng.writing.citations-and-referencing`, `eng.composition.claim-evidence-reasoning`, `eng.composition.rhetorical-appeals`), plus Batch 24 (2, autonomous /loop, level-24 frontier BATCH COMPLETE: `eng.composition.argumentation-basics`, `eng.composition.rhetorical-devices`) — this row was stale at 6 since 2026-08-04; see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md`'s reconciliation notes for the full audit; per-batch narrative for the pre-reconciliation history lives in git commit messages, not here |
