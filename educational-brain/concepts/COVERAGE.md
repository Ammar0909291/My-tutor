...
| english | 216 | 201 | 197/216 through Batch 24 (full per-batch narrative in git commit messages and prior revisions of this file), plus Batch 25 (4, autonomous /loop, level-25 frontier BATCH COMPLETE: `eng.composition.counterargument-and-rebuttal`, `eng.composition.logical-fallacies`, `eng.composition.figurative-language-in-composition`, `eng.composition.rhetorical-analysis`) — see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md` for the live frontier; 15 concepts remain |
