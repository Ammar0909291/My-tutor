...
| english | 216 | 205 | 201/216 through Batch 25 (full per-batch narrative in git commit messages and prior revisions of this file), plus Batch 26 (4, autonomous /loop, level-26 frontier BATCH COMPLETE: `eng.composition.style-voice-and-tone`, `eng.composition.persuasive-techniques`, `eng.composition.comparative-essay-writing`, `eng.composition.research-paper-writing`) — see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md` for the live frontier; 11 concepts remain |
