...
| english | 216 | 118 | 106/216 authored across ~46+ batches tracked via commit messages (phonics/phonetics/vocab/grammar domains complete, `eng.reading.*` in progress through `text-structure`) plus 7 concepts reconciled in from a parallel feature branch 2026-08-11 plus Batch 10: `eng.listening.listening-for-detail`, `eng.speaking.conversation-skills`, `eng.reading.predicting-and-confirming`, `eng.reading.authors-purpose-and-tone` plus Batch 11: `eng.communication.digital-communication`, `eng.reading.compare-and-contrast-texts`, `eng.reading.genre-recognition`, `eng.writing.sentence-writing`, `eng.linguistics.what-is-linguistics` plus Batch 12 part 1 (2026-08-11, autonomous /loop): `eng.listening.following-instructions`, `eng.listening.note-taking-while-listening`, `eng.linguistics.phonology-intro` — this row was stale at 6 since 2026-08-04; see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md`'s reconciliation notes for the full audit; per-batch narrative for the pre-reconciliation history lives in git commit messages, not here |
