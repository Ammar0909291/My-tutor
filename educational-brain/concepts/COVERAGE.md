...
| english | 216 | 212 | 209/216 through Batch 28 (full per-batch narrative in git commit messages and prior revisions of this file), plus Batch 29 (3, autonomous /loop, level-29 frontier BATCH COMPLETE: `eng.communication.research-methodology-writing`, `eng.communication.technical-writing`, `eng.communication.business-writing`) — see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md` for the live frontier; only 4 concepts remain |
