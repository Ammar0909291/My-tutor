...
| english | 216 | 131 | 106/216 authored across ~46+ batches tracked via commit messages plus 7 concepts reconciled in from a parallel feature branch 2026-08-11 plus Batch 10 (4), Batch 11 (5), Batch 12 (9 total across 3 parts, autonomous /loop, BATCH COMPLETE: `eng.listening.following-instructions`, `eng.listening.note-taking-while-listening`, `eng.linguistics.phonology-intro`, `eng.linguistics.morphology-intro`, `eng.reading.close-reading`, `eng.speaking.asking-and-answering-questions`, `eng.speaking.non-verbal-communication`, `eng.speaking.storytelling-orally`, `eng.writing.paragraph-structure`), plus Batch 13 (7, autonomous /loop, level-13 frontier BATCH COMPLETE: `eng.linguistics.historical-linguistics-intro`, `eng.linguistics.syntax-theory-intro`, `eng.listening.listening-comprehension-strategies`, `eng.literature.narrative-elements`, `eng.reading.critical-reading`, `eng.speaking.discussion-skills`, `eng.writing.topic-sentences`) — this row was stale at 6 since 2026-08-04; see `ROADMAP.md` §6 and `AUTHORING_QUEUE.md`'s reconciliation notes for the full audit; per-batch narrative for the pre-reconciliation history lives in git commit messages, not here |
