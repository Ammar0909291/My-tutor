...
| Concepts with an Educational Brain entry | **496** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,136** |
| Remaining | **639** |
| Completion percentage | **64.00%** |

*(Recomputed programmatically 2026-09-13, after Batch 69 (2 concepts:
...
math.trig, math.seq — the last certified 2026-09-13 in Batch 67); math.disc the one active
front as of Batch 69 (math.calc PARKED, only `change-of-variables`
remains, blocked on unauthored `math.linalg.determinant`; math.graph PARKED since Batch 65;
math.linalg newly has 1 candidate ready, `math.linalg.vector`, per Batch 69's fresh
all-domain frontier check — not yet selected), 496 of 908. The eight certified
