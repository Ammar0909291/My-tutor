...
| Concepts with an Educational Brain entry | **285** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **925** |
| Remaining | **850** |
| Completion percentage | **52.11%** |
...
(3 concepts), Wave 9 (4 concepts), and Wave 10 (1 concept) batches
together brought mathematics from 257 to 285. Cross-checked: 0 orphan
...
|---|---|---|---|---|---|
| mathematics | 908 | 285 | 31.39% | `math.found.mathematical-thinking` | **Yes** |
...
Four domains certified plus math.alg in progress, 285 of 908. The four certified domains are the
graph's foundation layer; every remaining domain draws on at least one of
them, so the prerequisite debt for the remaining 623 concepts is now
