...
| Concepts with an Educational Brain entry | **431** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,071** |
| Remaining | **704** |
| Completion percentage | **60.34%** |
...
brought mathematics from 257 to 431.
...
|---|---|---|---|---|---|
| mathematics | 908 | 431 | 47.47% | `math.found.mathematical-thinking` | **Yes** |
