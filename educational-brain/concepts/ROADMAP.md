...
| Concepts with an Educational Brain entry | **375** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,015** |
| Remaining | **760** |
| Completion percentage | **57.13%** |
...
and Batch 37 (4 more `math.calc` concepts — `continuity-types`, `ivt`,
`derivative-intro`, `squeeze-theorem`) together brought mathematics from
257 to 375.
...
|---|---|---|---|---|---|
| mathematics | 908 | 375 | 41.30% | `math.found.mathematical-thinking` | **Yes** |
...
375 of 908. The six certified domains are the graph's
...
(`derivative-definition`, `parametric-curves`, `riemann-sums`).
