...
`math.seq.series`, `math.seq.convergent`) brought mathematics from 434 to 438.
...
|---|---|---|---|---|---|
| mathematics | 908 | 438 | 48.24% | `math.found.mathematical-thinking` | **Yes** |
