...
| Concepts with an Educational Brain entry | **421** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,061** |
| Remaining | **714** |
| Completion percentage | **59.77%** |
...
zero-discrepancy batch) together brought mathematics from 257 to 421.
...
|---|---|---|---|---|---|
| mathematics | 908 | 421 | 46.37% | `math.found.mathematical-thinking` | **Yes** |
