...
| Concepts with an Educational Brain entry | **490** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,130** |
| Remaining | **645** |
| Completion percentage | **63.66%** |

*(Recomputed programmatically 2026-09-13, after Batch 67 (4 concepts:
`math.seq.absolute-convergence`, `math.seq.integral-test`, `math.seq.ratio-test`,
`math.seq.root-test` — authored ALL 4 remaining math.seq concepts, reaching **math.seq
21/21 — DOMAIN CERTIFIED**, the eighth domain, and reopening math.calc's frontier via
`ratio-test`, brought mathematics from 486 to 490), mid-way through a dedicated
...
math.trig, math.seq — the last certified 2026-09-13 in Batch 67); math.disc/math.calc the two
active fronts as of Batch 67 (math.calc REOPENED this same batch via `math.seq.ratio-test`;
math.graph PARKED since Batch 65), 490 of 908. The eight certified
