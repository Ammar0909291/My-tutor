...
| Concepts with an Educational Brain entry | **378** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,018** |
| Remaining | **757** |
| Completion percentage | **57.35%** |
...
`derivative-intro`, `squeeze-theorem`), and Batch 38 (the final 3
topologically-ready `math.calc` concepts — `derivative-definition`,
`parametric-curves`, `riemann-sums`) together brought mathematics from
257 to 378.
...
|---|---|---|---|---|---|
| mathematics | 908 | 378 | 41.63% | `math.found.mathematical-thinking` | **Yes** |
...
378 of 908. The six certified domains are the graph's
...
every concept authored. A fresh frontier check after Batch 38 remains to be run in the
next batch.
