...
| Concepts with an Educational Brain entry | **462** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,102** |
| Remaining | **673** |
| Completion percentage | **62.08%** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 462 | 50.88% | `math.found.mathematical-thinking` | **Yes** |
