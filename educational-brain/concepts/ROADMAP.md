...
| Concepts with an Educational Brain entry | **423** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,063** |
| Remaining | **712** |
| Completion percentage | **59.89%** |
...
zero-discrepancy batch) together brought mathematics from 257 to 423.
...
|---|---|---|---|---|---|
| mathematics | 908 | 423 | 46.59% | `math.found.mathematical-thinking` | **Yes** |
