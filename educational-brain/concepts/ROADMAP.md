...
| Concepts with an Educational Brain entry | **524** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,164** |
| Remaining | **611** |
| Completion percentage | **65.58%** |

*(Recomputed programmatically 2026-09-13, after Batch 77 (4 concepts:
...
|---|---|---|---|---|---|
| mathematics | 908 | 524 | 57.71% | `math.found.mathematical-thinking` | **Yes** |
...
| `math.linalg` | 22/61 | **Batch 77 (4, `augmented-matrix`/`cofactor-expansion`/`cramer-rule`/
