...
| Concepts with an Educational Brain entry | **406** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,046** |
| Remaining | **729** |
| Completion percentage | **58.93%** |
...
second consecutive all-4-zero-discrepancy batch), and Batch 45 (4 more
`math.calc` concepts — `reduction-formulas`, `lhopitals-rule`,
`mean-value-theorem`, `multivariable-intro`; all 4 zero-discrepancy,
third consecutive all-4-zero-discrepancy batch) together brought
mathematics from 257 to 406.
...
|---|---|---|---|---|---|
| mathematics | 908 | 406 | 44.71% | `math.found.mathematical-thinking` | **Yes** |
