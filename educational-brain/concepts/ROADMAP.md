...
| Concepts with an Educational Brain entry | **494** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,134** |
| Remaining | **641** |
| Completion percentage | **63.89%** |

*(Recomputed programmatically 2026-09-13, after Batch 68 (4 concepts:
...
front as of Batch 68 (math.calc PARKED again this same batch, only `change-of-variables`
remains, blocked on unauthored `math.linalg.determinant`; math.graph PARKED since Batch 65),
494 of 908. The eight certified
