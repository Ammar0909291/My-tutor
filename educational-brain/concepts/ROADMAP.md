...
| Concepts with an Educational Brain entry | **458** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,098** |
| Remaining | **677** |
| Completion percentage | **61.86%** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 458 | 50.44% | `math.found.mathematical-thinking` | **Yes** |
