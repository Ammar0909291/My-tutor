...
| Concepts with an Educational Brain entry | **414** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,054** |
| Remaining | **721** |
| Completion percentage | **59.38%** |
...
consecutive all-4-zero-discrepancy batch) together brought mathematics
from 257 to 414.
...
|---|---|---|---|---|---|
| mathematics | 908 | 414 | 45.59% | `math.found.mathematical-thinking` | **Yes** |
