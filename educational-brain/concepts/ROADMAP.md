...
| Concepts with an Educational Brain entry | **508** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,148** |
| Remaining | **627** |
| Completion percentage | **64.68%** |

*(Recomputed programmatically 2026-09-13, after Batch 73 (4 concepts:
...
remain PARKED — but `math.linalg.determinant` is now itself topologically READY (its sole
prerequisite, `matrix-multiplication`, was authored this same Batch 73), meaning authoring it
next is the direct step that reopens `math.calc`. `math.linalg`'s own fresh frontier now has 6
candidates ready (`norm`, `orthogonality`, `cross-product`, `symmetric-matrix`, `linear-system`,
`determinant`). Mathematics stands at 508 of 908. The nine certified
