...
| Concepts with an Educational Brain entry | **466** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,106** |
| Remaining | **669** |
| Completion percentage | **62.31%** |
...
and telescoping cancellation), all 4 zero Blueprint/KG metadata discrepancy.
...
|---|---|---|---|---|---|
| mathematics | 908 | 466 | 51.32% | `math.found.mathematical-thinking` | **Yes** |
...
math.disc and math.graph parked; math.calc/math.trig/math.seq the active standalone campaigns
(math.calc reopened 2026-09-13 by Batch 59), 458 of 908. The six certified domains are the graph's
