...
| Concepts with an Educational Brain entry | **270** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **910** |
| Remaining | **865** |
| Completion percentage | **51.27%** |
...
session's math.alg Wave 3 (3 concepts), Wave 4 (5 concepts) and Wave 5
(5 concepts) batches together brought mathematics from 257 to 270.
...
|---|---|---|---|---|---|
| mathematics | 908 | 270 | 29.74% | `math.found.mathematical-thinking` | **Yes** |
...
Four domains certified plus math.alg in progress, 270 of 908. The four certified domains are the
graph's foundation layer; every remaining domain draws on at least one of
them, so the prerequisite debt for the remaining 638 concepts is now
