...
| Concepts with an Educational Brain entry | **426** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,066** |
| Remaining | **709** |
| Completion percentage | **60.06%** |
...
zero-discrepancy, ninth consecutive zero-discrepancy batch) together
brought mathematics from 257 to 426.
...
|---|---|---|---|---|---|
| mathematics | 908 | 426 | 46.92% | `math.found.mathematical-thinking` | **Yes** |
