...
| Concepts with an Educational Brain entry | **273** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **913** |
| Remaining | **862** |
| Completion percentage | **51.44%** |
...
(5 concepts), and Wave 6 (3 concepts) batches together brought
mathematics from 257 to 273. Cross-checked: 0 orphan EB files, 0
...
|---|---|---|---|---|---|
| mathematics | 908 | 273 | 30.07% | `math.found.mathematical-thinking` | **Yes** |
...
Four domains certified plus math.alg in progress, 273 of 908. The four certified domains are the
graph's foundation layer; every remaining domain draws on at least one of
them, so the prerequisite debt for the remaining 635 concepts is now
