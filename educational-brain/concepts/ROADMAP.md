...
| Concepts with an Educational Brain entry | **527** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,167** |
| Remaining | **608** |
| Completion percentage | **65.75%** |

*(Recomputed programmatically 2026-09-13, after Batch 78 (3 concepts:
...
|---|---|---|---|---|---|
| mathematics | 908 | 527 | 58.04% | `math.found.mathematical-thinking` | **Yes** |
...
| `math.linalg` | 25/61 | **Batch 78 (3, `det-properties`/`characteristic-polynomial`/
