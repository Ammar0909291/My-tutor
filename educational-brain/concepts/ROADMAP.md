...
| Concepts with an Educational Brain entry | **499** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,139** |
| Remaining | **636** |
| Completion percentage | **64.17%** |

*(Recomputed programmatically 2026-09-13, after Batch 70 (3 concepts:
...
math.calc, and math.graph are ALL PARKED simultaneously for the first time this campaign —
...
the third `shortest-path` already closed in Batch 65). `math.linalg` (0/16, entirely unstarted) now
holds the single topologically-ready candidate across all of mathematics — `math.linalg.vector`,
its entry node — making it the natural next front: opening it is the direct path back into all
three parked domains at once. Mathematics stands at 499 of 908. The eight certified
