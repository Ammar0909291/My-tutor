...
| Concepts with an Educational Brain entry | **520** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,160** |
| Remaining | **615** |
| Completion percentage | **65.35%** |

*(Recomputed programmatically 2026-09-13, after Batch 76 (4 concepts:
...
|---|---|---|---|---|---|
| mathematics | 908 | 520 | 57.27% | `math.found.mathematical-thinking` | **Yes** |
...
| `math.linalg` | 18/61 | **Batch 76 (3, `linear-system`/`matrix-inverse`/`angle-vectors`,
