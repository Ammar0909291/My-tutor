...
| Concepts with an Educational Brain entry | **561** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,201** |
| Remaining | **574** |
| Completion percentage | **67.66%** |

*(Recomputed programmatically 2026-09-14, after Batch 88 (4 concepts: `math.abst.field`/
...
| `math.linalg` | 28/61 | **REOPENED (2026-09-14, Batch 88) — `math.abst.field` (the domain's
...
topologically ready. Not yet authored — the next math.linalg batch resumes here.**
...
| `math.abst` | 19/37 | **Batch 88 (4, `field`/`quotient-group`/`group-homomorphism`/`ring-
