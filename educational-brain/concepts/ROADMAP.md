...
| Concepts with an Educational Brain entry | **284** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **924** |
| Remaining | **851** |
| Completion percentage | **52.06%** |
...
(3 concepts), and Wave 9 (4 concepts) batches together brought
mathematics from 257 to 284. Cross-checked: 0 orphan EB files, 0
...
|---|---|---|---|---|---|
| mathematics | 908 | 284 | 31.28% | `math.found.mathematical-thinking` | **Yes** |
...
Four domains certified plus math.alg in progress, 284 of 908. The four certified domains are the
graph's foundation layer; every remaining domain draws on at least one of
them, so the prerequisite debt for the remaining 624 concepts is now
