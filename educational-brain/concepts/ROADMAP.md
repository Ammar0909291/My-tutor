...
| Concepts with an Educational Brain entry | **482** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,122** |
| Remaining | **653** |
| Completion percentage | **63.21%** |

*(Recomputed programmatically 2026-09-13, after Batch 65 (4 concepts:
`math.calc.taylor-series`, `math.graph.shortest-path`, `math.seq.harmonic-series`,
`math.disc.stirling-numbers` — one concept selected per currently-open front, closing
`math.graph`'s just-discovered reopening from Batch 64's tracking update, brought
mathematics from 478 to 482), mid-way through a dedicated
...
math.trig, the last certified 2026-09-13 in Batch 64); math.disc/math.calc/math.seq/math.graph
the four active fronts as of Batch 65 (math.graph PARKED again after Batch 65 closed its sole
ready candidate), 482 of 908. The seven certified
