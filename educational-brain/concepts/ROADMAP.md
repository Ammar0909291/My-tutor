...
| Concepts with an Educational Brain entry | **470** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,110** |
| Remaining | **665** |
| Completion percentage | **62.54%** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 470 | 51.76% | `math.found.mathematical-thinking` | **Yes** |
