...
| Concepts with an Educational Brain entry | **402** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,042** |
| Remaining | **733** |
| Completion percentage | **58.70%** |
...
`ftc-part2`; all 4 zero-discrepancy), and Batch 44 (4 more `math.calc`
concepts — `logarithmic-differentiation`, `related-rates`,
`surface-area-integral`, `integration-by-parts`; all 4 zero-discrepancy,
second consecutive all-4-zero-discrepancy batch) together brought
mathematics from 257 to 402.
...
|---|---|---|---|---|---|
| mathematics | 908 | 402 | 44.27% | `math.found.mathematical-thinking` | **Yes** |
