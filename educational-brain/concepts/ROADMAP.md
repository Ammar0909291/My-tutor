...
| Concepts with an Educational Brain entry | **287** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **927** |
| Remaining | **848** |
| Completion percentage | **52.23%** |
...
(3 concepts), Wave 9 (4 concepts), Wave 10 (1 concept), and Wave 11
(2 concepts) batches together brought mathematics from 257 to 287.
...
|---|---|---|---|---|---|
| mathematics | 908 | 287 | 31.61% | `math.found.mathematical-thinking` | **Yes** |
...
Four domains certified plus math.alg in progress, 287 of 908. The four certified domains are the
graph's foundation layer; every remaining domain draws on at least one of
them, so the prerequisite debt for the remaining 621 concepts is now
