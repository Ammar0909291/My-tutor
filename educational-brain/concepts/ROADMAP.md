...
| Concepts with an Educational Brain entry | **581** mathematics + 238 physics + 216 english + 186 chemistry + 1 biology + 0 computer_science = **1,222** |
| Remaining | **644** |
| Completion percentage | **65.49%** |
...
| biology | 199 | 1 | **0.50% (IN PROGRESS, Biology End-User Readiness Program started 2026-09-20)** | `bio.found.what-is-biology` (now authored — the KG root) | Yes (root only) — KG count corrected 108→199 (2026-09-14 extension, previously unreflected here); see `CLAUDE.md`'s Biology program section for authoritative status |
