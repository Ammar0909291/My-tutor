...
| Concepts with an Educational Brain entry | **418** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,058** |
| Remaining | **717** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 418 | 46.04% | `math.found.mathematical-thinking` | **Yes** |
