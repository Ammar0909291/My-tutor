...
| Concepts with an Educational Brain entry | **438** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,078** |
| Remaining | **697** |
| Completion percentage | **60.73%** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 446 | 49.12% | `math.found.mathematical-thinking` | **Yes** |
...
390 of 908. The six certified domains are the graph's
