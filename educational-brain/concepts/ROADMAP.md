...
| Concepts with an Educational Brain entry | **474** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,114** |
| Remaining | **661** |
| Completion percentage | **62.76%** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 474 | 52.20% | `math.found.mathematical-thinking` | **Yes** |
