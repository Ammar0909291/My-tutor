...
| Concepts with an Educational Brain entry | **434** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,074** |
| Remaining | **701** |
...
|---|---|---|---|---|---|
| mathematics | 908 | 434 | 47.80% | `math.found.mathematical-thinking` | **Yes** |
