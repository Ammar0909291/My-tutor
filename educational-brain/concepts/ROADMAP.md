...
| Concepts with an Educational Brain entry | **529** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,169** |
| Remaining | **606** |
| Completion percentage | **65.86%** |

*(Recomputed programmatically 2026-09-13, after Batch 79 (2 concepts:
...
|---|---|---|---|---|---|
| mathematics | 908 | 529 | 58.26% | `math.found.mathematical-thinking` | **Yes** |
...
| `math.linalg` | 27/61 | **Batch 79 (2, `row-echelon`/`lu-factorization`, closing the ENTIRE
