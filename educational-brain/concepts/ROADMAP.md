...
| Concepts with an Educational Brain entry | **565** mathematics + 238 physics + 216 english + 186 chemistry + 0 biology + 0 computer_science = **1,205** |
| Remaining | **570** |
| Completion percentage | **67.89%** |

*(Recomputed programmatically 2026-09-14, after Batch 89 (4 concepts: `math.linalg.vector-space`/
...
| `math.linalg` | 29/61 | **Batch 89 (1, `vector-space`, the domain's own reopening entry
...
| `math.abst` | 22/37 | **Batch 89 (3, `first-isomorphism-theorem`/`finite-field`/
