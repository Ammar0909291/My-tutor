# Educational Brain Index — Canonical Registry
...
`MISSING` = no Educational Brain entry yet (the authoring backlog —
see `AUTHORING_QUEUE.md`). `DUPLICATE` = more than one Educational Brain
file resolves to this KG id. `ORPHAN` = reserved for an Educational Brain
file with no matching row (listed separately below, since an orphan by
definition has no KG concept to anchor a row to). `INVALID_REFERENCE` =
this concept's own `requires`/`unlocks` contains a broken reference within
its subject KG.

## mathematics (908 concepts, 237 READY)
| Domain | KG ID | Concept Name | Blueprint | EB Entry | EB File | Status |
|---|---|---|---|---|---|---|
| abst | `math.abst.algebraic-extension` | Algebraic Extension | Yes | No | — | MISSING |
| abst | `math.abst.algebraic-structure` | Algebraic Structure | Yes | No | — | MISSING |
| abst | `math.abst.alternating-group` | Alternating Group | No | No | — | MISSING |
| abst | `math.abst.binary-operation` | Binary Operation | Yes | No | — | MISSING |
| abst | `math.abst.burnside-lemma` | Burnside's Lemma | No | No | — | MISSING |
| abst | `math.abst.coset` | Coset | Yes | No | — | MISSING |
| abst | `math.abst.cyclic-group` | Cyclic Group | No | No | — | MISSING |
| abst | `math.abst.euclidean-domain` | Euclidean Domain | Yes | No | — | MISSING |
| abst | `math.abst.field` | Field | Yes | No | — | MISSING |
| abst | `math.abst.field-extension` | Field Extension | Yes | No | — | MISSING |
| abst | `math.abst.finite-field` | Finite Field | Yes | No | — | MISSING |
| abst | `math.abst.first-isomorphism-theorem` | First Isomorphism Theorem | Yes | No | — | MISSING |
| abst | `math.abst.galois-correspondence` | Fundamental Theorem of Galois Theory | Yes | No | — | MISSING |
| abst | `math.abst.galois-group` | Galois Group | Yes | No | — | MISSING |
| abst | `math.abst.galois-theory` | Galois Theory | Yes | No | — | MISSING |
| abst | `math.abst.group-action` | Group Action | Yes | No | — | MISSING |
| abst | `math.abst.group-homomorphism` | Group Homomorphism | Yes | No | — | MISSING |
| abst | `math.abst.group-inverse` | Group Inverse | No | No | — | MISSING |
| abst | `math.abst.group-isomorphism` | Group Isomorphism | No | No | — | MISSING |
| abst | `math.abst.group-operation` | Group Operation Examples | No | No | — | MISSING |
| abst | `math.abst.group-order` | Order of Group and Elements | No | No | — | MISSING |
| abst | `math.abst.group-theory` | Group | Yes | No | — | MISSING |
| abst | `math.abst.ideal` | Ideal | Yes | No | — | MISSING |
| abst | `math.abst.lagrange-theorem` | Lagrange's Theorem | No | No | — | MISSING |
| abst | `math.abst.normal-subgroup` | Normal Subgroup | Yes | No | — | MISSING |
| abst | `math.abst.pid` | Principal Ideal Domain | Yes | No | — | MISSING |
| abst | `math.abst.polynomial-ring` | Polynomial Ring | Yes | No | — | MISSING |
| abst | `math.abst.prime-ideal` | Prime and Maximal Ideals | Yes | No | — | MISSING |
| abst | `math.abst.quotient-group` | Quotient Group | Yes | No | — | MISSING |
| abst | `math.abst.quotient-ring` | Quotient Ring | No | No | — | MISSING |
| abst | `math.abst.ring-homomorphism` | Ring Homomorphism | No | No | — | MISSING |
| abst | `math.abst.ring-theory` | Ring | Yes | No | — | MISSING |
| abst | `math.abst.second-isomorphism-theorem` | Second and Third Isomorphism Theorems | No | No | — | MISSING |
| abst | `math.abst.subgroup` | Subgroup | Yes | No | — | MISSING |
| abst | `math.abst.sylow-theorems` | Sylow Theorems | No | No | — | MISSING |
| abst | `math.abst.symmetric-group` | Symmetric Group | Yes | No | — | MISSING |
| abst | `math.abst.ufd` | Unique Factorization Domain | Yes | No | — | MISSING |
| alg | `math.alg.absolute-value-equations` | Absolute Value Equations and Inequalities | No | No | — | MISSING |
| alg | `math.alg.binomial-theorem` | Binomial Theorem | Yes | No | — | MISSING |
| alg | `math.alg.change-of-base` | Change of Base Formula | No | No | — | MISSING |
| alg | `math.alg.coefficient` | Coefficient | Yes | No | — | MISSING |
| alg | `math.alg.completing-the-square` | Completing the Square | Yes | No | — | MISSING |
| alg | `math.alg.complex-polynomial-roots` | Complex Roots of Polynomials | No | No | — | MISSING |
| alg | `math.alg.degree` | Degree of a Polynomial | No | No | — | MISSING |
| alg | `math.alg.discriminant` | Discriminant | No | No | — | MISSING |
| alg | `math.alg.elimination-method` | Elimination Method | Yes | No | — | MISSING |
| alg | `math.alg.equation` | Equation | Yes | No | — | MISSING |
| alg | `math.alg.exponent-rules` | Exponent Rules (Algebraic) | Yes | No | — | MISSING |
| alg | `math.alg.exponential-equations` | Exponential Equations | No | No | — | MISSING |
| alg | `math.alg.exponential-function` | Exponential Function | Yes | No | — | MISSING |
| alg | `math.alg.expression` | Algebraic Expression | Yes | No | — | MISSING |
| alg | `math.alg.factor-theorem` | Factor Theorem | Yes | No | — | MISSING |
| alg | `math.alg.factoring` | Factoring Polynomials | Yes | No | — | MISSING |
| alg | `math.alg.factoring-gcf` | Factoring out the GCF | Yes | No | — | MISSING |
| alg | `math.alg.factoring-special` | Special Factoring Patterns | No | No | — | MISSING |
| alg | `math.alg.factoring-trinomials` | Factoring Trinomials | Yes | No | — | MISSING |
| alg | `math.alg.fractional-exponent` | Fractional Exponent | No | No | — | MISSING |
| alg | `math.alg.fundamental-theorem-algebra` | Fundamental Theorem of Algebra | Yes | No | — | MISSING |
| alg | `math.alg.inequality` | Inequality | Yes | No | — | MISSING |
| alg | `math.alg.inequality-1var` | Linear Inequality in One Variable | Yes | No | — | MISSING |
| alg | `math.alg.inequality-2var` | Linear Inequality in Two Variables | No | No | — | MISSING |
| alg | `math.alg.like-terms` | Like Terms | Yes | No | — | MISSING |
| alg | `math.alg.linear-equation-1var` | Linear Equation in One Variable | Yes | No | — | MISSING |
| alg | `math.alg.linear-equation-2var` | Linear Equation in Two Variables | Yes | No | — | MISSING |
| alg | `math.alg.logarithm` | Logarithm | Yes | No | — | MISSING |
| alg | `math.alg.logarithm-properties` | Logarithm Properties | Yes | No | — | MISSING |
| alg | `math.alg.logarithmic-equations` | Logarithmic Equations | No | No | — | MISSING |
| alg | `math.alg.natural-logarithm` | Natural Logarithm | Yes | No | — | MISSING |
| alg | `math.alg.negative-exponent` | Negative Exponent | No | No | — | MISSING |
| alg | `math.alg.pascals-triangle` | Pascal's Triangle | No | No | — | MISSING |
| alg | `math.alg.polynomial` | Polynomial | Yes | No | — | MISSING |
| alg | `math.alg.polynomial-division` | Polynomial Division | Yes | No | — | MISSING |
| alg | `math.alg.polynomial-inequality` | Polynomial Inequality | No | No | — | MISSING |
| alg | `math.alg.polynomial-operations` | Polynomial Operations | Yes | No | — | MISSING |
| alg | `math.alg.polynomial-roots` | Polynomial Roots (Real and Complex) | Yes | No | — | MISSING |
| alg | `math.alg.quadratic-equation` | Quadratic Equation | Yes | No | — | MISSING |
| alg | `math.alg.quadratic-formula` | Quadratic Formula | Yes | No | — | MISSING |
| alg | `math.alg.radical-equations` | Radical Equations | No | No | — | MISSING |
| alg | `math.alg.radicals` | Radical Expressions | Yes | No | — | MISSING |
| alg | `math.alg.rational-equations` | Rational Equations | No | No | — | MISSING |
| alg | `math.alg.rational-expressions` | Rational Expressions | Yes | No | — | MISSING |
| alg | `math.alg.rational-expressions-addition` | Addition of Rational Expressions | No | No | — | MISSING |
| alg | `math.alg.rational-expressions-multiplication` | Multiplication of Rational Expressions | No | No | — | MISSING |
| alg | `math.alg.rational-inequality` | Rational Inequality | No | No | — | MISSING |
| alg | `math.alg.rational-root-theorem` | Rational Root Theorem | No | No | — | MISSING |
| alg | `math.alg.rationalizing-denominators` | Rationalizing the Denominator | No | No | — | MISSING |
| alg | `math.alg.remainder-theorem` | Remainder Theorem | Yes | No | — | MISSING |
| alg | `math.alg.simplification` | Algebraic Simplification | Yes | No | — | MISSING |
| alg | `math.alg.simplifying-radicals` | Simplifying Radical Expressions | No | No | — | MISSING |
| alg | `math.alg.solution-set` | Solution Set | No | No | — | MISSING |
| alg | `math.alg.substitution-method` | Substitution Method | No | No | — | MISSING |
| alg | `math.alg.system-3var` | Systems of 3 Equations in 3 Variables | Yes | No | — | MISSING |
| alg | `math.alg.system-linear-equations` | Systems of Linear Equations | Yes | No | — | MISSING |
...
| arith | `math.arith.cube-numbers` | Perfect Cubes | No | Yes | `educational-brain/concepts/mathematics/math.arith.cube-numbers.md` | READY |
...
| arith | `math.arith.divisor-dividend` | Divisor and Dividend | No | Yes | `educational-brain/concepts/mathematics/math.arith.divisor-dividend.md` | READY |
...
| arith | `math.arith.fraction-addition` | Addition and Subtraction of Fractions | No | Yes | `educational-brain/concepts/mathematics/math.arith.fraction-addition.md` | READY |
...
| arith | `math.arith.fraction-simplification` | Fraction Simplification | No | Yes | `educational-brain/concepts/mathematics/math.arith.fraction-simplification.md` | READY |
...
| arith | `math.arith.percentage-change` | Percentage Change | No | Yes | `educational-brain/concepts/mathematics/math.arith.percentage-change.md` | READY |
...
| calc | `math.calc.chain-rule-multivariable` | Multivariable Chain Rule | No | No | — | MISSING |
| calc | `math.calc.change-of-variables` | Change of Variables (Jacobian) | No | No | — | MISSING |
| calc | `math.calc.concavity` | Concavity and Inflection Points | Yes | No | — | MISSING |
| calc | `math.calc.continuity` | Continuity | Yes | No | — | MISSING |
| calc | `math.calc.continuity-types` | Types of Discontinuity | No | No | — | MISSING |
| calc | `math.calc.critical-points` | Critical Points | Yes | No | — | MISSING |
| calc | `math.calc.curl-divergence` | Curl and Divergence | Yes | No | — | MISSING |
| calc | `math.calc.curve-sketching` | Curve Sketching | No | No | — | MISSING |
| calc | `math.calc.definite-integral` | Definite Integral | Yes | No | — | MISSING |
| calc | `math.calc.derivative-definition` | Derivative (Definition) | Yes | No | — | MISSING |
| calc | `math.calc.derivative-exponential` | Derivative of Exponential Functions | No | No | — | MISSING |
| calc | `math.calc.derivative-intro` | Slope of Tangent and Rate of Change | Yes | No | — | MISSING |
| calc | `math.calc.derivative-inverse-trig` | Derivatives of Inverse Trig Functions | No | No | — | MISSING |
| calc | `math.calc.derivative-ln` | Derivative of Logarithmic Functions | No | No | — | MISSING |
| calc | `math.calc.derivative-rules` | Basic Differentiation Rules | Yes | No | — | MISSING |
| calc | `math.calc.derivative-trig` | Derivatives of Trigonometric Functions | No | No | — | MISSING |
| calc | `math.calc.differentiability` | Differentiability | No | No | — | MISSING |
| calc | `math.calc.directional-derivative` | Directional Derivative | No | No | — | MISSING |
| calc | `math.calc.divergence-theorem` | Divergence Theorem | No | No | — | MISSING |
| calc | `math.calc.double-integrals` | Double Integrals | Yes | No | — | MISSING |
| calc | `math.calc.fourier-series-intro` | Fourier Series (Introduction) | Yes | No | — | MISSING |
| calc | `math.calc.ftc-part1` | Fundamental Theorem of Calculus Part 1 | Yes | No | — | MISSING |
| calc | `math.calc.ftc-part2` | Fundamental Theorem of Calculus Part 2 | Yes | No | — | MISSING |
| calc | `math.calc.gradient` | Gradient | Yes | No | — | MISSING |
| calc | `math.calc.greens-theorem` | Green's Theorem | Yes | No | — | MISSING |
| calc | `math.calc.higher-order-derivatives` | Higher-Order Derivatives | Yes | No | — | MISSING |
| calc | `math.calc.hyperbolic-derivatives` | Derivatives of Hyperbolic Functions | No | No | — | MISSING |
| calc | `math.calc.implicit-differentiation` | Implicit Differentiation | Yes | No | — | MISSING |
| calc | `math.calc.improper-integrals` | Improper Integrals | Yes | No | — | MISSING |
| calc | `math.calc.increasing-decreasing` | Increasing and Decreasing Functions | Yes | No | — | MISSING |
| calc | `math.calc.integral-area` | Area by Integration | Yes | No | — | MISSING |
| calc | `math.calc.integration-by-parts` | Integration by Parts | Yes | No | — | MISSING |
| calc | `math.calc.ivt` | Intermediate Value Theorem | Yes | No | — | MISSING |
| calc | `math.calc.lhopitals-rule` | L'Hôpital's Rule | No | No | — | MISSING |
| calc | `math.calc.limit-laws` | Limit Laws | No | No | — | MISSING |
| calc | `math.calc.limits` | Limit of a Function | Yes | No | — | MISSING |
| calc | `math.calc.limits-at-infinity` | Limits at Infinity | Yes | No | — | MISSING |
| calc | `math.calc.line-integrals` | Line Integrals | Yes | No | — | MISSING |
| calc | `math.calc.linearization` | Linearization and Differentials | Yes | No | — | MISSING |
| calc | `math.calc.local-extrema` | Local Extrema | Yes | No | — | MISSING |
| calc | `math.calc.logarithmic-differentiation` | Logarithmic Differentiation | No | No | — | MISSING |
| calc | `math.calc.maclaurin-series` | Maclaurin Series | No | No | — | MISSING |
| calc | `math.calc.mean-value-theorem` | Mean Value Theorem | Yes | No | — | MISSING |
| calc | `math.calc.multiple-integrals` | Multiple Integrals | Yes | No | — | MISSING |
| calc | `math.calc.multivariable-extrema` | Multivariable Extrema | Yes | No | — | MISSING |
| calc | `math.calc.multivariable-intro` | Introduction to Multivariable Calculus | Yes | No | — | MISSING |
| calc | `math.calc.one-sided-limits` | One-Sided Limits | Yes | No | — | MISSING |
| calc | `math.calc.optimization` | Optimization (Calculus) | Yes | No | — | MISSING |
| calc | `math.calc.parametric-calculus` | Calculus of Parametric Curves | No | No | — | MISSING |
| calc | `math.calc.parametric-curves` | Parametric Equations and Curves | Yes | No | — | MISSING |
| calc | `math.calc.partial-derivatives` | Partial Derivatives | Yes | No | — | MISSING |
| calc | `math.calc.partial-fractions` | Partial Fraction Decomposition | Yes | No | — | MISSING |
| calc | `math.calc.power-series` | Power Series | Yes | No | — | MISSING |
| calc | `math.calc.product-rule` | Product Rule | Yes | No | — | MISSING |
| calc | `math.calc.quotient-rule` | Quotient Rule | No | No | — | MISSING |
| calc | `math.calc.radius-of-convergence` | Radius of Convergence | No | No | — | MISSING |
| calc | `math.calc.reduction-formulas` | Reduction Formulas | No | No | — | MISSING |
| calc | `math.calc.related-rates` | Related Rates | No | No | — | MISSING |
| calc | `math.calc.riemann-sums` | Riemann Sums | Yes | No | — | MISSING |
| calc | `math.calc.rolles-theorem` | Rolle's Theorem | No | No | — | MISSING |
| calc | `math.calc.sequence-limits` | Limits of Sequences (Calculus) | Yes | No | — | MISSING |
| calc | `math.calc.squeeze-theorem` | Squeeze Theorem | No | No | — | MISSING |
| calc | `math.calc.stokes-theorem` | Stokes' Theorem | No | No | — | MISSING |
| calc | `math.calc.surface-area-integral` | Surface Area of Revolution | No | No | — | MISSING |
| calc | `math.calc.surface-integrals` | Surface Integrals | Yes | No | — | MISSING |
| calc | `math.calc.taylor-remainder` | Taylor Remainder and Error Bound | No | No | — | MISSING |
| calc | `math.calc.taylor-series` | Taylor Series | Yes | No | — | MISSING |
| calc | `math.calc.trig-integrals` | Trigonometric Integrals | Yes | No | — | MISSING |
| calc | `math.calc.trig-substitution` | Trigonometric Substitution | Yes | No | — | MISSING |
| calc | `math.calc.triple-integrals` | Triple Integrals | No | No | — | MISSING |
| calc | `math.calc.u-substitution` | Integration by Substitution | Yes | No | — | MISSING |
| calc | `math.calc.vector-fields` | Vector Fields | Yes | No | — | MISSING |
| calc | `math.calc.volume-revolution` | Volumes of Revolution | No | No | — | MISSING |
| cat | `math.cat.adjunction` | Adjunction | Yes | No | — | MISSING |
| cat | `math.cat.category` | Category | Yes | No | — | MISSING |
| cat | `math.cat.equalizer` | Equalizer and Coequalizer | No | No | — | MISSING |
| cat | `math.cat.functor` | Functor | Yes | No | — | MISSING |
| cat | `math.cat.functor-category` | Functor Category | Yes | No | — | MISSING |
| cat | `math.cat.higher-category` | Higher Category Theory | Yes | No | — | MISSING |
| cat | `math.cat.limits` | Limits and Colimits | Yes | No | — | MISSING |
| cat | `math.cat.monad` | Monad | Yes | No | — | MISSING |
| cat | `math.cat.morphism-types` | Types of Morphisms | No | No | — | MISSING |
| cat | `math.cat.natural-transformation` | Natural Transformation | Yes | No | — | MISSING |
| cat | `math.cat.pullback` | Pullback and Pushout | No | No | — | MISSING |
| cat | `math.cat.representable-functor` | Representable Functor | No | No | — | MISSING |
| cat | `math.cat.tensor-product` | Tensor Product (Categorical) | Yes | No | — | MISSING |
| cat | `math.cat.topos` | Topos | Yes | No | — | MISSING |
| cat | `math.cat.yoneda-lemma` | Yoneda Lemma | Yes | No | — | MISSING |
| cx | `math.cx.analytic-continuation` | Analytic Continuation | Yes | No | — | MISSING |
| cx | `math.cx.analytic-functions` | Analytic (Holomorphic) Functions | Yes | No | — | MISSING |
| cx | `math.cx.argument-principle` | Argument Principle | Yes | No | — | MISSING |
| cx | `math.cx.cauchy-goursat` | Cauchy-Goursat Theorem | No | No | — | MISSING |
| cx | `math.cx.cauchy-integral-formula` | Cauchy Integral Formula | Yes | No | — | MISSING |
| cx | `math.cx.cauchy-riemann` | Cauchy-Riemann Equations | Yes | No | — | MISSING |
| cx | `math.cx.cauchy-theorem` | Cauchy's Theorem | Yes | No | — | MISSING |
| cx | `math.cx.complex-function` | Complex-Valued Function | Yes | No | — | MISSING |
| cx | `math.cx.complex-integration` | Complex Line Integral | Yes | No | — | MISSING |
| cx | `math.cx.complex-numbers-analysis` | Complex Numbers (Analysis) | Yes | No | — | MISSING |
| cx | `math.cx.conformal-mapping` | Conformal Mapping | Yes | No | — | MISSING |
| cx | `math.cx.essential-singularity` | Essential Singularity | No | No | — | MISSING |
| cx | `math.cx.fundamental-theorem-algebra` | Fundamental Theorem of Algebra (Complex Analysis) | No | No | — | MISSING |
| cx | `math.cx.harmonic-functions` | Harmonic Functions (Complex Analysis) | Yes | No | — | MISSING |
| cx | `math.cx.higher-derivatives` | Derivatives of Holomorphic Functions | Yes | No | — | MISSING |
| cx | `math.cx.identity-theorem` | Identity Theorem | Yes | No | — | MISSING |
| cx | `math.cx.laurent-series` | Laurent Series | Yes | No | — | MISSING |
| cx | `math.cx.liouville-theorem` | Liouville's Theorem | Yes | No | — | MISSING |
| cx | `math.cx.maximum-modulus` | Maximum Modulus Principle | Yes | No | — | MISSING |
| cx | `math.cx.mobius-transformation` | Möbius Transformation | No | No | — | MISSING |
| cx | `math.cx.morera-theorem` | Morera's Theorem | No | No | — | MISSING |
| cx | `math.cx.poles` | Poles and Meromorphic Functions | Yes | No | — | MISSING |
| cx | `math.cx.power-series-cx` | Power Series in ℂ | Yes | No | — | MISSING |
| cx | `math.cx.real-integral-residues` | Evaluating Real Integrals via Residues | Yes | No | — | MISSING |
| cx | `math.cx.residue` | Residue | Yes | No | — | MISSING |
| cx | `math.cx.residue-theorem` | Residue Theorem | Yes | No | — | MISSING |
| cx | `math.cx.riemann-mapping` | Riemann Mapping Theorem | Yes | No | — | MISSING |
| cx | `math.cx.riemann-surface` | Riemann Surface | Yes | No | — | MISSING |
| cx | `math.cx.riemann-zeta` | Riemann Zeta Function | Yes | No | — | MISSING |
| cx | `math.cx.rouche-theorem` | Rouché's Theorem | No | No | — | MISSING |
| cx | `math.cx.singularities` | Singularities | Yes | No | — | MISSING |
| de | `math.de.bernoulli` | Bernoulli Equation | No | No | — | MISSING |
| de | `math.de.bessel-equation` | Bessel's Equation | Yes | No | — | MISSING |
| de | `math.de.bifurcation` | Bifurcation Theory | No | No | — | MISSING |
| de | `math.de.bvp` | Boundary Value Problem | Yes | No | — | MISSING |
| de | `math.de.chaos` | Chaotic Dynamics | No | No | — | MISSING |
| de | `math.de.char-equation` | Characteristic Equation | Yes | No | — | MISSING |
| de | `math.de.convolution-theorem` | Convolution Theorem (Laplace) | Yes | No | — | MISSING |
| de | `math.de.eigenfunction-expansion` | Eigenfunction Expansion | Yes | No | — | MISSING |
| de | `math.de.euler-method` | Euler's Method | Yes | No | — | MISSING |
| de | `math.de.exact-ode` | Exact Differential Equation | No | No | — | MISSING |
| de | `math.de.existence-uniqueness` | Existence and Uniqueness Theorem | Yes | No | — | MISSING |
| de | `math.de.first-order-ode` | First-Order ODE | Yes | No | — | MISSING |
| de | `math.de.fourier-convergence` | Convergence of Fourier Series | Yes | No | — | MISSING |
| de | `math.de.fourier-series` | Fourier Series | Yes | No | — | MISSING |
| de | `math.de.fourier-sine-cosine` | Fourier Sine and Cosine Series | No | No | — | MISSING |
| de | `math.de.fourier-transform` | Fourier Transform | Yes | No | — | MISSING |
| de | `math.de.frobenius-method` | Frobenius Method | Yes | No | — | MISSING |
| de | `math.de.greens-function` | Green's Function | Yes | No | — | MISSING |
| de | `math.de.harmonic-functions` | Harmonic Functions | Yes | No | — | MISSING |
| de | `math.de.harmonic-oscillator` | Harmonic Oscillator | No | No | — | MISSING |
| de | `math.de.heat-equation` | Heat Equation | No | No | — | MISSING |
| de | `math.de.higher-order-ode` | Higher-Order Linear ODE | Yes | No | — | MISSING |
| de | `math.de.homogeneous-ode` | Homogeneous First-Order ODE | No | No | — | MISSING |
| de | `math.de.inverse-laplace` | Inverse Laplace Transform | Yes | No | — | MISSING |
| de | `math.de.ivp` | Initial Value Problem | Yes | No | — | MISSING |
| de | `math.de.laplace-equation` | Laplace's Equation | Yes | No | — | MISSING |
| de | `math.de.laplace-ode` | Solving ODEs with Laplace Transform | No | No | — | MISSING |
| de | `math.de.laplace-properties` | Laplace Transform Properties | Yes | No | — | MISSING |
| de | `math.de.laplace-transform` | Laplace Transform | Yes | No | — | MISSING |
| de | `math.de.legendre-equation` | Legendre's Equation | Yes | No | — | MISSING |
| de | `math.de.linear-first-order` | Linear First-Order ODE | No | No | — | MISSING |
| de | `math.de.nonlinear-ode` | Nonlinear ODE | No | No | — | MISSING |
| de | `math.de.ode` | Ordinary Differential Equation | Yes | No | — | MISSING |
| de | `math.de.ode-linearity` | Linearity of Differential Equations | Yes | No | — | MISSING |
| de | `math.de.ode-order` | Order of a Differential Equation | No | No | — | MISSING |
| de | `math.de.pde` | Partial Differential Equation | Yes | No | — | MISSING |
| de | `math.de.pde-classification` | Classification of Second-Order PDEs | No | No | — | MISSING |
| de | `math.de.phase-plane` | Phase Plane Analysis | Yes | No | — | MISSING |
| de | `math.de.poisson-equation` | Poisson's Equation | Yes | No | — | MISSING |
| de | `math.de.resonance` | Resonance | No | No | — | MISSING |
| de | `math.de.second-order-homogeneous` | Homogeneous Second-Order Linear ODE | Yes | No | — | MISSING |
| de | `math.de.second-order-linear` | Second-Order Linear ODE | Yes | No | — | MISSING |
| de | `math.de.second-order-ode` | Second-Order ODE | Yes | No | — | MISSING |
| de | `math.de.separable` | Separable Differential Equation | No | No | — | MISSING |
| de | `math.de.separation-of-variables-pde` | Separation of Variables (PDE) | Yes | No | — | MISSING |
| de | `math.de.series-solution` | Series Solution of ODEs | Yes | No | — | MISSING |
| de | `math.de.slope-field` | Slope Field | Yes | No | — | MISSING |
| de | `math.de.solution-types` | Types of Solutions | Yes | No | — | MISSING |
| de | `math.de.stability-analysis` | Stability Analysis | Yes | No | — | MISSING |
| de | `math.de.sturm-liouville` | Sturm-Liouville Theory | Yes | No | — | MISSING |
| de | `math.de.systems-matrix-method` | Matrix Method for Linear Systems | No | No | — | MISSING |
| de | `math.de.systems-ode` | Systems of ODEs | Yes | No | — | MISSING |
| de | `math.de.undetermined-coefficients` | Method of Undetermined Coefficients | No | No | — | MISSING |
| de | `math.de.variation-of-parameters` | Variation of Parameters | No | No | — | MISSING |
| de | `math.de.wave-equation` | Wave Equation | No | No | — | MISSING |
| de | `math.de.wronskian` | Wronskian | Yes | No | — | MISSING |
| disc | `math.disc.algorithm-complexity` | Algorithm Complexity | No | No | — | MISSING |
| disc | `math.disc.asymptotic-notation` | Asymptotic Notation | Yes | No | — | MISSING |
| disc | `math.disc.binomial-theorem` | Binomial Theorem | No | No | — | MISSING |
| disc | `math.disc.boolean-circuits` | Boolean Circuits and Logic Gates | No | No | — | MISSING |
| disc | `math.disc.catalan-numbers` | Catalan Numbers | No | No | — | MISSING |
| disc | `math.disc.combinations` | Combinations | Yes | No | — | MISSING |
| disc | `math.disc.combinatorics` | Combinatorics | Yes | No | — | MISSING |
| disc | `math.disc.complexity-classes` | Complexity Classes | No | No | — | MISSING |
| disc | `math.disc.counting-principles` | Counting Principles | Yes | No | — | MISSING |
| disc | `math.disc.derangements` | Derangements | No | No | — | MISSING |
| disc | `math.disc.divide-conquer-recurrence` | Divide-and-Conquer Recurrence | No | No | — | MISSING |
| disc | `math.disc.egf` | Exponential Generating Function | No | No | — | MISSING |
| disc | `math.disc.euler-hamiltonian` | Euler and Hamiltonian Paths | Yes | No | — | MISSING |
| disc | `math.disc.generating-functions` | Generating Functions | Yes | No | — | MISSING |
| disc | `math.disc.graph` | Graph | Yes | No | — | MISSING |
| disc | `math.disc.graph-coloring` | Graph Coloring | No | No | — | MISSING |
| disc | `math.disc.graph-connectivity` | Graph Connectivity | Yes | No | — | MISSING |
| disc | `math.disc.graph-representation` | Graph Representation | No | No | — | MISSING |
| disc | `math.disc.graph-trees` | Trees | Yes | No | — | MISSING |
| disc | `math.disc.graph-types` | Types of Graphs | No | No | — | MISSING |
| disc | `math.disc.inclusion-exclusion` | Inclusion-Exclusion Principle | No | No | — | MISSING |
| disc | `math.disc.linear-recurrence` | Linear Recurrence | No | No | — | MISSING |
| disc | `math.disc.ogf` | Ordinary Generating Function | No | No | — | MISSING |
| disc | `math.disc.permutations` | Permutations | Yes | No | — | MISSING |
| disc | `math.disc.pigeonhole` | Pigeonhole Principle | No | No | — | MISSING |
| disc | `math.disc.planar-graph` | Planar Graph | No | No | — | MISSING |
| disc | `math.disc.predicate-logic-disc` | Predicate Logic and Proof Methods | No | No | — | MISSING |
| disc | `math.disc.propositional-logic` | Propositional Logic | Yes | No | — | MISSING |
| disc | `math.disc.recurrence-relation` | Recurrence Relation | Yes | No | — | MISSING |
| disc | `math.disc.spanning-tree` | Spanning Tree | No | No | — | MISSING |
| disc | `math.disc.stars-bars` | Stars and Bars | No | No | — | MISSING |
| disc | `math.disc.stirling-numbers` | Stirling Numbers | No | No | — | MISSING |
| fnal | `math.fnal.banach-space` | Banach Space | Yes | No | — | MISSING |
| fnal | `math.fnal.bounded-operator` | Bounded Linear Operator | Yes | No | — | MISSING |
| fnal | `math.fnal.closed-graph-theorem` | Closed Graph Theorem | No | No | — | MISSING |
| fnal | `math.fnal.compact-operator-spectrum` | Compact Operators | No | No | — | MISSING |
| fnal | `math.fnal.completeness` | Completeness | Yes | No | — | MISSING |
| fnal | `math.fnal.convolution` | Convolution | Yes | No | — | MISSING |
| fnal | `math.fnal.dense-subspace` | Dense Subspaces and Approximation | Yes | No | — | MISSING |
| fnal | `math.fnal.distributions` | Distributions | Yes | No | — | MISSING |
| fnal | `math.fnal.dual-space-functional` | Dual Space | Yes | No | — | MISSING |
| fnal | `math.fnal.fourier-transform` | Fourier Transform (Functional Analysis) | Yes | No | — | MISSING |
| fnal | `math.fnal.hahn-banach` | Hahn-Banach Theorem | No | No | — | MISSING |
| fnal | `math.fnal.hilbert-space` | Hilbert Space | Yes | No | — | MISSING |
| fnal | `math.fnal.normed-space` | Normed Space | Yes | No | — | MISSING |
| fnal | `math.fnal.open-mapping-theorem` | Open Mapping Theorem | Yes | No | — | MISSING |
| fnal | `math.fnal.riesz-representation` | Riesz Representation Theorem | No | No | — | MISSING |
| fnal | `math.fnal.special-functions` | Special Functions | Yes | No | — | MISSING |
...
| func | `math.func.end-behavior` | End Behavior | No | No | — | MISSING |
| func | `math.func.even-odd-functions` | Even and Odd Functions | No | No | — | MISSING |
| func | `math.func.exponential-function` | Exponential Function | Yes | No | — | MISSING |
| func | `math.func.function-concept` | Function | Yes | No | — | MISSING |
| func | `math.func.function-notation` | Function Notation | No | No | — | MISSING |
| func | `math.func.function-operations` | Operations on Functions | Yes | No | — | MISSING |
| func | `math.func.graph-of-function` | Graph of a Function | Yes | No | — | MISSING |
| func | `math.func.horizontal-asymptote` | Horizontal Asymptote | No | No | — | MISSING |
| func | `math.func.injectivity` | Injective (One-to-One) Function | Yes | No | — | MISSING |
| func | `math.func.inverse-functions` | Inverse Functions | Yes | No | — | MISSING |
| func | `math.func.linear-function` | Linear Function | Yes | No | — | MISSING |
| func | `math.func.logarithmic-function` | Logarithmic Function | Yes | No | — | MISSING |
| func | `math.func.monotonic-function` | Monotonic Function | Yes | No | — | MISSING |
| func | `math.func.periodic-function` | Periodic Function | No | No | — | MISSING |
| func | `math.func.piecewise-function` | Piecewise-Defined Function | No | No | — | MISSING |
| func | `math.func.polynomial-function` | Polynomial Function | Yes | No | — | MISSING |
| func | `math.func.quadratic-function` | Quadratic Function | Yes | No | — | MISSING |
| func | `math.func.rational-function` | Rational Function | Yes | No | — | MISSING |
| func | `math.func.rational-root` | Real Roots of Polynomials | No | No | — | MISSING |
| func | `math.func.real-valued-function` | Real-Valued Function | Yes | No | — | MISSING |
| func | `math.func.step-function` | Step Function | No | No | — | MISSING |
| func | `math.func.surjectivity` | Surjective (Onto) Function | Yes | No | — | MISSING |
| func | `math.func.transformations-functions` | Transformations of Functions | No | No | — | MISSING |
...
| geom | `math.geom.conic-sections` | Conic Sections | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.conic-sections.md` | READY |
...
| geom | `math.geom.cross-product` | Cross Product | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.cross-product.md` | READY |
| geom | `math.geom.curvature` | Curvature | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.curvature.md` | READY |
| geom | `math.geom.differential-geometry-curves` | Curves in Space | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.differential-geometry-curves.md` | READY |
| geom | `math.geom.differential-geometry-surfaces` | Differential Geometry of Surfaces | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.differential-geometry-surfaces.md` | READY |
...
| geom | `math.geom.dot-product` | Dot Product | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.dot-product.md` | READY |
| geom | `math.geom.ellipse` | Ellipse | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.ellipse.md` | READY |
| geom | `math.geom.frenet-serret` | Frenet-Serret Formulas | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.frenet-serret.md` | READY |
...
| geom | `math.geom.hyperbola` | Hyperbola | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.hyperbola.md` | READY |
...
| geom | `math.geom.parabola` | Parabola | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.parabola.md` | READY |
...
| geom | `math.geom.polar-coordinates` | Polar Coordinates | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.polar-coordinates.md` | READY |
| geom | `math.geom.polar-curves` | Polar Curves | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.polar-curves.md` | READY |
...
| geom | `math.geom.rotation` | Rotation | Yes | Yes | `educational-brain/concepts/mathematics/math.geom.rotation.md` | READY |
...
| graph | `math.graph.extremal-graph-theory` | Extremal Graph Theory | Yes | No | — | MISSING |
| graph | `math.graph.graph` | Graph | Yes | No | — | MISSING |
| graph | `math.graph.graph-coloring` | Graph Coloring | No | No | — | MISSING |
| graph | `math.graph.graph-invariants` | Graph Invariants | No | No | — | MISSING |
| graph | `math.graph.graph-operations` | Graph Operations | No | No | — | MISSING |
| graph | `math.graph.hamiltonian-cycle` | Hamiltonian Cycle | Yes | No | — | MISSING |
| graph | `math.graph.matching` | Matching | No | No | — | MISSING |
| graph | `math.graph.maximum-flow` | Maximum Flow | No | No | — | MISSING |
| graph | `math.graph.minimum-spanning-tree` | Minimum Spanning Tree | No | No | — | MISSING |
| graph | `math.graph.ramsey-theory` | Ramsey Theory | No | No | — | MISSING |
| graph | `math.graph.random-graph` | Random Graphs | Yes | No | — | MISSING |
| graph | `math.graph.shortest-path` | Shortest Path Algorithms | No | No | — | MISSING |
| graph | `math.graph.tree` | Tree | No | No | — | MISSING |
| linalg | `math.linalg.angle-vectors` | Angle Between Vectors | No | No | — | MISSING |
| linalg | `math.linalg.augmented-matrix` | Augmented Matrix | Yes | No | — | MISSING |
| linalg | `math.linalg.basis` | Basis | Yes | No | — | MISSING |
| linalg | `math.linalg.change-of-basis` | Change of Basis | No | No | — | MISSING |
| linalg | `math.linalg.characteristic-polynomial` | Characteristic Polynomial | No | No | — | MISSING |
| linalg | `math.linalg.cholesky` | Cholesky Decomposition | Yes | No | — | MISSING |
| linalg | `math.linalg.cofactor-expansion` | Cofactor Expansion | No | No | — | MISSING |
| linalg | `math.linalg.column-space` | Column Space | No | No | — | MISSING |
| linalg | `math.linalg.coordinates` | Coordinates | No | No | — | MISSING |
| linalg | `math.linalg.cramer-rule` | Cramer's Rule | No | No | — | MISSING |
| linalg | `math.linalg.cross-product` | Cross Product | No | No | — | MISSING |
| linalg | `math.linalg.det-properties` | Properties of Determinants | No | No | — | MISSING |
| linalg | `math.linalg.determinant` | Determinant | Yes | No | — | MISSING |
| linalg | `math.linalg.diagonalization` | Diagonalization | No | No | — | MISSING |
| linalg | `math.linalg.dimension` | Dimension | No | No | — | MISSING |
| linalg | `math.linalg.distance` | Distance in Vector Spaces | No | No | — | MISSING |
| linalg | `math.linalg.dot-product` | Dot Product | Yes | No | — | MISSING |
| linalg | `math.linalg.dual-space` | Dual Space | Yes | No | — | MISSING |
| linalg | `math.linalg.eigenspace` | Eigenspace | No | No | — | MISSING |
| linalg | `math.linalg.eigenvalues` | Eigenvalues and Eigenvectors | Yes | No | — | MISSING |
| linalg | `math.linalg.gram-schmidt` | Gram-Schmidt Process | No | No | — | MISSING |
| linalg | `math.linalg.inner-product` | Inner Product | Yes | No | — | MISSING |
| linalg | `math.linalg.inner-product-space` | Inner Product Space | Yes | No | — | MISSING |
| linalg | `math.linalg.jordan-form` | Jordan Normal Form | No | No | — | MISSING |
| linalg | `math.linalg.kernel-image` | Kernel and Image of Linear Map | No | No | — | MISSING |
| linalg | `math.linalg.least-squares` | Least Squares | Yes | No | — | MISSING |
| linalg | `math.linalg.linear-independence` | Linear Independence | Yes | No | — | MISSING |
| linalg | `math.linalg.linear-map` | Linear Map | Yes | No | — | MISSING |
| linalg | `math.linalg.linear-system` | System of Linear Equations | Yes | No | — | MISSING |
| linalg | `math.linalg.lu-factorization` | LU Factorization | Yes | No | — | MISSING |
| linalg | `math.linalg.matrix` | Matrix | Yes | No | — | MISSING |
| linalg | `math.linalg.matrix-addition` | Matrix Addition | No | No | — | MISSING |
| linalg | `math.linalg.matrix-exponential` | Matrix Exponential | No | No | — | MISSING |
| linalg | `math.linalg.matrix-inverse` | Matrix Inverse | Yes | No | — | MISSING |
| linalg | `math.linalg.matrix-multiplication` | Matrix Multiplication | Yes | No | — | MISSING |
| linalg | `math.linalg.matrix-representation` | Matrix Representation of Linear Map | No | No | — | MISSING |
| linalg | `math.linalg.matrix-transpose` | Matrix Transpose | Yes | No | — | MISSING |
| linalg | `math.linalg.norm` | Vector Norm | Yes | No | — | MISSING |
| linalg | `math.linalg.null-space` | Null Space | Yes | No | — | MISSING |
| linalg | `math.linalg.orthogonal-basis` | Orthogonal and Orthonormal Basis | Yes | No | — | MISSING |
| linalg | `math.linalg.orthogonality` | Orthogonality | Yes | No | — | MISSING |
| linalg | `math.linalg.positive-definite` | Positive Definite Matrix | Yes | No | — | MISSING |
| linalg | `math.linalg.projection` | Orthogonal Projection | Yes | No | — | MISSING |
| linalg | `math.linalg.pseudoinverse` | Moore-Penrose Pseudoinverse | No | No | — | MISSING |
| linalg | `math.linalg.qr-factorization` | QR Factorization | No | No | — | MISSING |
| linalg | `math.linalg.rank` | Rank | No | No | — | MISSING |
| linalg | `math.linalg.rank-nullity` | Rank-Nullity Theorem | No | No | — | MISSING |
| linalg | `math.linalg.row-echelon` | Row Echelon Form | Yes | No | — | MISSING |
| linalg | `math.linalg.row-reduction` | Row Reduction | Yes | No | — | MISSING |
| linalg | `math.linalg.scalar-multiplication` | Scalar Multiplication | Yes | No | — | MISSING |
| linalg | `math.linalg.singular-values` | Singular Values | No | No | — | MISSING |
| linalg | `math.linalg.span` | Span | Yes | No | — | MISSING |
| linalg | `math.linalg.spectral-theorem` | Spectral Theorem | Yes | No | — | MISSING |
| linalg | `math.linalg.subspace` | Subspace | Yes | No | — | MISSING |
| linalg | `math.linalg.svd` | Singular Value Decomposition | No | No | — | MISSING |
| linalg | `math.linalg.symmetric-matrix` | Symmetric Matrix | Yes | No | — | MISSING |
| linalg | `math.linalg.tensor` | Tensor | Yes | No | — | MISSING |
| linalg | `math.linalg.unit-vector` | Unit Vector | No | No | — | MISSING |
| linalg | `math.linalg.vector` | Vector | Yes | No | — | MISSING |
| linalg | `math.linalg.vector-addition` | Vector Addition | Yes | No | — | MISSING |
| linalg | `math.linalg.vector-space` | Vector Space | Yes | No | — | MISSING |
| meas | `math.meas.abstract-measure-spaces` | Abstract Measure Spaces | No | No | — | MISSING |
| meas | `math.meas.convergence-theorems` | Convergence Theorems | Yes | No | — | MISSING |
| meas | `math.meas.l2-space` | L² Space | Yes | No | — | MISSING |
| meas | `math.meas.lebesgue-integral` | Lebesgue Integral | Yes | No | — | MISSING |
| meas | `math.meas.lebesgue-measure` | Lebesgue Measure | Yes | No | — | MISSING |
| meas | `math.meas.lp-space` | Lᵖ Spaces | Yes | No | — | MISSING |
| meas | `math.meas.measurable-function` | Measurable Function | Yes | No | — | MISSING |
| meas | `math.meas.measure` | Measure | Yes | No | — | MISSING |
| meas | `math.meas.measure-zero` | Measure Zero | Yes | No | — | MISSING |
| meas | `math.meas.product-measure` | Product Measure and Fubini's Theorem | Yes | No | — | MISSING |
| meas | `math.meas.radon-nikodym` | Radon-Nikodym Theorem | Yes | No | — | MISSING |
| meas | `math.meas.sigma-algebra` | σ-Algebra | Yes | No | — | MISSING |
| meas | `math.meas.simple-function` | Simple Function | Yes | No | — | MISSING |
...
| num | `math.num.floating-point` | Floating-Point Arithmetic | No | No | — | MISSING |
| num | `math.num.interpolation` | Polynomial Interpolation | Yes | No | — | MISSING |
| num | `math.num.iterative-linear` | Iterative Methods for Linear Systems | No | No | — | MISSING |
| num | `math.num.lu-factorization` | LU Factorization (Numerical) | No | No | — | MISSING |
| num | `math.num.newtons-method` | Newton's Method | No | No | — | MISSING |
| num | `math.num.numerical-differentiation` | Numerical Differentiation | No | No | — | MISSING |
| num | `math.num.numerical-integration` | Numerical Integration | No | No | — | MISSING |
| num | `math.num.qr-algorithm` | QR Algorithm | No | No | — | MISSING |
| num | `math.num.root-finding` | Root-Finding Methods | Yes | No | — | MISSING |
| num | `math.num.runge-kutta` | Runge-Kutta Methods | No | No | — | MISSING |
| num | `math.num.splines` | Spline Interpolation | No | No | — | MISSING |
| num | `math.num.stiff-ode` | Stiff ODEs and Implicit Methods | No | No | — | MISSING |
| num | `math.num.svd` | SVD (Numerical) | No | No | — | MISSING |
| opt | `math.opt.convex-function` | Convex Function | Yes | No | — | MISSING |
| opt | `math.opt.convex-optimization` | Convex Optimization | No | No | — | MISSING |
| opt | `math.opt.convex-set` | Convex Set | No | No | — | MISSING |
| opt | `math.opt.duality` | Duality Theory | No | No | — | MISSING |
| opt | `math.opt.dynamic-programming` | Dynamic Programming | No | No | — | MISSING |
| opt | `math.opt.gradient-methods` | Gradient Descent | Yes | No | — | MISSING |
| opt | `math.opt.integer-programming` | Integer Programming | No | No | — | MISSING |
| opt | `math.opt.kkt` | KKT Conditions | No | No | — | MISSING |
| opt | `math.opt.lagrange-multipliers` | Lagrange Multipliers | Yes | No | — | MISSING |
| opt | `math.opt.linear-programming` | Linear Programming | No | No | — | MISSING |
| opt | `math.opt.newton-optimization` | Newton's Method for Optimization | No | No | — | MISSING |
| opt | `math.opt.pca` | Principal Component Analysis | No | No | — | MISSING |
| opt | `math.opt.quadratic-programming` | Quadratic Programming | No | No | — | MISSING |
| opt | `math.opt.semidefinite-programming` | Semidefinite Programming | No | No | — | MISSING |
| opt | `math.opt.stochastic-gradient` | Stochastic Gradient Descent | No | No | — | MISSING |
| opt | `math.opt.unconstrained-optimization` | Unconstrained Optimization | Yes | No | — | MISSING |
| prob | `math.prob.bayes-theorem` | Bayes' Theorem | No | No | — | MISSING |
| prob | `math.prob.bayesian-inference` | Bayesian Inference | No | No | — | MISSING |
| prob | `math.prob.cdf` | Cumulative Distribution Function | Yes | No | — | MISSING |
| prob | `math.prob.characteristic-function` | Characteristic Function | Yes | No | — | MISSING |
| prob | `math.prob.chebyshev` | Chebyshev's Inequality | Yes | No | — | MISSING |
| prob | `math.prob.classical-probability` | Classical Probability | Yes | No | — | MISSING |
| prob | `math.prob.clt` | Central Limit Theorem | Yes | No | — | MISSING |
| prob | `math.prob.combinatorial-probability` | Combinatorial Probability | Yes | No | — | MISSING |
| prob | `math.prob.conditional-distribution` | Conditional Distribution | Yes | No | — | MISSING |
| prob | `math.prob.conditional-expectation` | Conditional Expectation | Yes | No | — | MISSING |
| prob | `math.prob.conditional-probability` | Conditional Probability | Yes | No | — | MISSING |
| prob | `math.prob.continuous-distributions` | Continuous Distributions | Yes | No | — | MISSING |
| prob | `math.prob.continuous-rv` | Continuous Random Variable | Yes | No | — | MISSING |
| prob | `math.prob.convergence-types` | Modes of Convergence | Yes | No | — | MISSING |
| prob | `math.prob.correlation` | Correlation | No | No | — | MISSING |
| prob | `math.prob.covariance` | Covariance | Yes | No | — | MISSING |
| prob | `math.prob.discrete-distributions` | Discrete Distributions | No | No | — | MISSING |
| prob | `math.prob.discrete-rv` | Discrete Random Variable | Yes | No | — | MISSING |
| prob | `math.prob.distribution` | Probability Distribution | Yes | No | — | MISSING |
| prob | `math.prob.ergodicity` | Ergodic Theorem (Markov Chains) | No | No | — | MISSING |
| prob | `math.prob.event` | Event | Yes | No | — | MISSING |
| prob | `math.prob.expected-value` | Expected Value | Yes | No | — | MISSING |
| prob | `math.prob.generating-function` | Probability Generating Function | No | No | — | MISSING |
| prob | `math.prob.independence` | Independence | Yes | No | — | MISSING |
| prob | `math.prob.joint-distribution` | Joint Distribution | Yes | No | — | MISSING |
| prob | `math.prob.law-of-unconscious` | Law of the Unconscious Statistician | No | No | — | MISSING |
| prob | `math.prob.linearity-expectation` | Linearity of Expectation | No | No | — | MISSING |
| prob | `math.prob.lln` | Law of Large Numbers | Yes | No | — | MISSING |
| prob | `math.prob.marginal-distribution` | Marginal Distribution | No | No | — | MISSING |
| prob | `math.prob.markov-chain` | Markov Chain | Yes | No | — | MISSING |
| prob | `math.prob.markov-inequality` | Markov's Inequality | No | No | — | MISSING |
| prob | `math.prob.martingale` | Martingale | Yes | No | — | MISSING |
| prob | `math.prob.mgf` | Moment Generating Function | Yes | No | — | MISSING |
| prob | `math.prob.moments` | Moments | Yes | No | — | MISSING |
| prob | `math.prob.normal-distribution` | Normal Distribution | Yes | No | — | MISSING |
| prob | `math.prob.pdf` | Probability Density Function | Yes | No | — | MISSING |
| prob | `math.prob.pmf` | Probability Mass Function | Yes | No | — | MISSING |
| prob | `math.prob.poisson-process` | Poisson Process | No | No | — | MISSING |
| prob | `math.prob.probability-axioms` | Axioms of Probability | Yes | No | — | MISSING |
| prob | `math.prob.probability-measure` | Probability Measure | Yes | No | — | MISSING |
| prob | `math.prob.quantile` | Quantile | No | No | — | MISSING |
| prob | `math.prob.random-variable` | Random Variable | Yes | No | — | MISSING |
| prob | `math.prob.sample-space` | Sample Space | Yes | No | — | MISSING |
| prob | `math.prob.standard-deviation` | Standard Deviation | No | No | — | MISSING |
| prob | `math.prob.standard-normal` | Standard Normal Distribution | No | No | — | MISSING |
| prob | `math.prob.stationary-distribution` | Stationary Distribution | No | No | — | MISSING |
| prob | `math.prob.total-probability` | Law of Total Probability | No | No | — | MISSING |
| prob | `math.prob.transition-matrix` | Transition Matrix | No | No | — | MISSING |
| prob | `math.prob.variance` | Variance | Yes | No | — | MISSING |
| real | `math.real.absolute-convergence` | Absolute Convergence | No | No | — | MISSING |
| real | `math.real.archimedean` | Archimedean Property | No | No | — | MISSING |
| real | `math.real.baire-category` | Baire Category Theorem | Yes | No | — | MISSING |
| real | `math.real.cauchy-sequence` | Cauchy Sequence | Yes | No | — | MISSING |
| real | `math.real.compactness` | Compactness | Yes | No | — | MISSING |
| real | `math.real.completeness` | Completeness of ℝ | Yes | No | — | MISSING |
| real | `math.real.completeness-metric` | Completeness of Metric Spaces | Yes | No | — | MISSING |
| real | `math.real.connectedness` | Connectedness | Yes | No | — | MISSING |
| real | `math.real.continuity-rigorous` | Continuity (ε-δ) | Yes | No | — | MISSING |
| real | `math.real.convergence-sequences` | Convergence of Sequences | Yes | No | — | MISSING |
| real | `math.real.differentiability-rigorous` | Differentiability (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.extreme-value-theorem` | Extreme Value Theorem | Yes | No | — | MISSING |
| real | `math.real.fixed-point-theorem` | Banach Fixed-Point Theorem | Yes | No | — | MISSING |
| real | `math.real.ftc-rigorous` | Fundamental Theorem of Calculus (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.implicit-function-theorem` | Implicit Function Theorem | Yes | No | — | MISSING |
| real | `math.real.inverse-function-theorem` | Inverse Function Theorem | No | No | — | MISSING |
| real | `math.real.ivt` | Intermediate Value Theorem (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.lipschitz-continuity` | Lipschitz Continuity | Yes | No | — | MISSING |
| real | `math.real.metric-space` | Metric Space | Yes | No | — | MISSING |
| real | `math.real.mvt` | Mean Value Theorem (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.open-sets` | Open and Closed Sets | Yes | No | — | MISSING |
| real | `math.real.pointwise-convergence` | Pointwise Convergence | Yes | No | — | MISSING |
| real | `math.real.riemann-integrability` | Riemann Integrability | Yes | No | — | MISSING |
| real | `math.real.riemann-integral` | Riemann Integral (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.series-rigorous` | Series (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.sup-inf` | Supremum and Infimum | No | No | — | MISSING |
| real | `math.real.taylor-rigorous` | Taylor's Theorem (Rigorous) | Yes | No | — | MISSING |
| real | `math.real.uniform-continuity` | Uniform Continuity | Yes | No | — | MISSING |
| real | `math.real.uniform-convergence` | Uniform Convergence | Yes | No | — | MISSING |
| real | `math.real.weierstrass-approximation` | Weierstrass Approximation Theorem | Yes | No | — | MISSING |
| seq | `math.seq.absolute-convergence` | Absolute and Conditional Convergence | No | No | — | MISSING |
| seq | `math.seq.alternating-series` | Alternating Series | Yes | No | — | MISSING |
| seq | `math.seq.arithmetic-sequence` | Arithmetic Sequence | Yes | No | — | MISSING |
| seq | `math.seq.arithmetic-series` | Arithmetic Series | No | No | — | MISSING |
| seq | `math.seq.comparison-test` | Comparison Test | No | No | — | MISSING |
| seq | `math.seq.convergent` | Convergent Sequence | Yes | No | — | MISSING |
| seq | `math.seq.divergence-test` | Divergence Test (nth Term Test) | No | No | — | MISSING |
| seq | `math.seq.divergent-sequence` | Divergent Sequence | No | No | — | MISSING |
| seq | `math.seq.geometric-sequence` | Geometric Sequence | Yes | No | — | MISSING |
| seq | `math.seq.geometric-series` | Geometric Series | Yes | No | — | MISSING |
| seq | `math.seq.harmonic-series` | Harmonic Series | No | No | — | MISSING |
| seq | `math.seq.infinite-geometric-series` | Infinite Geometric Series | No | No | — | MISSING |
| seq | `math.seq.integral-test` | Integral Test | No | No | — | MISSING |
| seq | `math.seq.partial-sums` | Partial Sums | Yes | No | — | MISSING |
| seq | `math.seq.ratio-test` | Ratio Test | No | No | — | MISSING |
| seq | `math.seq.recursive-sequences` | Recursive Sequences | Yes | No | — | MISSING |
| seq | `math.seq.root-test` | Root Test | No | No | — | MISSING |
| seq | `math.seq.sequence` | Sequence | Yes | No | — | MISSING |
| seq | `math.seq.series` | Series | Yes | No | — | MISSING |
| seq | `math.seq.series-convergence` | Convergence of Series | Yes | No | — | MISSING |
| seq | `math.seq.telescoping-series` | Telescoping Series | No | No | — | MISSING |
| stats | `math.stats.anova` | Analysis of Variance | Yes | No | — | MISSING |
| stats | `math.stats.bayesian-inference` | Bayesian Statistics | No | No | — | MISSING |
| stats | `math.stats.bias-variance` | Bias-Variance Tradeoff | No | No | — | MISSING |
| stats | `math.stats.chi-squared-test` | Chi-Squared Test | No | No | — | MISSING |
| stats | `math.stats.ci-mean` | Confidence Interval for a Mean | No | No | — | MISSING |
| stats | `math.stats.ci-proportion` | Confidence Interval for a Proportion | No | No | — | MISSING |
| stats | `math.stats.confidence-interval` | Confidence Interval | Yes | No | — | MISSING |
| stats | `math.stats.conjugate-prior` | Conjugate Prior | No | No | — | MISSING |
| stats | `math.stats.consistency` | Consistency of Estimators | No | No | — | MISSING |
| stats | `math.stats.correlation` | Sample Correlation | No | No | — | MISSING |
| stats | `math.stats.covariance-matrix` | Covariance Matrix | Yes | No | — | MISSING |
| stats | `math.stats.credible-interval` | Credible Interval | No | No | — | MISSING |
| stats | `math.stats.data-visualization` | Data Visualization | No | No | — | MISSING |
| stats | `math.stats.descriptive-statistics` | Descriptive Statistics | Yes | No | — | MISSING |
| stats | `math.stats.estimator` | Estimator | Yes | No | — | MISSING |
| stats | `math.stats.experimental-design` | Experimental Design | No | No | — | MISSING |
| stats | `math.stats.hypothesis-testing` | Hypothesis Testing | Yes | No | — | MISSING |
| stats | `math.stats.linear-regression` | Simple Linear Regression | No | No | — | MISSING |
| stats | `math.stats.measures-of-center` | Measures of Center | No | No | — | MISSING |
| stats | `math.stats.measures-of-spread` | Measures of Spread | Yes | No | — | MISSING |
| stats | `math.stats.method-of-moments` | Method of Moments | No | No | — | MISSING |
| stats | `math.stats.mle` | Maximum Likelihood Estimation | No | No | — | MISSING |
| stats | `math.stats.multiple-regression` | Multiple Linear Regression | No | No | — | MISSING |
| stats | `math.stats.nonparametric` | Nonparametric Tests | No | No | — | MISSING |
| stats | `math.stats.normal-approximation` | Normal Approximation | No | No | — | MISSING |
| stats | `math.stats.normal-distribution` | Normal Distribution (Statistics) | No | No | — | MISSING |
| stats | `math.stats.p-value` | p-value | No | No | — | MISSING |
| stats | `math.stats.percentile` | Percentile | No | No | — | MISSING |
| stats | `math.stats.population-sample` | Population and Sample | Yes | No | — | MISSING |
| stats | `math.stats.power` | Power of a Test | No | No | — | MISSING |
| stats | `math.stats.rao-blackwell` | Rao-Blackwell Theorem | No | No | — | MISSING |
| stats | `math.stats.sampling` | Sampling Methods | Yes | No | — | MISSING |
| stats | `math.stats.sampling-distribution` | Sampling Distribution | Yes | No | — | MISSING |
| stats | `math.stats.standard-error` | Standard Error | No | No | — | MISSING |
| stats | `math.stats.sufficient-statistic` | Sufficient Statistic | Yes | No | — | MISSING |
| stats | `math.stats.t-test` | t-Test | No | No | — | MISSING |
| stats | `math.stats.test-statistic` | Test Statistic | No | No | — | MISSING |
| stats | `math.stats.two-way-anova` | Two-Way ANOVA | No | No | — | MISSING |
| stats | `math.stats.type-errors` | Type I and Type II Errors | No | No | — | MISSING |
| stats | `math.stats.z-test` | z-Test | No | No | — | MISSING |
| top | `math.top.basis` | Basis for a Topology | No | No | — | MISSING |
| top | `math.top.cohomology` | Cohomology | Yes | No | — | MISSING |
| top | `math.top.compactness` | Compactness (Topology) | Yes | No | — | MISSING |
| top | `math.top.connectedness` | Connectedness (Topology) | Yes | No | — | MISSING |
| top | `math.top.continuity-top` | Continuity (Topology) | Yes | No | — | MISSING |
| top | `math.top.covering-space` | Covering Space | Yes | No | — | MISSING |
| top | `math.top.euler-characteristic` | Euler Characteristic | No | No | — | MISSING |
| top | `math.top.fundamental-group` | Fundamental Group | Yes | No | — | MISSING |
| top | `math.top.homeomorphism` | Homeomorphism | No | No | — | MISSING |
| top | `math.top.homology` | Homology | Yes | No | — | MISSING |
| top | `math.top.homotopy` | Homotopy | Yes | No | — | MISSING |
| top | `math.top.homotopy-equivalence` | Homotopy Equivalence | No | No | — | MISSING |
| top | `math.top.interior-closure` | Interior, Closure, and Boundary | No | No | — | MISSING |
| top | `math.top.manifold` | Topological Manifold | No | No | — | MISSING |
| top | `math.top.open-sets` | Open and Closed Sets (Topology) | Yes | No | — | MISSING |
| top | `math.top.product-space` | Product Topology | Yes | No | — | MISSING |
| top | `math.top.quotient-space` | Quotient Space | Yes | No | — | MISSING |
| top | `math.top.separation-axioms` | Separation Axioms | No | No | — | MISSING |
| top | `math.top.simplicial-complex` | Simplicial Complex | Yes | No | — | MISSING |
| top | `math.top.smooth-manifold` | Smooth Manifold | No | No | — | MISSING |
| top | `math.top.topological-space` | Topological Space | Yes | No | — | MISSING |
| top | `math.top.tychonoff` | Tychonoff's Theorem | Yes | No | — | MISSING |
| top | `math.top.van-kampen` | Seifert-van Kampen Theorem | Yes | No | — | MISSING |
| trig | `math.trig.amplitude-period-phase` | Amplitude, Period, Phase Shift | No | No | — | MISSING |
| trig | `math.trig.angle-measure` | Angle Measure | Yes | No | — | MISSING |
| trig | `math.trig.basic-ratios` | Six Trigonometric Ratios | No | No | — | MISSING |
| trig | `math.trig.de-moivres-theorem` | De Moivre's Theorem | Yes | No | — | MISSING |
| trig | `math.trig.degree-radian-conversion` | Degree-Radian Conversion | No | No | — | MISSING |
| trig | `math.trig.double-angle-formulas` | Double Angle Formulas | No | No | — | MISSING |
| trig | `math.trig.eulers-formula` | Euler's Formula | Yes | No | — | MISSING |
| trig | `math.trig.half-angle-formulas` | Half Angle Formulas | No | No | — | MISSING |
| trig | `math.trig.hyperbolic-functions` | Hyperbolic Functions | Yes | No | — | MISSING |
| trig | `math.trig.inverse-trig` | Inverse Trigonometric Functions | Yes | No | — | MISSING |
| trig | `math.trig.law-of-cosines` | Law of Cosines | No | No | — | MISSING |
| trig | `math.trig.law-of-sines` | Law of Sines | No | No | — | MISSING |
| trig | `math.trig.polar-form-complex` | Polar Form of Complex Numbers | Yes | No | — | MISSING |
| trig | `math.trig.product-to-sum` | Product-to-Sum and Sum-to-Product Formulas | Yes | No | — | MISSING |
| trig | `math.trig.pythagorean-identities` | Pythagorean Identities | No | No | — | MISSING |
| trig | `math.trig.reciprocal-identities` | Reciprocal Identities | No | No | — | MISSING |
| trig | `math.trig.reference-angles` | Reference Angles | Yes | No | — | MISSING |
| trig | `math.trig.right-triangle-trig` | Right-Triangle Trigonometry | Yes | No | — | MISSING |
| trig | `math.trig.special-angles` | Trigonometric Values at Special Angles | No | No | — | MISSING |
| trig | `math.trig.sum-difference-formulas` | Sum and Difference Formulas | Yes | No | — | MISSING |
| trig | `math.trig.trig-equations` | Trigonometric Equations | No | No | — | MISSING |
| trig | `math.trig.trig-functions` | Trigonometric Functions | Yes | No | — | MISSING |
| trig | `math.trig.trig-graphs` | Graphs of Trigonometric Functions | No | No | — | MISSING |
...
| em | `phys.em.dc-circuits` | Series and Parallel Circuits | Yes | Yes | `educational-brain/concepts/physics/phys.em.dc-circuits.md` | READY |
| em | `phys.em.dielectrics` | Dielectrics and Polarization | Yes | Yes | `educational-brain/concepts/physics/phys.em.dielectrics.md` | READY |
| em | `phys.em.electric-charge` | Electric Charge and Conservation | Yes | Yes | `educational-brain/concepts/physics/phys.em.electric-charge.md` | READY |
| em | `phys.em.electric-current` | Electric Current and Drift Velocity | Yes | Yes | `educational-brain/concepts/physics/phys.em.electric-current.md` | READY |
| em | `phys.em.electric-dipole` | Electric Dipole | Yes | Yes | `educational-brain/concepts/physics/phys.em.electric-dipole.md` | READY |
| em | `phys.em.electric-field` | Electric Field and Field Lines | Yes | Yes | `educational-brain/concepts/physics/phys.em.electric-field.md` | READY |
| em | `phys.em.electric-potential` | Electric Potential and Potential Difference | Yes | Yes | `educational-brain/concepts/physics/phys.em.electric-potential.md` | READY |
| em | `phys.em.electrical-power` | Electrical Power and Joule Heating | Yes | Yes | `educational-brain/concepts/physics/phys.em.electrical-power.md` | READY |
| em | `phys.em.electromagnetic-waves` | Electromagnetic Waves and the EM Spectrum | Yes | Yes | `educational-brain/concepts/physics/phys.em.electromagnetic-waves.md` | READY |
| em | `phys.em.emf` | EMF, Internal Resistance, and Terminal Voltage | Yes | Yes | `educational-brain/concepts/physics/phys.em.emf.md` | READY |
| em | `phys.em.energy-capacitor` | Energy Stored in a Capacitor | Yes | Yes | `educational-brain/concepts/physics/phys.em.energy-capacitor.md` | READY |
| em | `phys.em.faradays-law` | Faraday's Law of Electromagnetic Induction | Yes | Yes | `educational-brain/concepts/physics/phys.em.faradays-law.md` | READY |
| em | `phys.em.gauss-law` | Gauss's Law | Yes | Yes | `educational-brain/concepts/physics/phys.em.gauss-law.md` | READY |
| em | `phys.em.kirchhoffs-laws` | Kirchhoff's Current and Voltage Laws | Yes | Yes | `educational-brain/concepts/physics/phys.em.kirchhoffs-laws.md` | READY |
| em | `phys.em.lc-circuits` | LC Oscillations and Resonance | Yes | Yes | `educational-brain/concepts/physics/phys.em.lc-circuits.md` | READY |
...
| em | `phys.em.magnetic-force` | Magnetic Force on Moving Charges — Lorentz Force | Yes | Yes | `educational-brain/concepts/physics/phys.em.magnetic-force.md` | READY |
...
| em | `phys.em.maxwells-equations` | Maxwell's Equations and Displacement Current | Yes | Yes | `educational-brain/concepts/physics/phys.em.maxwells-equations.md` | READY |
| em | `phys.em.mutual-inductance` | Mutual Inductance and Transformers | Yes | Yes | `educational-brain/concepts/physics/phys.em.mutual-inductance.md` | READY |
| em | `phys.em.ohms-law` | Ohm's Law and Resistance | Yes | Yes | `educational-brain/concepts/physics/phys.em.ohms-law.md` | READY |
| em | `phys.em.potentiometer` | Potentiometer | Yes | Yes | `educational-brain/concepts/physics/phys.em.potentiometer.md` | READY |
| em | `phys.em.rc-circuits` | RC Circuits: Charging and Discharging | Yes | Yes | `educational-brain/concepts/physics/phys.em.rc-circuits.md` | READY |
| em | `phys.em.resistivity` | Resistivity and Conductivity | Yes | Yes | `educational-brain/concepts/physics/phys.em.resistivity.md` | READY |
| em | `phys.em.self-inductance` | Self-Inductance | Yes | Yes | `educational-brain/concepts/physics/phys.em.self-inductance.md` | READY |
| em | `phys.em.solenoid` | Magnetic Field of a Solenoid and Toroid | Yes | Yes | `educational-brain/concepts/physics/phys.em.solenoid.md` | READY |
| em | `phys.em.wheatstone-bridge` | Wheatstone Bridge | Yes | Yes | `educational-brain/concepts/physics/phys.em.wheatstone-bridge.md` | READY |
| meas | `phys.meas.dimensions` | Dimensional Analysis | Yes | Yes | `educational-brain/concepts/physics/phys.meas.dimensions.md` | READY |
| meas | `phys.meas.errors` | Measurement Errors and Uncertainty | Yes | Yes | `educational-brain/concepts/physics/phys.meas.errors.md` | READY |
| meas | `phys.meas.scalars-vectors` | Scalar and Vector Quantities | Yes | Yes | `educational-brain/concepts/physics/phys.meas.scalars-vectors.md` | READY |
| meas | `phys.meas.significant-figures` | Significant Figures and Precision | Yes | Yes | `educational-brain/concepts/physics/phys.meas.significant-figures.md` | READY |
| meas | `phys.meas.unit-conversion` | Unit Conversion and Prefixes | Yes | Yes | `educational-brain/concepts/physics/phys.meas.unit-conversion.md` | READY |
| meas | `phys.meas.units` | SI Units and Measurement | Yes | Yes | `educational-brain/concepts/physics/phys.meas.units.md` | READY |
| meas | `phys.meas.vector-addition` | Vector Addition and Resolution | Yes | Yes | `educational-brain/concepts/physics/phys.meas.vector-addition.md` | READY |
...
| mech | `phys.mech.keplers-laws` | Kepler's Laws of Planetary Motion | Yes | Yes | `educational-brain/concepts/physics/phys.mech.keplers-laws.md` | READY |
| mech | `phys.mech.kinematics-1d` | Kinematics in One Dimension | Yes | Yes | `educational-brain/concepts/physics/phys.mech.kinematics-1d.md` | READY |
| mech | `phys.mech.kinematics-2d` | Kinematics in Two Dimensions | Yes | Yes | `educational-brain/concepts/physics/phys.mech.kinematics-2d.md` | READY |
| mech | `phys.mech.kinetic-energy` | Kinetic Energy | Yes | Yes | `educational-brain/concepts/physics/phys.mech.kinetic-energy.md` | READY |
| mech | `phys.mech.moment-of-inertia` | Moment of Inertia | Yes | Yes | `educational-brain/concepts/physics/phys.mech.moment-of-inertia.md` | READY |
| mech | `phys.mech.momentum` | Linear Momentum | Yes | Yes | `educational-brain/concepts/physics/phys.mech.momentum.md` | READY |
| mech | `phys.mech.newtons-first-law` | Newton's First Law — Inertia | Yes | Yes | `educational-brain/concepts/physics/phys.mech.newtons-first-law.md` | READY |
| mech | `phys.mech.newtons-second-law` | Newton's Second Law — F=ma | Yes | Yes | `educational-brain/concepts/physics/phys.mech.newtons-second-law.md` | READY |
...
| mech | `phys.mech.surface-tension` | Surface Tension and Capillarity | Yes | Yes | `educational-brain/concepts/physics/phys.mech.surface-tension.md` | READY |
| mech | `phys.mech.tension` | Tension in Strings and Ropes | Yes | Yes | `educational-brain/concepts/physics/phys.mech.tension.md` | READY |
| mech | `phys.mech.torque` | Torque | Yes | Yes | `educational-brain/concepts/physics/phys.mech.torque.md` | READY |
...
| opt | `phys.opt.lens-power` | Power of a Lens and Lens Combinations | Yes | Yes | `educational-brain/concepts/physics/phys.opt.lens-power.md` | READY |
...
| opt | `phys.opt.single-slit` | Single-Slit Diffraction | Yes | Yes | `educational-brain/concepts/physics/phys.opt.single-slit.md` | READY |
...
| qm | `phys.qm.identical-particles` | Identical Particles and the Symmetrization Postulate | Yes | Yes | `educational-brain/concepts/physics/phys.qm.identical-particles.md` | READY |
...
| stat | `phys.stat.fermi-dirac` | Fermi-Dirac Statistics | Yes | Yes | `educational-brain/concepts/physics/phys.stat.fermi-dirac.md` | READY |
...
| therm | `phys.therm.heat-transfer` | Heat Transfer: Conduction, Convection, Radiation | Yes | Yes | `educational-brain/concepts/physics/phys.therm.heat-transfer.md` | READY |
| therm | `phys.therm.ideal-gas-law` | Ideal Gas Law | Yes | Yes | `educational-brain/concepts/physics/phys.therm.ideal-gas-law.md` | READY |
...
| wave | `phys.wave.forced-oscillations` | Forced Oscillations and Resonance | Yes | Yes | `educational-brain/concepts/physics/phys.wave.forced-oscillations.md` | READY |
| wave | `phys.wave.interference` | Wave Interference | Yes | Yes | `educational-brain/concepts/physics/phys.wave.interference.md` | READY |
| wave | `phys.wave.longitudinal-waves` | Longitudinal Waves | Yes | Yes | `educational-brain/concepts/physics/phys.wave.longitudinal-waves.md` | READY |
| wave | `phys.wave.pendulum` | Simple Pendulum | Yes | Yes | `educational-brain/concepts/physics/phys.wave.pendulum.md` | READY |
| wave | `phys.wave.shm` | Simple Harmonic Motion | Yes | Yes | `educational-brain/concepts/physics/phys.wave.shm.md` | READY |
| wave | `phys.wave.shm-energy` | Energy in Simple Harmonic Motion | Yes | Yes | `educational-brain/concepts/physics/phys.wave.shm-energy.md` | READY |
...
| wave | `phys.wave.spring-mass` | Spring-Mass System | Yes | Yes | `educational-brain/concepts/physics/phys.wave.spring-mass.md` | READY |
...
| communication | `eng.communication.cross-cultural-communication` | Cross-Cultural Communication | Yes | No | — | MISSING |
| communication | `eng.communication.digital-communication` | Digital Communication | Yes | No | — | MISSING |
| communication | `eng.communication.discourse-markers-advanced` | Advanced Discourse Markers | Yes | No | — | MISSING |
| communication | `eng.communication.editing-for-publication` | Editing for Publication | Yes | No | — | MISSING |
| communication | `eng.communication.media-literacy` | Media Literacy | Yes | No | — | MISSING |
...
| composition | `eng.composition.figurative-language-in-composition` | Figurative Language in Composition | Yes | No | — | MISSING |
| composition | `eng.composition.logical-fallacies` | Logical Fallacies | Yes | No | — | MISSING |
...
| literature | `eng.literature.narrative-elements` | Narrative Elements | Yes | No | — | MISSING |
...
## chemistry (186 concepts, 136 READY)
| Domain | KG ID | Concept Name | Blueprint | EB Entry | EB File | Status |
|---|---|---|---|---|---|---|
| alc | `chem.alc.alcohols` | Alcohols | No | No | — | MISSING |
| alc | `chem.alc.diols` | Diols and Polyols | No | No | — | MISSING |
| alc | `chem.alc.epoxides` | Epoxides | No | No | — | MISSING |
...
| anal | `chem.anal.spectroscopy` | Spectroscopic Methods | No | `educational-brain/concepts/chemistry/chem.anal.spectroscopy.md` | READY |
| anal | `chem.anal.volumetric` | Volumetric Analysis | No | `educational-brain/concepts/chemistry/chem.anal.volumetric.md` | READY |
...
| bio | `chem.bio.lipids` | Lipids | No | No | — | MISSING |
...
| bond | `chem.bond.intermolecular` | Intermolecular Forces | No | `educational-brain/concepts/chemistry/chem.bond.intermolecular.md` | READY |
...
| carb | `chem.carb.derivatives` | Carboxylic Acid Derivatives | No | No | — | MISSING |
| carb | `chem.carb.ketones` | Ketones | No | No | — | MISSING |
| carb | `chem.carb.named-reactions` | Named Carbonyl Reactions | No | No | — | MISSING |
| carb | `chem.carb.spectro` | Spectroscopic ID of Carbonyls | No | No | — | MISSING |
| coord | `chem.coord.applications` | Applications of Coordination Chemistry | No | Yes | `educational-brain/concepts/chemistry/chem.coord.applications.md` | READY |
| coord | `chem.coord.bonding` | Bonding in Complexes | No | Yes | `educational-brain/concepts/chemistry/chem.coord.bonding.md` | READY |
| coord | `chem.coord.cft` | Crystal Field Theory | No | `educational-brain/concepts/chemistry/chem.coord.cft.md` | READY |
| coord | `chem.coord.isomerism` | Isomerism in Complexes | No | Yes | `educational-brain/concepts/chemistry/chem.coord.isomerism.md` | READY |
| coord | `chem.coord.nomenclature` | Nomenclature of Complexes | No | `educational-brain/concepts/chemistry/chem.coord.nomenclature.md` | READY |
| coord | `chem.coord.stability` | Stability Constants | No | `educational-brain/concepts/chemistry/chem.coord.stability.md` | READY |
...
| dblock | `chem.dblock.organometallics` | Organometallic Chemistry | No | Yes | `educational-brain/concepts/chemistry/chem.dblock.organometallics.md` | READY |
| dblock | `chem.dblock.oxo-species` | Oxides and Oxyanions of Transition Metals | No | `educational-brain/concepts/chemistry/chem.dblock.oxo-species.md` | READY |
| elect | `chem.elect.batteries` | Batteries and Fuel Cells | No | Yes | `educational-brain/concepts/chemistry/chem.elect.batteries.md` | READY |
| elect | `chem.elect.concentration-cell` | Concentration Cells | No | No | — | MISSING |
| elect | `chem.elect.conductance` | Electrolytic Conductance | No | Yes | `educational-brain/concepts/chemistry/chem.elect.conductance.md` | READY |
| elect | `chem.elect.corrosion` | Corrosion | No | Yes | `educational-brain/concepts/chemistry/chem.elect.corrosion.md` | READY |
| elect | `chem.elect.electrolysis` | Electrolysis and Faraday's Laws | No | Yes | `educational-brain/concepts/chemistry/chem.elect.electrolysis.md` | READY |
| elect | `chem.elect.galvanic-cell` | Galvanic Cell | No | `educational-brain/concepts/chemistry/chem.elect.galvanic-cell.md` | READY |
| elect | `chem.elect.industrial` | Industrial Electrolysis | No | No | — | MISSING |
| elect | `chem.elect.nernst` | Nernst Equation | No | No | — | MISSING |
| elect | `chem.elect.standard-electrode` | Standard Electrode Potential | No | Yes | `educational-brain/concepts/chemistry/chem.elect.standard-electrode.md` | READY |
...
| found | `chem.found.mole-concept` | Mole Concept and Avogadro's Number | No | Yes | `educational-brain/concepts/chemistry/chem.found.mole-concept.md` | READY |
| found | `chem.found.pure-substances` | Pure Substances and Mixtures | No | Yes | `educational-brain/concepts/chemistry/chem.found.pure-substances.md` | READY |
| found | `chem.found.significant-figures` | Significant Figures and Error Analysis | No | Yes | `educational-brain/concepts/chemistry/chem.found.significant-figures.md` | READY |
| found | `chem.found.states-of-matter` | States of Matter | No | Yes | `educational-brain/concepts/chemistry/chem.found.states-of-matter.md` | READY |
| found | `chem.found.stoichiometry` | Stoichiometry | No | Yes | `educational-brain/concepts/chemistry/chem.found.stoichiometry.md` | READY |
| hal | `chem.hal.cfcs` | Polyhalogen Compounds and CFCs | No | No | — | MISSING |
| hal | `chem.hal.elimination` | Elimination Reactions | No | No | — | MISSING |
| hal | `chem.hal.grignard` | Grignard and Organolithium Reagents | No | No | — | MISSING |
| hal | `chem.hal.haloarenes` | Haloarenes | No | No | — | MISSING |
| hal | `chem.hal.introduction` | Haloalkanes and Haloarenes | No | Yes | `educational-brain/concepts/chemistry/chem.hal.introduction.md` | READY |
| hal | `chem.hal.sn1` | SN1 Mechanism | No | No | — | MISSING |
| hal | `chem.hal.sn2` | SN2 Mechanism | No | No | — | MISSING |
| hyd | `chem.hyd.alkanes` | Alkanes | No | `educational-brain/concepts/chemistry/chem.hyd.alkanes.md` | READY |
| hyd | `chem.hyd.alkenes` | Alkenes | No | No | — | MISSING |
| hyd | `chem.hyd.alkynes` | Alkynes | No | No | — | MISSING |
| hyd | `chem.hyd.arenes` | Benzene and Arenes | No | Yes | `educational-brain/concepts/chemistry/chem.hyd.arenes.md` | READY |
| hyd | `chem.hyd.conformations` | Conformational Analysis | No | Yes | `educational-brain/concepts/chemistry/chem.hyd.conformations.md` | READY |
| hyd | `chem.hyd.petroleum` | Petroleum Refining | No | Yes | `educational-brain/concepts/chemistry/chem.hyd.petroleum.md` | READY |
...
| nitro | `chem.nitro.heterocycles` | Nitrogen Heterocycles | No | No | — | MISSING |
| nitro | `chem.nitro.nitro-compounds` | Nitro Compounds | No | No | — | MISSING |
| org | `chem.org.aromaticity` | Aromaticity | No | `educational-brain/concepts/chemistry/chem.org.aromaticity.md` | READY |
| org | `chem.org.arrow-pushing` | Electron Flow and Arrow Notation | No | No | — | MISSING |
| org | `chem.org.electronic-effects` | Inductive and Mesomeric Effects | No | `educational-brain/concepts/chemistry/chem.org.electronic-effects.md` | READY |
| org | `chem.org.hybridization` | Carbon Hybridization | No | `educational-brain/concepts/chemistry/chem.org.hybridization.md` | READY |
| org | `chem.org.isomerism` | Structural and Stereoisomerism | No | `educational-brain/concepts/chemistry/chem.org.isomerism.md` | READY |
...
| org | `chem.org.qualitative-analysis` | Qualitative Organic Analysis | No | `educational-brain/concepts/chemistry/chem.org.qualitative-analysis.md` | READY |
| org | `chem.org.reactive-intermediates` | Reactive Intermediates | No | Yes | `educational-brain/concepts/chemistry/chem.org.reactive-intermediates.md` | READY |
...
| sblock | `chem.sblock.water` | Chemistry of Water | No | Yes | `educational-brain/concepts/chemistry/chem.sblock.water.md` | READY |
...
| solid | `chem.solid.ionic-solids` | Ionic Crystal Structures | No | `educational-brain/concepts/chemistry/chem.solid.ionic-solids.md` | READY |
...
| solid | `chem.solid.properties` | Electrical and Magnetic Properties | No | `educational-brain/concepts/chemistry/chem.solid.properties.md` | READY |
...
| state | `chem.state.liquids` | Liquid State Properties | No | Yes | `educational-brain/concepts/chemistry/chem.state.liquids.md` | READY |
...
| bioinfo | `bio.bioinfo.phylogenetics-computational` | Computational Phylogenetics | No | No | — | MISSING |
| bioinfo | `bio.bioinfo.sequence-alignment` | Sequence Alignment | No | No | — | MISSING |
| bioinfo | `bio.bioinfo.structural-bioinformatics` | Structural Bioinformatics | No | No | — | MISSING |
| biotech | `bio.biotech.biotech-principles` | Principles of Biotechnology | No | No | — | MISSING |
...
| cell | `bio.cell.cell-theory` | Cell Theory | No | No | — | MISSING |
| cell | `bio.cell.chloroplast-structure` | Chloroplast Structure | No | No | — | MISSING |
| cell | `bio.cell.cytoskeleton` | Cytoskeleton and Cell Motility | No | No | — | MISSING |
| cell | `bio.cell.endomembrane-system` | Endomembrane System | No | No | — | MISSING |
| cell | `bio.cell.eukaryotic-cell` | Eukaryotic Cell Structure | No | No | — | MISSING |
| cell | `bio.cell.meiosis` | Meiosis | No | No | — | MISSING |
| cell | `bio.cell.mitochondria-energy` | Mitochondria and Energy Organelles | No | No | — | MISSING |
| cell | `bio.cell.mitosis` | Mitosis | No | No | — | MISSING |
| cell | `bio.cell.nucleus-chromosomes` | Nucleus and Chromosomes | No | No | — | MISSING |
| cell | `bio.cell.prokaryotic-cell` | Prokaryotic Cell Structure | No | No | — | MISSING |
...
| found | `bio.found.biomes-levels-of-organisation` | Levels of Biological Organisation | No | No | — | MISSING |
| found | `bio.found.characteristics-of-life` | Characteristics of Living Organisms | No | No | — | MISSING |
| found | `bio.found.classification-need` | Need for Classification | No | No | — | MISSING |
| found | `bio.found.five-kingdom` | Five Kingdom Classification | No | No | — | MISSING |
| found | `bio.found.microscopy-basics` | Microscopy and Laboratory Techniques | No | No | — | MISSING |
| found | `bio.found.viruses-viroids-lichens` | Viruses, Viroids and Lichens | No | No | — | MISSING |
| found | `bio.found.what-is-biology` | What is Biology | No | No | — | MISSING |
| gen | `bio.gen.chromosomal-theory-linkage` | Chromosomal Theory and Linkage | No | No | — | MISSING |
| gen | `bio.gen.gene-interactions` | Gene Interactions and Extensions of Mendelism | No | No | — | MISSING |
| gen | `bio.gen.genetic-engineering` | Genetic Engineering and Recombinant DNA | No | No | — | MISSING |
| gen | `bio.gen.mendelian-genetics` | Mendelian Genetics | No | No | — | MISSING |
...
| physio | `bio.physio.digestive-system` | Human Digestive System | No | No | — | MISSING |
| physio | `bio.physio.endocrine-system` | Endocrine System | No | No | — | MISSING |
| physio | `bio.physio.excretory-system` | Excretory System and Osmoregulation | No | No | — | MISSING |
| physio | `bio.physio.immune-system-intro` | Immune System Overview | No | No | — | MISSING |
| physio | `bio.physio.musculoskeletal-system` | Locomotion and Musculoskeletal System | No | No | — | MISSING |
| physio | `bio.physio.nervous-system` | Nervous System and Neural Control | No | No | — | MISSING |
| physio | `bio.physio.respiratory-system` | Human Respiratory System | No | No | — | MISSING |
| plant | `bio.plant.mineral-nutrition` | Mineral Nutrition in Plants | No | No | — | MISSING |
| plant | `bio.plant.photosynthesis` | Photosynthesis | No | No | — | MISSING |
| plant | `bio.plant.plant-growth-hormones` | Plant Growth and Hormones | No | No | — | MISSING |
| plant | `bio.plant.plant-respiration` | Respiration in Plants | No | No | — | MISSING |
| plant | `bio.plant.plant-water-relations` | Plant Water Relations | No | No | — | MISSING |
| repro | `bio.repro.asexual-reproduction` | Asexual Reproduction | No | No | — | MISSING |
| repro | `bio.repro.fertilisation-development` | Fertilisation and Embryonic Development | No | No | — | MISSING |
| repro | `bio.repro.human-reproductive-system` | Human Reproductive System | No | No | — | MISSING |
| repro | `bio.repro.reproductive-health` | Reproductive Health and Contraception | No | No | — | MISSING |
| repro | `bio.repro.sexual-reproduction-plants` | Sexual Reproduction in Flowering Plants | No | No | — | MISSING |
| sys | `bio.sys.gene-regulatory-networks` | Gene Regulatory Networks | No | No | — | MISSING |
| sys | `bio.sys.metabolic-network-modelling` | Metabolic Network Modelling | No | No | — | MISSING |
| sys | `bio.sys.synthetic-biology` | Synthetic Biology | No | No | — | MISSING |
...
| algo | `cs.algo.asymptotic-notation` | Asymptotic Notation | No | No | — | MISSING |
| algo | `cs.algo.backtracking` | Backtracking | No | No | — | MISSING |
| algo | `cs.algo.divide-and-conquer` | Divide and Conquer | No | No | — | MISSING |
| algo | `cs.algo.dynamic-programming` | Dynamic Programming | No | No | — | MISSING |
| algo | `cs.algo.flowcharts` | Flowcharts and Pseudocode | No | No | — | MISSING |
| algo | `cs.algo.greedy-algorithms` | Greedy Algorithms | No | No | — | MISSING |
| algo | `cs.algo.np-completeness` | NP-Completeness and Intractability | No | No | — | MISSING |
| algo | `cs.algo.problem-solving` | Problem Solving Methodology | No | No | — | MISSING |
| algo | `cs.algo.time-space-complexity` | Time and Space Complexity Analysis | No | No | — | MISSING |
| control | `cs.control.conditionals` | Conditional Statements | No | No | — | MISSING |
| control | `cs.control.loops` | Iteration — while and for Loops | No | No | — | MISSING |
| control | `cs.control.nested-control-patterns` | Nested Control Flow Patterns | No | No | — | MISSING |
| data | `cs.data.comprehensions-iterators` | Comprehensions, Iterators and Generators | No | No | — | MISSING |
| data | `cs.data.dictionaries` | Dictionaries | No | No | — | MISSING |
| data | `cs.data.lists` | Lists | No | No | — | MISSING |
| data | `cs.data.sets` | Sets | No | No | — | MISSING |
| data | `cs.data.strings` | Strings | No | No | — | MISSING |
| data | `cs.data.tuples` | Tuples | No | No | — | MISSING |
| db | `cs.db.database-concepts` | Database Concepts | No | No | — | MISSING |
| db | `cs.db.er-modeling` | Entity-Relationship Modeling | No | No | — | MISSING |
| db | `cs.db.indexing-query-optimisation` | Indexing and Query Optimisation | No | No | — | MISSING |
| db | `cs.db.mysql-python` | Connecting Python to MySQL | No | No | — | MISSING |
| db | `cs.db.normalisation` | Normalisation | No | No | — | MISSING |
| db | `cs.db.nosql-intro` | Introduction to NoSQL Databases | No | No | — | MISSING |
| db | `cs.db.relational-model` | The Relational Model | No | No | — | MISSING |
| db | `cs.db.sql-ddl-dml` | SQL — DDL and DML Basics | No | No | — | MISSING |
| db | `cs.db.sql-joins-subqueries` | SQL — Joins and Subqueries | No | No | — | MISSING |
| db | `cs.db.sql-queries-functions` | SQL — Queries and Aggregate Functions | No | No | — | MISSING |
| db | `cs.db.transactions-acid` | Transactions and the ACID Properties | No | No | — | MISSING |
| ds | `cs.ds.data-visualisation` | Data Visualisation with Matplotlib | No | No | — | MISSING |
| ds | `cs.ds.intro-machine-learning` | Introduction to Machine Learning | No | No | — | MISSING |
| ds | `cs.ds.neural-networks-intro` | Introduction to Neural Networks | No | No | — | MISSING |
| ds | `cs.ds.numpy-arrays` | NumPy for Numerical Computing | No | No | — | MISSING |
| ds | `cs.ds.pandas-dataframes` | Pandas for Data Analysis | No | No | — | MISSING |
| ds | `cs.ds.supervised-learning-models` | Supervised Learning Models | No | No | — | MISSING |
| ds | `cs.ds.unsupervised-learning-models` | Unsupervised Learning Models | No | No | — | MISSING |
| file | `cs.file.binary-serialisation` | Binary Files and Serialisation | No | No | — | MISSING |
| file | `cs.file.csv-files` | CSV File Handling | No | No | — | MISSING |
| file | `cs.file.text-files` | Text File Handling | No | No | — | MISSING |
| found | `cs.found.boolean-logic` | Boolean Logic and Logic Gates | No | No | — | MISSING |
| found | `cs.found.computer-organisation` | Computer Organisation | No | No | — | MISSING |
| found | `cs.found.cpu-architecture` | CPU Architecture and Instruction Sets | No | No | — | MISSING |
| found | `cs.found.intro-computers` | Introduction to Computers | No | No | — | MISSING |
| found | `cs.found.memory-storage` | Memory and Storage Systems | No | No | — | MISSING |
| found | `cs.found.number-systems` | Number Systems | No | No | — | MISSING |
| found | `cs.found.os-concepts` | Operating System Fundamentals | No | No | — | MISSING |
| found | `cs.found.pipelining-cache` | Pipelining and Cache Memory | No | No | — | MISSING |
| found | `cs.found.software-concepts` | Software Concepts | No | No | — | MISSING |
| func | `cs.func.decorators` | Decorators | No | No | — | MISSING |
| func | `cs.func.functions` | Functions | No | No | — | MISSING |
| func | `cs.func.lambda-functional` | Lambda Expressions and Functional Tools | No | No | — | MISSING |
| func | `cs.func.modules-packages` | Modules and Packages | No | No | — | MISSING |
| func | `cs.func.recursion` | Recursion | No | No | — | MISSING |
| func | `cs.func.scope-namespaces` | Scope and Namespaces | No | No | — | MISSING |
| net | `cs.net.application-protocols` | Application-Layer Protocols | No | No | — | MISSING |
| net | `cs.net.cloud-computing` | Cloud Computing | No | No | — | MISSING |
| net | `cs.net.dns-dhcp` | DNS and DHCP | No | No | — | MISSING |
| net | `cs.net.ip-addressing` | IP Addressing and Subnetting | No | No | — | MISSING |
| net | `cs.net.networking-basics` | Networking Basics | No | No | — | MISSING |
| net | `cs.net.osi-tcp-ip-models` | OSI and TCP/IP Reference Models | No | No | — | MISSING |
| net | `cs.net.routing-congestion` | Routing and Congestion Control | No | No | — | MISSING |
| net | `cs.net.tcp-udp-transport` | TCP and UDP — Transport Layer | No | No | — | MISSING |
| net | `cs.net.wireless-mobile-networks` | Wireless and Mobile Networks | No | No | — | MISSING |
| oop | `cs.oop.class-static-methods` | Class Methods and Static Methods | No | No | — | MISSING |
| oop | `cs.oop.classes-objects-python` | Classes and Objects in Python | No | No | — | MISSING |
| oop | `cs.oop.design-patterns-intro` | Introduction to Design Patterns | No | No | — | MISSING |
| oop | `cs.oop.encapsulation-abstraction` | Encapsulation and Abstraction | No | No | — | MISSING |
| oop | `cs.oop.inheritance` | Inheritance | No | No | — | MISSING |
| oop | `cs.oop.oop-concepts` | Object-Oriented Programming Concepts | No | No | — | MISSING |
| oop | `cs.oop.polymorphism-overloading` | Polymorphism and Operator Overloading | No | No | — | MISSING |
| os | `cs.os.cpu-scheduling` | CPU Scheduling Algorithms | No | No | — | MISSING |
| os | `cs.os.file-systems` | File Systems | No | No | — | MISSING |
| os | `cs.os.memory-management-os` | Memory Management | No | No | — | MISSING |
| os | `cs.os.process-management` | Process Management | No | No | — | MISSING |
| os | `cs.os.synchronisation-deadlocks` | Synchronisation and Deadlocks | No | No | — | MISSING |
| os | `cs.os.threads-concurrency` | Threads and Concurrency | No | No | — | MISSING |
| os | `cs.os.virtual-memory` | Virtual Memory | No | No | — | MISSING |
| prog | `cs.prog.data-types-variables` | Data Types and Variables | No | No | — | MISSING |
| prog | `cs.prog.exception-handling` | Exception Handling | No | No | — | MISSING |
| prog | `cs.prog.input-output` | Input, Output and Formatting | No | No | — | MISSING |
| prog | `cs.prog.intro-programming` | Introduction to Programming | No | No | — | MISSING |
| prog | `cs.prog.operators-expressions` | Operators and Expressions | No | No | — | MISSING |
| prog | `cs.prog.python-basics` | Python Language Basics | No | No | — | MISSING |
| prog | `cs.prog.type-conversion` | Type Conversion and Casting | No | No | — | MISSING |
| se | `cs.se.agile-design-principles` | Agile Practices and Software Design Principles | No | No | — | MISSING |
| se | `cs.se.sdlc` | Software Development Life Cycle | No | No | — | MISSING |
| se | `cs.se.software-testing` | Software Testing Fundamentals | No | No | — | MISSING |
| se | `cs.se.version-control-git` | Version Control with Git | No | No | — | MISSING |
| sec | `cs.sec.cryptography-basics` | Cryptography Fundamentals | No | No | — | MISSING |
| sec | `cs.sec.cyber-ethics-safety` | Cyber Ethics and Online Safety | No | No | — | MISSING |
| sec | `cs.sec.data-protection-privacy` | Data Protection and Privacy | No | No | — | MISSING |
| sec | `cs.sec.network-web-security` | Network and Web Security | No | No | — | MISSING |
| struct | `cs.struct.balanced-trees` | Balanced Search Trees | No | No | — | MISSING |
| struct | `cs.struct.binary-search` | Binary Search | No | No | — | MISSING |
| struct | `cs.struct.binary-search-trees` | Binary Search Trees | No | No | — | MISSING |
| struct | `cs.struct.deques-priority-queues` | Deques and Priority Queues | No | No | — | MISSING |
| struct | `cs.struct.doubly-circular-lists` | Doubly and Circular Linked Lists | No | No | — | MISSING |
| struct | `cs.struct.efficient-sorts` | Efficient Sorting — Merge Sort and Quick Sort | No | No | — | MISSING |
| struct | `cs.struct.elementary-sorts` | Elementary Sorting — Bubble, Selection, Insertion | No | No | — | MISSING |
| struct | `cs.struct.graph-traversal` | Graph Traversal — BFS and DFS | No | No | — | MISSING |
| struct | `cs.struct.graphs-representation` | Graphs and Their Representations | No | No | — | MISSING |
| struct | `cs.struct.hashing-hash-tables` | Hashing and Hash Tables | No | No | — | MISSING |
| struct | `cs.struct.heaps` | Heaps | No | No | — | MISSING |
| struct | `cs.struct.linear-search` | Linear Search | No | No | — | MISSING |
| struct | `cs.struct.linked-lists` | Singly Linked Lists | No | No | — | MISSING |
| struct | `cs.struct.minimum-spanning-tree` | Minimum Spanning Trees | No | No | — | MISSING |
| struct | `cs.struct.queues` | Queues | No | No | — | MISSING |
| struct | `cs.struct.shortest-path-algorithms` | Shortest Path Algorithms | No | No | — | MISSING |
| struct | `cs.struct.stacks` | Stacks | No | No | — | MISSING |
| struct | `cs.struct.trees` | Trees | No | No | — | MISSING |
| theory | `cs.theory.complexity-classes` | Computational Complexity Classes | No | No | — | MISSING |
| theory | `cs.theory.context-free-grammars` | Context-Free Grammars | No | No | — | MISSING |
| theory | `cs.theory.finite-automata` | Finite Automata | No | No | — | MISSING |
| theory | `cs.theory.regular-expressions` | Regular Expressions and Regular Languages | No | No | — | MISSING |
| theory | `cs.theory.turing-machines` | Turing Machines | No | No | — | MISSING |
| web | `cs.web.client-server-model` | The Client-Server Model | No | No | — | MISSING |
| web | `cs.web.html-css-basics` | HTML and CSS Basics | No | No | — | MISSING |
| web | `cs.web.rest-apis` | REST APIs | No | No | — | MISSING |
...
None found. No two Educational Brain files resolve to the same KG id
(checked case-insensitively as well as exactly).
