  ...
  grades: [
    ...
    // ── Grade 5 ─────────────────────────────────────────────────────────────
    {
      ...
      chapters: [
        ...
        { id: 'cbse.hin.5.ch14', order: 14, title: '[रिमझिम] वे दिन भी क्या दिन थे (कहानी)',            kgNodeIds: ['hindi.gadya.yatra_sansmaran', 'hindi.sahitya_vishleshan.vishay_vastu'] },
    ...
    // ── Grade 7 ─────────────────────────────────────────────────────────────
    {
      ...
      chapters: [
        ...
        { id: 'cbse.hin.7.ch10', order: 10, title: '[वसंत] दादी माँ — शिवप्रसाद सिंह (कहानी)',         kgNodeIds: ['hindi.gadya.yatra_sansmaran', 'hindi.sahitya_vishleshan.patra_chitran'] },
    ...
    // ── Grade 10 ────────────────────────────────────────────────────────────
    {
      ...
      chapters: [
        ...
        { id: 'cbse.hin.10.ch17', order: 17, title: '[क्षितिज] सूरदास के पद / राम-लक्ष्मण-परशुराम संवाद — तुलसीदास (पद्य)', kgNodeIds: ['hindi.padya.bhaktikaal', 'hindi.kavya_bodh.bhav_saundarya', 'hindi.kavya_bodh.shilpa_saundarya'] },
        { id: 'cbse.hin.10.ch18', order: 18, title: '[क्षितिज] देव के सवैये / आत्मकथ्य — जयशंकर प्रसाद (पद्य)', kgNodeIds: ['hindi.padya.ritikaal', 'hindi.padya.chhayavad', 'hindi.kavya_bodh.bhav_saundarya'] },
        { id: 'cbse.hin.10.ch19', order: 19, title: '[क्षितिज] उत्साह और अट नहीं रही — सूर्यकांत त्रिपाठी निराला (पद्य)', kgNodeIds: ['hindi.padya.chhayavad', 'hindi.kavya_bodh.bhav_saundarya'] },
        { id: 'cbse.hin.10.ch20', order: 20, title: '[क्षितिज] यह दंतुरित मुसकान / फसल — नागार्जुन / छाया मत छूना — गिरिजाकुमार माथुर (पद्य)', kgNodeIds: ['hindi.padya.pragativad_prayogvad', 'hindi.kavya_bodh.bhav_saundarya'] },
        { id: 'cbse.hin.10.ch21', order: 21, title: '[क्षितिज] कन्यादान — ऋतुराज / संगतकार — मंगलेश डबराल (पद्य)',      kgNodeIds: ['hindi.padya.samakaleen', 'hindi.kavya_bodh.bhav_saundarya'] },
        // ── कृतिका भाग–2 — पूरक पाठ (Sprint DG) ──
        { id: 'cbse.hin.10.ch22', order: 22, title: '[कृतिका] माता का अँचल — शिवपूजन सहाय / जॉर्ज पंचम की नाक — कमलेश्वर', kgNodeIds: ['hindi.gadya.purak_path', 'hindi.sahitya_vishleshan.vishay_vastu'] },
        { id: 'cbse.hin.10.ch23', order: 23, title: '[कृतिका] साना-साना हाथ जोड़ि — मधु कांकरिया (यात्रा-वृत्तांत)', kgNodeIds: ['hindi.gadya.purak_path', 'hindi.gadya.yatra_sansmaran', 'hindi.sahitya_vishleshan.bhasha_shaili'] },
        { id: 'cbse.hin.10.ch24', order: 24, title: '[कृतिका] मैं क्यों लिखता हूँ — अज्ञेय',                            kgNodeIds: ['hindi.gadya.purak_path', 'hindi.sahitya_vishleshan.vishay_vastu'] },
        // ── लेखक परिचय ──
        { id: 'cbse.hin.10.ch25', order: 25, title: '[लेखक परिचय] क्षितिज-2 के लेखकों और कवियों का परिचय', kgNodeIds: ['hindi.kavya_bodh.lekhak_kavi_parichay'] },
      ],
    },
    ...
    // ── Grade 11 ────────────────────────────────────────────────────────────
    {
      ...
      chapters: [
        ...
        { id: 'cbse.hin.11.ch18', order: 18, title: '[आरोह] कबीर के पद — हम तो एक एक करि जाना / संतों देखत जग बौराना (पद्य)', kgNodeIds: ['hindi.padya.bhaktikaal', 'hindi.kavya_bodh.bhav_saundarya', 'hindi.kavya_bodh.shilpa_saundarya'] },
        { id: 'cbse.hin.11.ch19', order: 19, title: '[आरोह] मीराबाई के पद — मेरे तो गिरिधर गोपाल (पद्य)', kgNodeIds: ['hindi.padya.bhaktikaal', 'hindi.kavya_bodh.bhav_saundarya'] },
        { id: 'cbse.hin.11.ch20', order: 20, title: '[आरोह] पथिक — रामनरेश त्रिपाठी / वे आँखें — सुमित्रानंदन पंत / घर की याद — भवानीप्रसाद मिश्र (पद्य)', kgNodeIds: ['hindi.padya.chhayavad', 'hindi.kavya_bodh.bhav_saundarya'] },
        { id: 'cbse.hin.11.ch21', order: 21, title: '[आरोह] गजल — दुष्यंत कुमार / सबसे खतरनाक — पाश / आओ मिलकर बचाएँ — निर्मला पुतुल (पद्य)', kgNodeIds: ['hindi.padya.samakaleen', 'hindi.kavya_bodh.bhav_saundarya'] },
        // ── वितान भाग–1 — पूरक पाठ (Sprint DG) ──
        { id: 'cbse.hin.11.ch22', order: 22, title: '[वितान] भारतीय गायिकाओं में बेजोड़: लता मंगेशकर — कुमार गंधर्व', kgNodeIds: ['hindi.gadya.purak_path', 'hindi.sahitya_vishleshan.vishay_vastu'] },
        { id: 'cbse.hin.11.ch23', order: 23, title: '[वितान] राजस्थान की रजत बूँदें — अनुपम मिश्र',       kgNodeIds: ['hindi.gadya.purak_path', 'hindi.gadya.reportaj_patra', 'hindi.sahitya_vishleshan.samaj_darshan'] },
        { id: 'cbse.hin.11.ch24', order: 24, title: '[वितान] आलो-आँधारि — बेबी हालदार (आत्मकथा-अंश)',    kgNodeIds: ['hindi.gadya.purak_path', 'hindi.gadya.jeevani_aatmkatha', 'hindi.sahitya_vishleshan.vishay_vastu'] },
        // ── लेखक-कवि परिचय ──
        { id: 'cbse.hin.11.ch25', order: 25, title: '[लेखक परिचय] आरोह-1 के लेखकों और कवियों का परिचय', kgNodeIds: ['hindi.kavya_bodh.lekhak_kavi_parichay'] },
      ],
    },
