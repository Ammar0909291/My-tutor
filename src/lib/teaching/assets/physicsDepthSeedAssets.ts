...
// With this batch every physics (concept, HIGH) pair holds >= 5.
// ═══════════════════════════════════════════════════════════════════════════

const TAIL: SeedProbe[] = [
  // ── phys.astro ───────────────────────────────────────────────────────────
  {
    conceptId: 'phys.astro.dark-matter', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What is the classic galaxy-rotation evidence for dark matter?',
    choices: [
      { text: 'Stars in the outer parts of a galaxy orbit far faster than the visible mass can account for — rotation curves stay flat instead of falling away with radius', isCorrect: true },
      { text: 'Galaxies look dimmer than their mass suggests they should', isCorrect: false },
      { text: 'The cosmic microwave background is almost perfectly uniform', isCorrect: false },
      { text: 'Stars near the galactic centre orbit more slowly than expected', isCorrect: false },
    ],
    correctValue: 'flat rotation curves',
    targetedMisconceptions: [],
    source: src('phys.astro.dark-matter', 'the evidence is a DYNAMICAL mismatch, not a brightness one — the last option inverts which part of the galaxy is anomalous, which is the detail the whole argument rests on'),
  },
  {
    conceptId: 'phys.astro.gravitational-waves', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What physically happens to space as a gravitational wave passes through it?',
    choices: [
      { text: 'It stretches and squeezes TRANSVERSELY — lengthening along one perpendicular direction while shortening along the other, then reversing', isCorrect: true },
      { text: 'It is compressed uniformly in every direction at once', isCorrect: false },
      { text: 'The wave drags matter along with it as it goes', isCorrect: false },
      { text: 'Time stops briefly wherever the wave is passing', isCorrect: false },
    ],
    correctValue: 'transverse stretch and squeeze',
    targetedMisconceptions: [],
    source: src('phys.astro.gravitational-waves', 'the two perpendicular directions doing OPPOSITE things is exactly what a two-arm interferometer is built to detect; uniform compression would produce no signal at all in such a detector'),
  },
  {
    conceptId: 'phys.astro.stellar-evolution', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'Which single property determines a star\'s ultimate fate more than any other?',
    choices: [
      { text: 'Its mass', isCorrect: true },
      { text: 'Its surface temperature', isCorrect: false },
      { text: 'Its chemical composition', isCorrect: false },
      { text: 'How close it is to neighbouring stars', isCorrect: false },
    ],
    correctValue: 'mass',
    targetedMisconceptions: [],
    source: src('phys.astro.stellar-evolution', 'mass sets the whole life story — luminosity, lifetime, and whether the end is a white dwarf, a neutron star or a black hole; temperature is a CONSEQUENCE of mass rather than an independent cause'),
  },
  {
    conceptId: 'phys.astro.stellar-structure', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What holds an ordinary main-sequence star up against its own gravity?',
    choices: [
      { text: 'Outward gas pressure from its hot interior, sustained by fusion in the core — the balance called hydrostatic equilibrium', isCorrect: true },
      { text: 'Electron degeneracy pressure', isCorrect: false },
      { text: 'Its rotation, which flings material outwards', isCorrect: false },
      { text: 'Its magnetic field', isCorrect: false },
    ],
    correctValue: 'thermal gas pressure from fusion',
    targetedMisconceptions: [],
    source: src('phys.astro.stellar-structure', 'degeneracy pressure is what supports a WHITE DWARF — a star that has stopped fusing — so the second option is the correct answer for the next stage of the star\'s life and the wrong one for this stage'),
  },

  // ── phys.meas ────────────────────────────────────────────────────────────
  {
    conceptId: 'phys.meas.dimensions', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.PROFICIENT,
    stem: 'A student writes v = at², where v is a velocity, a an acceleration and t a time. Is the equation dimensionally consistent?',
    choices: [
      { text: 'No — the left side is LT⁻¹ and the right side is LT⁻² × T² = L, so it cannot be right', isCorrect: true },
      { text: 'Yes — acceleration and time are exactly what velocity is built from', isCorrect: false },
      { text: 'It cannot be checked without knowing the units used', isCorrect: false },
      { text: 'Yes, provided a is quoted in m/s² and t in seconds', isCorrect: false },
    ],
    correctValue: 'no — L against LT^-1',
    targetedMisconceptions: [],
    source: src('phys.meas.dimensions', 'a dimensional check needs no units and no numbers, which is what the third and fourth options both deny; the correct relation is v = at, so the error is a single stray power of t'),
  },
  {
    conceptId: 'phys.meas.errors', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.PROFICIENT,
    stem: 'You repeat a measurement many times and take the mean. Which kind of error does that reduce?',
    choices: [
      { text: 'Random error only — systematic error survives averaging completely untouched', isCorrect: true },
      { text: 'Systematic error only', isCorrect: false },
      { text: 'Both kinds, equally', isCorrect: false },
      { text: 'Neither — averaging changes nothing about the uncertainty', isCorrect: false },
    ],
    correctValue: 'random error only',
    targetedMisconceptions: [],
    source: src('phys.meas.errors', 'this is precisely why the concept\'s existing worn-ruler and 2°C-high-thermometer probes matter: a consistent offset is invisible to repetition, however many times you repeat it'),
  },
  {
    conceptId: 'phys.meas.scalars-vectors', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.DEVELOPING,
    stem: 'Two forces, of 3 N and 4 N, act on the same point. What is the SMALLEST magnitude their resultant can have?',
    choices: [
      { text: '1 N — when they point in exactly opposite directions', isCorrect: true },
      { text: '0 N — any two forces can be arranged to cancel', isCorrect: false },
      { text: '5 N — the perpendicular case', isCorrect: false },
      { text: '7 N — the two magnitudes added', isCorrect: false },
    ],
    correctValue: '1 N',
    targetedMisconceptions: [],
    source: src('phys.meas.scalars-vectors', 'the resultant of two vectors is bounded by |a−b| and a+b, so 3 and 4 can give anything from 1 to 7 and never zero — the 5 N and 7 N options are both real values from that range, at the wrong end of the question'),
  },
  {
    conceptId: 'phys.meas.significant-figures', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.PROFICIENT,
    stem: 'You multiply 2.5 (two significant figures) by 3.42 (three). To how many significant figures should the result be quoted?',
    choices: [
      { text: 'Two — a product carries the precision of its LEAST precise input', isCorrect: true },
      { text: 'Three', isCorrect: false },
      { text: 'Five — two plus three', isCorrect: false },
      { text: 'However many the calculator displays', isCorrect: false },
    ],
    correctValue: 'two',
    targetedMisconceptions: [],
    source: src('phys.meas.significant-figures', 'precision cannot be manufactured by arithmetic; the five-figure option treats significant figures as something that accumulates, which is the belief the rule exists to stop'),
  },
  {
    conceptId: 'phys.meas.unit-conversion', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.PROFICIENT,
    stem: 'Convert 72 km/h into metres per second.',
    choices: [
      { text: '20 m/s', isCorrect: true },
      { text: '259 m/s — multiplying by 3.6 instead of dividing', isCorrect: false },
      { text: '1.2 m/s — dividing by 60 only, as though the hour were a minute', isCorrect: false },
      { text: '43.2 m/s', isCorrect: false },
    ],
    correctValue: '20 m/s',
    targetedMisconceptions: [],
    source: src('phys.meas.unit-conversion', '72 × 1000 / 3600 = 20. Two conversions happen at once here and in opposite directions, which is why the factor 3.6 gets inverted so often'),
  },

  // ── phys.rel ─────────────────────────────────────────────────────────────
  {
    conceptId: 'phys.rel.length-contraction', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'In which direction is a fast-moving object measured to be contracted?',
    choices: [
      { text: 'Only along its direction of motion — dimensions perpendicular to the motion are unchanged', isCorrect: true },
      { text: 'Equally in all three directions', isCorrect: false },
      { text: 'Only perpendicular to the direction of motion', isCorrect: false },
      { text: 'It is stretched along the direction of motion, not contracted', isCorrect: false },
    ],
    correctValue: 'along the motion only',
    targetedMisconceptions: [],
    source: src('phys.rel.length-contraction', 'the one-directional nature is exactly what the concept\'s existing moving-sphere probe turns on: a sphere does not stay a sphere, it flattens along one axis alone'),
  },
  {
    conceptId: 'phys.rel.lorentz-transform', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What do the Lorentz transformations do?',
    choices: [
      { text: 'Convert the space and time coordinates of an event between two inertial frames in relative motion, in the one way that keeps the speed of light identical in both', isCorrect: true },
      { text: 'Convert between two frames that are accelerating relative to each other', isCorrect: false },
      { text: 'Convert mass into energy', isCorrect: false },
      { text: 'Convert between different systems of units', isCorrect: false },
    ],
    correctValue: 'coordinates between inertial frames',
    targetedMisconceptions: [],
    source: src('phys.rel.lorentz-transform', 'INERTIAL frames only — accelerating frames are general relativity\'s territory, and offering them tests whether the scope of special relativity has registered'),
  },
  {
    conceptId: 'phys.rel.mass-energy', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What does E = mc² actually state?',
    choices: [
      { text: 'Mass and energy are two measures of the same thing — a body at rest with mass m has a rest energy of mc²', isCorrect: true },
      { text: 'Mass can be destroyed to create energy, and is then permanently lost', isCorrect: false },
      { text: 'Energy has weight only when it is moving quickly', isCorrect: false },
      { text: 'An object\'s mass increases as it goes faster', isCorrect: false },
    ],
    correctValue: 'mass and energy are equivalent',
    targetedMisconceptions: [],
    source: src('phys.rel.mass-energy', 'EQUIVALENCE rather than conversion-and-loss: the mass is not destroyed, it is accounted for as energy, which is why the total is conserved. The last option is the relativistic-mass framing the concept\'s existing probe addresses'),
  },
  {
    conceptId: 'phys.rel.postulates', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What are Einstein\'s two postulates of special relativity?',
    choices: [
      { text: 'The laws of physics are the same in every inertial frame; and the speed of light in vacuum is the same for every inertial observer, whatever the source is doing', isCorrect: true },
      { text: 'Nothing can travel faster than light; and mass increases with speed', isCorrect: false },
      { text: 'Time is absolute; and space is relative to the observer', isCorrect: false },
      { text: 'Light needs a medium to travel through; and the Earth moves through that medium', isCorrect: false },
    ],
    correctValue: 'relativity principle and light-speed invariance',
    targetedMisconceptions: [],
    source: src('phys.rel.postulates', 'the second option lists two CONSEQUENCES as though they were the assumptions — a common inversion, and it hides how little relativity actually assumes; the fourth is the aether hypothesis relativity replaced'),
  },
  {
    conceptId: 'phys.rel.relativistic-momentum', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'How does relativistic momentum differ from the Newtonian p = mv?',
    choices: [
      { text: 'It carries a factor of γ: p = γmv, which grows without limit as v approaches c even though v itself cannot exceed c', isCorrect: true },
      { text: 'It becomes p = mc, independent of the actual speed', isCorrect: false },
      { text: 'It drops the mass and depends only on the speed', isCorrect: false },
      { text: 'It is identical to the Newtonian expression at every speed', isCorrect: false },
    ],
    correctValue: 'p = gamma m v',
    targetedMisconceptions: [],
    source: src('phys.rel.relativistic-momentum', 'unbounded momentum with bounded speed is precisely why no finite impulse reaches c — the answer to the concept\'s existing rocket probe, stated as a formula'),
  },
  {
    conceptId: 'phys.rel.simultaneity', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What does the relativity of simultaneity claim?',
    choices: [
      { text: 'Two events that happen at the same time in one inertial frame are generally NOT simultaneous in another frame moving relative to it', isCorrect: true },
      { text: 'Clocks in different frames run at different rates, but simultaneity itself is absolute', isCorrect: false },
      { text: 'Whether two events are simultaneous depends on how far away the observer is standing', isCorrect: false },
      { text: 'No two events anywhere are ever truly simultaneous', isCorrect: false },
    ],
    correctValue: 'simultaneity is frame-dependent',
    targetedMisconceptions: [],
    source: src('phys.rel.simultaneity', 'the second option grants time dilation and keeps absolute simultaneity, which is the half-converted position most learners occupy; the third confuses frame dependence with light travel time, which is a delay you can correct for'),
  },
  {
    conceptId: 'phys.rel.simultaneity', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'Two events occur at the same time in frame S, one at x = 0 and one at larger x. In a frame S′ moving in the +x direction relative to S, which happens first?',
    choices: [
      { text: 'The event at LARGER x happens earlier in S′ — from t′ = γ(t − vx/c²), a bigger x gives a smaller t′', isCorrect: true },
      { text: 'The event at smaller x happens earlier in S′', isCorrect: false },
      { text: 'They stay simultaneous — the transformation only rescales time', isCorrect: false },
      { text: 'It cannot be determined without knowing the events\' separation in time', isCorrect: false },
    ],
    correctValue: 'the one at larger x',
    targetedMisconceptions: [],
    source: src('phys.rel.simultaneity', 'the −vx/c² term is the whole content of the relativity of simultaneity, and reading its SIGN is what turns the qualitative claim into a usable one — the concept\'s existing train probe sets up the same situation without asking for the direction'),
  },
  {
    conceptId: 'phys.rel.spacetime', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What is special about the spacetime interval between two events?',
    choices: [
      { text: 'It is INVARIANT — every inertial observer computes the same value, even though they disagree about the separate time and space intervals', isCorrect: true },
      { text: 'It is always positive', isCorrect: false },
      { text: 'It is simply the spatial distance between the two events', isCorrect: false },
      { text: 'Its value depends on how fast the observer is moving', isCorrect: false },
    ],
    correctValue: 'it is invariant',
    targetedMisconceptions: [],
    source: src('phys.rel.spacetime', 'invariance is what replaces absolute time and absolute distance, both of which relativity gives up; the interval can be negative, zero or positive, and that SIGN is what the concept\'s existing spacelike probe turns on'),
  },

  // ── phys.stat ────────────────────────────────────────────────────────────
  {
    conceptId: 'phys.stat.boltzmann-factor', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What does the Boltzmann factor e^(−E/kT) give you?',
    choices: [
      { text: 'The RELATIVE probability of finding the system in a state of energy E, at temperature T', isCorrect: true },
      { text: 'The energy of that state', isCorrect: false },
      { text: 'The number of states available at energy E', isCorrect: false },
      { text: 'The entropy of the state', isCorrect: false },
    ],
    correctValue: 'relative probability of a state',
    targetedMisconceptions: [],
    source: src('phys.stat.boltzmann-factor', 'the factor is a relative WEIGHT and needs the partition function to become an absolute probability; the number of states at an energy is the degeneracy, which multiplies it and is a separate quantity'),
  },
  {
    conceptId: 'phys.stat.bose-einstein', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'Which particles obey Bose–Einstein statistics, and what does that permit?',
    choices: [
      { text: 'Bosons — integer-spin particles such as photons — and any number of them may occupy the very same quantum state', isCorrect: true },
      { text: 'Fermions, such as electrons', isCorrect: false },
      { text: 'All particles, once the temperature is low enough', isCorrect: false },
      { text: 'Only massless particles', isCorrect: false },
    ],
    correctValue: 'bosons, unlimited occupancy',
    targetedMisconceptions: [],
    source: src('phys.stat.bose-einstein', 'unlimited occupancy is the exact opposite of Pauli exclusion, and it is what makes a laser and a Bose–Einstein condensate possible; the massless option is too narrow, since helium-4 atoms are massive bosons'),
  },
  {
    conceptId: 'phys.stat.chemical-potential', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What does the chemical potential μ measure?',
    choices: [
      { text: 'The change in a system\'s free energy when one further particle is added, at fixed temperature and volume', isCorrect: true },
      { text: 'The total energy of the system divided by the number of particles', isCorrect: false },
      { text: 'The energy needed to raise the temperature by one kelvin', isCorrect: false },
      { text: 'How chemically reactive the substance is', isCorrect: false },
    ],
    correctValue: 'free energy per added particle',
    targetedMisconceptions: [],
    source: src('phys.stat.chemical-potential', 'a MARGINAL quantity, not an average — the last option is the reading the name invites, and it is what the concept\'s existing does-it-only-matter-for-reactions probe addresses'),
  },
  {
    conceptId: 'phys.stat.chemical-potential', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'Two systems are free to exchange particles. What is equal between them once equilibrium is reached?',
    choices: [
      { text: 'Their chemical potentials — particles flow from higher μ to lower μ until the two match', isCorrect: true },
      { text: 'Their particle numbers', isCorrect: false },
      { text: 'Their total energies', isCorrect: false },
      { text: 'Their entropies', isCorrect: false },
    ],
    correctValue: 'the chemical potentials',
    targetedMisconceptions: [],
    source: src('phys.stat.chemical-potential', 'μ is to particle flow what TEMPERATURE is to heat flow, and the equal-numbers option is the same error as expecting two bodies in thermal equilibrium to hold equal amounts of energy'),
  },
  {
    conceptId: 'phys.stat.entropy-statistical', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'Boltzmann\'s entropy formula is S = k ln Ω. What is Ω?',
    choices: [
      { text: 'The number of microstates consistent with the system\'s macrostate', isCorrect: true },
      { text: 'The total energy of the system', isCorrect: false },
      { text: 'The volume the system occupies', isCorrect: false },
      { text: 'The number of particles it contains', isCorrect: false },
    ],
    correctValue: 'the number of microstates',
    targetedMisconceptions: [],
    source: src('phys.stat.entropy-statistical', 'entropy as a COUNT is the bridge between the statistical and thermodynamic definitions, which is exactly what the concept\'s existing partition-function probe asks the learner to reconcile'),
  },
  {
    conceptId: 'phys.stat.fermi-dirac', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'At absolute zero, what shape does the Fermi–Dirac distribution take?',
    choices: [
      { text: 'A sharp step: every state below the Fermi energy is occupied and every state above it is empty', isCorrect: true },
      { text: 'All the particles collapse into the single lowest-energy state', isCorrect: false },
      { text: 'A smooth exponential decay with energy', isCorrect: false },
      { text: 'A uniform spread across all available energies', isCorrect: false },
    ],
    correctValue: 'a step at the Fermi energy',
    targetedMisconceptions: [],
    source: src('phys.stat.fermi-dirac', 'the second option is what BOSONS do at T = 0, and it is forbidden here by exclusion — offering it tests whether the two statistics have been kept apart; the exponential is the classical Boltzmann limit'),
  },
  {
    conceptId: 'phys.stat.fluctuations-correlations', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'For a system of N particles, how do RELATIVE fluctuations in an extensive quantity typically scale with N?',
    choices: [
      { text: 'As 1/√N — so for a macroscopic N they become utterly negligible, which is why thermodynamics works at all', isCorrect: true },
      { text: 'As N — bigger systems fluctuate relatively more', isCorrect: false },
      { text: 'As 1/N', isCorrect: false },
      { text: 'They do not depend on N at all', isCorrect: false },
    ],
    correctValue: '1/sqrt(N)',
    targetedMisconceptions: [],
    source: src('phys.stat.fluctuations-correlations', 'ABSOLUTE fluctuations grow as √N while RELATIVE ones shrink as 1/√N — keeping those two straight is what the concept\'s existing large-N probe is really about'),
  },
  {
    conceptId: 'phys.stat.fluctuations-correlations', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'The fluctuation–dissipation relation connects which two kinds of quantity?',
    choices: [
      { text: 'Spontaneous equilibrium fluctuations and the system\'s RESPONSE to a small applied perturbation — energy fluctuations and heat capacity being the standard example', isCorrect: true },
      { text: 'Entropy and temperature, and nothing else', isCorrect: false },
      { text: 'Particle number and volume', isCorrect: false },
      { text: 'Kinetic energy and potential energy', isCorrect: false },
    ],
    correctValue: 'fluctuations and response functions',
    targetedMisconceptions: [],
    source: src('phys.stat.fluctuations-correlations', 'a system left alone tells you how it will answer when pushed — which is why C_V diverging at T_c and energy fluctuations diverging there are the same statement, as the concept\'s existing probe notes'),
  },
  {
    conceptId: 'phys.stat.free-energy', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'At constant temperature and volume, which quantity does a system minimise at equilibrium?',
    choices: [
      { text: 'The Helmholtz free energy, F = U − TS', isCorrect: true },
      { text: 'Its internal energy U alone', isCorrect: false },
      { text: 'Its entropy S', isCorrect: false },
      { text: 'Its temperature', isCorrect: false },
    ],
    correctValue: 'the Helmholtz free energy',
    targetedMisconceptions: [],
    source: src('phys.stat.free-energy', 'the system minimises a COMBINATION, not either term alone — which is the whole reason a process can run uphill in energy if it pays for it in entropy, as the concept\'s existing evaporation probe shows'),
  },
  {
    conceptId: 'phys.stat.grand-canonical-ensemble', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'In the grand canonical ensemble, what does the system exchange with its reservoir?',
    choices: [
      { text: 'Both energy AND particles', isCorrect: true },
      { text: 'Energy only', isCorrect: false },
      { text: 'Particles only', isCorrect: false },
      { text: 'Neither — the system is isolated', isCorrect: false },
    ],
    correctValue: 'energy and particles',
    targetedMisconceptions: [],
    source: src('phys.stat.grand-canonical-ensemble', 'energy-only is the CANONICAL ensemble and neither is the MICROCANONICAL — offering all three tests whether the ensembles are distinguished by what is allowed to flow'),
  },
  {
    conceptId: 'phys.stat.grand-canonical-ensemble', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'Which variables are held FIXED in the grand canonical ensemble?',
    choices: [
      { text: 'Chemical potential, volume and temperature — μ, V and T', isCorrect: true },
      { text: 'Particle number, volume and energy — N, V and E', isCorrect: false },
      { text: 'Particle number, volume and temperature — N, V and T', isCorrect: false },
      { text: 'Pressure, volume and temperature — P, V and T', isCorrect: false },
    ],
    correctValue: 'mu, V, T',
    targetedMisconceptions: [],
    source: src('phys.stat.grand-canonical-ensemble', 'the two wrong ensembles are named exactly: NVE is microcanonical and NVT is canonical. μ replaces N precisely because N is now free to fluctuate'),
  },
  {
    conceptId: 'phys.stat.ising-model', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What does the Ising model represent?',
    choices: [
      { text: 'Spins fixed on a lattice, each pointing either up or down, interacting with their nearest neighbours', isCorrect: true },
      { text: 'Atoms moving freely through a gas', isCorrect: false },
      { text: 'Electrons orbiting an atomic nucleus', isCorrect: false },
      { text: 'A continuous magnetic field filling a region of space', isCorrect: false },
    ],
    correctValue: 'nearest-neighbour lattice spins',
    targetedMisconceptions: [],
    source: src('phys.stat.ising-model', 'two discrete states on a fixed lattice with local coupling is the whole model — its extreme simplicity is the point, and the continuous-field option is what a learner substitutes when "magnetism" is the cue'),
  },
  {
    conceptId: 'phys.stat.ising-model', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'Why is the two-dimensional Ising model so celebrated?',
    choices: [
      { text: 'Onsager solved it EXACTLY, and it shows a genuine phase transition at a finite temperature — the first exactly solved model to do so', isCorrect: true },
      { text: 'Because it turns out to have no phase transition at any temperature', isCorrect: false },
      { text: 'Because it was the first physical model ever solved by computer', isCorrect: false },
      { text: 'Because it applies specifically to iron', isCorrect: false },
    ],
    correctValue: 'Onsager exact solution with a real transition',
    targetedMisconceptions: [],
    source: src('phys.stat.ising-model', 'no transition is the correct answer for the ONE-dimensional chain, which the concept\'s existing probe covers — so the second option is right about a different dimensionality, and that contrast is exactly why 2D mattered'),
  },
  {
    conceptId: 'phys.stat.monte-carlo-basics', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'Why is Monte Carlo sampling used in statistical mechanics at all?',
    choices: [
      { text: 'The number of microstates is astronomically large, so the sums cannot be evaluated term by term. Sampling estimates the averages from a manageable subset', isCorrect: true },
      { text: 'Because the underlying equations have no solutions', isCorrect: false },
      { text: 'Because the aim is to generate random numbers', isCorrect: false },
      { text: 'Because computers are unable to perform integration', isCorrect: false },
    ],
    correctValue: 'the state space is too large to enumerate',
    targetedMisconceptions: [],
    source: src('phys.stat.monte-carlo-basics', 'the obstacle is SIZE, not insolubility — a 100-spin Ising lattice has 2^100 states, which no enumeration will ever reach, and randomness is the tool rather than the goal'),
  },
  {
    conceptId: 'phys.stat.monte-carlo-basics', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'What does DETAILED BALANCE guarantee in a Metropolis simulation?',
    choices: [
      { text: 'That the simulation converges on the correct equilibrium distribution and then stays there', isCorrect: true },
      { text: 'That every state is visited exactly once', isCorrect: false },
      { text: 'That energy is conserved at every individual step', isCorrect: false },
      { text: 'That the simulation runs faster', isCorrect: false },
    ],
    correctValue: 'convergence to the correct distribution',
    targetedMisconceptions: [],
    source: src('phys.stat.monte-carlo-basics', 'detailed balance is a CORRECTNESS condition, not a performance one — the concept\'s existing probe asks what goes wrong without it, and this asks what it buys you'),
  },
  {
    conceptId: 'phys.stat.partition-function', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What is the canonical partition function Z?',
    choices: [
      { text: 'A sum of e^(−E/kT) over every state of the system — and every thermodynamic quantity can be derived from it', isCorrect: true },
      { text: 'The total energy of the system', isCorrect: false },
      { text: 'The number of particles in the system', isCorrect: false },
      { text: 'The probability that the system sits in its ground state', isCorrect: false },
    ],
    correctValue: 'sum of Boltzmann factors over all states',
    targetedMisconceptions: [],
    source: src('phys.stat.partition-function', 'Z is a sum over STATES, which is why degeneracy matters — the point of the concept\'s existing two-fold-degenerate probe, and why Z is far more than the normaliser it first looks like'),
  },
  {
    conceptId: 'phys.stat.phase-transitions', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What characterises a FIRST-order phase transition?',
    choices: [
      { text: 'Latent heat is absorbed or released, and the first derivatives of the free energy — entropy and volume — jump discontinuously', isCorrect: true },
      { text: 'There is no latent heat at all', isCorrect: false },
      { text: 'The temperature rises continuously all the way through the transition', isCorrect: false },
      { text: 'Only the SECOND derivatives of the free energy jump', isCorrect: false },
    ],
    correctValue: 'latent heat, first derivatives jump',
    targetedMisconceptions: [],
    source: src('phys.stat.phase-transitions', 'the first and last options together are the definition of a SECOND-order transition, so they are the correct answer to the neighbouring question — which is exactly the distinction the Ehrenfest classification exists to draw'),
  },
  {
    conceptId: 'phys.stat.phase-transitions', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'What is an ORDER PARAMETER?',
    choices: [
      { text: 'A quantity that is zero in the disordered phase and non-zero in the ordered one — magnetisation for a ferromagnet — measuring how much order has appeared', isCorrect: true },
      { text: 'The temperature at which the transition takes place', isCorrect: false },
      { text: 'The latent heat absorbed during the transition', isCorrect: false },
      { text: 'The number of distinct phases the substance can adopt', isCorrect: false },
    ],
    correctValue: 'zero in one phase, non-zero in the other',
    targetedMisconceptions: [],
    source: src('phys.stat.phase-transitions', 'the order parameter is what makes "how ordered is it" a measurable number, and choosing one is the first step in analysing any transition; the second option is the critical temperature, a different quantity in the same discussion'),
  },
  {
    conceptId: 'phys.stat.phase-transitions-critical-phenomena', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'What happens to the correlation length as a system approaches its critical point?',
    choices: [
      { text: 'It DIVERGES — fluctuations become correlated over every length scale at once', isCorrect: true },
      { text: 'It falls to zero', isCorrect: false },
      { text: 'It stays constant right through the transition', isCorrect: false },
      { text: 'It shrinks to the spacing between neighbouring particles', isCorrect: false },
    ],
    correctValue: 'it diverges',
    targetedMisconceptions: [],
    source: src('phys.stat.phase-transitions-critical-phenomena', 'a diverging correlation length is why microscopic detail stops mattering, and so it is the direct cause of the universality the next probe asks about — it is also what makes critical opalescence visible to the eye'),
  },
  {
    conceptId: 'phys.stat.phase-transitions-critical-phenomena', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.ADVANCED,
    stem: 'What does UNIVERSALITY mean in the study of critical phenomena?',
    choices: [
      { text: 'Wildly different physical systems share the same critical exponents, fixed only by dimensionality and symmetry rather than by microscopic detail', isCorrect: true },
      { text: 'That every system has the same critical temperature', isCorrect: false },
      { text: 'That one set of equations describes the whole of physics', isCorrect: false },
      { text: 'That critical exponents always turn out to be whole numbers', isCorrect: false },
    ],
    correctValue: 'shared critical exponents',
    targetedMisconceptions: [],
    source: src('phys.stat.phase-transitions-critical-phenomena', 'the EXPONENTS are shared and the temperatures emphatically are not — which is why a magnet and a fluid can sit in one universality class, as the concept\'s existing probe states'),
  },
  {
    conceptId: 'phys.stat.probability-basics', subjectSlug: S, probeKind: 'mcq',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.FOUNDATIONAL,
    stem: 'A fair coin is tossed four times. How many of the possible outcomes give exactly two heads, and how many outcomes are there altogether?',
    choices: [
      { text: 'Six out of sixteen', isCorrect: true },
      { text: 'Two out of four', isCorrect: false },
      { text: 'Four out of sixteen', isCorrect: false },
      { text: 'Eight out of sixteen — half of them, since two heads is half of four tosses', isCorrect: false },
    ],
    correctValue: '6 of 16',
    targetedMisconceptions: [],
    source: src('phys.stat.probability-basics', 'counting microstates by hand on a case small enough to check: 2⁴ = 16 outcomes and C(4,2) = 6 with two heads. The eight-of-sixteen option confuses the most probable MACROSTATE with half the total, which is the same slip that makes entropy arguments go wrong at scale'),
  },
  {
    // phys.meas.units @ HIGH is the last slot-constrained pair in physics: its
    // mcq slot holds exactly ONE probe, so this goes into the
    // misconception_probe ladder, which already has two.
    conceptId: 'phys.meas.units', subjectSlug: S, probeKind: 'misconception_probe',
    gradeBand: GradeBand.HIGH, difficulty: ProbeDifficulty.PROFICIENT,
    stem: 'A student says: "The second is defined by the rotation of the Earth, so if the Earth slowed down, a second would get longer." What is wrong with that?',
    choices: [
      { text: 'Since 1967 the second has been defined by a caesium atomic transition, not by astronomy — the definition is completely independent of what the Earth does', isCorrect: true },
      { text: 'Nothing is wrong — that is exactly how the second is defined', isCorrect: false },
      { text: 'The second is defined by the swing of a standard pendulum', isCorrect: false },
      { text: 'The Earth\'s rotation is perfectly constant, so the question never arises', isCorrect: false },
    ],
    correctValue: 'defined by a caesium transition',
    targetedMisconceptions: [],
    source: src('phys.meas.units', 'the Earth\'s rotation genuinely IS irregular — which is why leap seconds exist — so the last option is false on its own terms as well as beside the point; base units were moved onto invariant physical constants precisely to break this dependence'),
  },
]
