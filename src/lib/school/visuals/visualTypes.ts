...
export const VISUAL_SUBJECTS = new Set(['mathematics', 'science', 'math', 'quantum_physics', 'physics', 'classical_mechanics', 'chemistry', 'computer_science', 'biology', 'data_science'])
