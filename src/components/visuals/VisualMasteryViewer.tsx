'use client'
/**
 * VisualMasteryViewer — Visual Learning Sprint M, Task 5.
 *
 ...
 *   - a persisted summary aggregated across all saved rows
 *
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 16 }}>
      <section>
        <h2 style={{ fontSize: 13, fontWeight: 700, margin: '0 0 6px', opacity: 0.8 }}>
          Persisted summary (across all saved EvidenceRecord rows)
        </h2>
