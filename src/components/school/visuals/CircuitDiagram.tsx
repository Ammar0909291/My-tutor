    ...
    <svg viewBox="0 0 280 200" width="100%" style={{ maxWidth: 300 }} aria-hidden="true">
      ...
      {show(2) && (
        <g className={anim.reveal}>
          ...
          <text x={40} y={105} textAnchor="middle" fontSize={9} fill="var(--text-dim)">{t('viz_battery')}</text>
      ...
      {show(3) && (
        <g className={anim.reveal}>
          ...
          <text x={130} y={22} textAnchor="middle" fontSize={9} fill="var(--text-dim)">{t('viz_switch')}</text>
        </g>
      )}
      {/* Step 4 — bulb (load) */}
      {show(4) && (
        <g className={anim.reveal}>
          ...
          <text x={260} y={93} fontSize={9} fill="var(--text-dim)">{t('viz_bulb')}</text>
        </g>
      )}
      ...
      {show(5) && (
        <g className={anim.reveal}>
          ...
          <text x={150} y={178} textAnchor="middle" fontSize={9} fill="var(--text-dim)">{t('viz_resistor')}</text>
