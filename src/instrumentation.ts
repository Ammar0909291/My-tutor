  ...
  try {
...

    {
      ...
      const ALL_EXPLANATIONS = [...SEED_EXPLANATIONS, ...AUTHORED_EXPLANATIONS, ...CHEMISTRY_EXPLANATIONS,
        ...
        ...MATHEMATICS_CATEGORY_FOUNDATIONS_EXPLANATIONS, ...MATHEMATICS_CATEGORY_MORPHISM_EXPLANATIONS, ...MATHEMATICS_CATEGORY_STRUCTURE_EXPLANATIONS, ...MATHEMATICS_CATEGORY_LIMITS_EXPLANATIONS, ...MATHEMATICS_CATEGORY_ADJUNCTION_EXPLANATIONS, ...MATHEMATICS_CATEGORY_MONAD_EXPLANATIONS]
      const ALL_PROBES = [...SEED_PROBES, ...AUTHORED_PROBES, ...CHEMISTRY_PROBES, ...PHYSICS_BAND_GAP_PROBES,
        ...
        ...MATHEMATICS_CATEGORY_FOUNDATIONS_PROBES, ...MATHEMATICS_CATEGORY_MORPHISM_PROBES, ...MATHEMATICS_CATEGORY_STRUCTURE_PROBES, ...MATHEMATICS_CATEGORY_LIMITS_PROBES, ...MATHEMATICS_CATEGORY_ADJUNCTION_PROBES, ...MATHEMATICS_CATEGORY_MONAD_PROBES]
