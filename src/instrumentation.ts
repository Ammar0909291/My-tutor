  ...
  try {
...

    {
      ...
      const ALL_PROBES = [...SEED_PROBES, ...AUTHORED_PROBES, ...CHEMISTRY_PROBES, ...PHYSICS_BAND_GAP_PROBES,
        ...
        ...MATHEMATICS_CATEGORY_FOUNDATIONS_PROBES, ...MATHEMATICS_CATEGORY_MORPHISM_PROBES, ...MATHEMATICS_CATEGORY_STRUCTURE_PROBES, ...MATHEMATICS_CATEGORY_LIMITS_PROBES, ...MATHEMATICS_CATEGORY_ADJUNCTION_PROBES, ...MATHEMATICS_CATEGORY_MONAD_PROBES, ...MATHEMATICS_CATEGORY_CLOSURE_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_FOUNDATIONS_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_GROUP_OPS_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_SUBGROUP_PROBES]
