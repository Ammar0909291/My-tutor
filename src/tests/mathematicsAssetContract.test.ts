...
import {
  ...
  MATHEMATICS_CATEGORY_FOUNDATIONS_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryFoundationsAssets'
import {
  MATHEMATICS_CATEGORY_MORPHISM_EXPLANATIONS,
  MATHEMATICS_CATEGORY_MORPHISM_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryMorphismAssets'
import {
  MATHEMATICS_CATEGORY_STRUCTURE_EXPLANATIONS,
  MATHEMATICS_CATEGORY_STRUCTURE_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryStructureAssets'
import {
  MATHEMATICS_CATEGORY_LIMITS_EXPLANATIONS,
  MATHEMATICS_CATEGORY_LIMITS_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryLimitsAssets'
import {
  MATHEMATICS_CATEGORY_ADJUNCTION_EXPLANATIONS,
  MATHEMATICS_CATEGORY_ADJUNCTION_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryAdjunctionAssets'
import {
  MATHEMATICS_CATEGORY_MONAD_EXPLANATIONS,
  MATHEMATICS_CATEGORY_MONAD_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryMonadAssets'
import {
  MATHEMATICS_CATEGORY_CLOSURE_EXPLANATIONS,
  MATHEMATICS_CATEGORY_CLOSURE_PROBES,
} from '@/lib/teaching/assets/mathematicsCategoryClosureAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_FOUNDATIONS_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_FOUNDATIONS_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraFoundationsAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_GROUP_OPS_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_GROUP_OPS_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraGroupOpsAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_SUBGROUP_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_SUBGROUP_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraSubgroupAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_ORDER_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_ORDER_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraOrderAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_RING_HOM_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_RING_HOM_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraRingHomAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_ACTION_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_ACTION_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraActionAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_QUOTIENT_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_QUOTIENT_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraQuotientAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_IDEAL_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_IDEAL_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraIdealAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_PRIME_EUCLID_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_PRIME_EUCLID_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraPrimeEuclidAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_FIELD_PID_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_FIELD_PID_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraFieldPidAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_UFD_QUOTIENT_RING_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_UFD_QUOTIENT_RING_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraUfdQuotientRingAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_HOM_ISO_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_HOM_ISO_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraHomIsoAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_FIT_LAGRANGE_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_FIT_LAGRANGE_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraFitLagrangeAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_ISO_FINITE_FIELD_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_ISO_FINITE_FIELD_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraIsoFiniteFieldAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_ALT_GROUP_FIELD_EXT_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_ALT_GROUP_FIELD_EXT_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraAltGroupFieldExtAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_BURNSIDE_SYLOW_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_BURNSIDE_SYLOW_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraBurnsideSylowAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_ALG_EXT_GALOIS_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_ALG_EXT_GALOIS_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraAlgExtGaloisAssets'
import {
  MATHEMATICS_ABSTRACT_ALGEBRA_GALOIS_GROUP_CORRESPONDENCE_EXPLANATIONS,
  MATHEMATICS_ABSTRACT_ALGEBRA_GALOIS_GROUP_CORRESPONDENCE_PROBES,
} from '@/lib/teaching/assets/mathematicsAbstractAlgebraGaloisGroupCorrespondenceAssets'
import {
  MATHEMATICS_ALGEBRA_SIMPLIFY_LINEAR_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_SIMPLIFY_LINEAR_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraSimplifyLinearAssets'
import {
  MATHEMATICS_ALGEBRA_INEQUALITY_RADICALS_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_INEQUALITY_RADICALS_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraInequalityRadicalsAssets'
import {
  MATHEMATICS_ALGEBRA_POLY_OPS_EXP_FUNC_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_POLY_OPS_EXP_FUNC_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraPolyOpsExpFuncAssets'
import {
  MATHEMATICS_ALGEBRA_COMPLETE_SQUARE_POLY_DIV_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_COMPLETE_SQUARE_POLY_DIV_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraCompleteSquarePolyDivAssets'
import {
  MATHEMATICS_ALGEBRA_SYSTEMS_LOGARITHM_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_SYSTEMS_LOGARITHM_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraSystemsLogarithmAssets'
import {
  MATHEMATICS_ALGEBRA_REMAINDER_QUADRATIC_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_REMAINDER_QUADRATIC_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraRemainderQuadraticAssets'
import {
  MATHEMATICS_ALGEBRA_FACTOR_DISCRIMINANT_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_FACTOR_DISCRIMINANT_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraFactorDiscriminantAssets'
import {
  MATHEMATICS_ALGEBRA_FACTORING_ROOTS_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_FACTORING_ROOTS_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraFactoringRootsAssets'
import {
  MATHEMATICS_ALGEBRA_RATIONAL_FTA_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_RATIONAL_FTA_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraRationalFtaAssets'
import {
  MATHEMATICS_ALGEBRA_GCF_RATIONAL_EQ_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_GCF_RATIONAL_EQ_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraGcfRationalEqAssets'
import {
  MATHEMATICS_ALGEBRA_LOG_PROPS_EXP_EQ_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_LOG_PROPS_EXP_EQ_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraLogPropsExpEqAssets'
import {
  MATHEMATICS_ALGEBRA_LOG_EQ_CHANGE_BASE_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_LOG_EQ_CHANGE_BASE_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraLogEqChangeBaseAssets'
import {
  MATHEMATICS_ALGEBRA_POLY_INEQ_SIMPLIFY_RADICALS_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_POLY_INEQ_SIMPLIFY_RADICALS_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraPolyIneqSimplifyRadicalsAssets'
import {
  MATHEMATICS_ALGEBRA_BINOMIAL_TRINOMIALS_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_BINOMIAL_TRINOMIALS_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraBinomialTrinomialsAssets'
import {
  MATHEMATICS_ALGEBRA_PASCALS_RATIONALIZING_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_PASCALS_RATIONALIZING_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraPascalsRationalizingAssets'
import {
  MATHEMATICS_ALGEBRA_FACTORING_SPECIAL_ROOT_THEOREM_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_FACTORING_SPECIAL_ROOT_THEOREM_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraFactoringSpecialRootTheoremAssets'
import {
  MATHEMATICS_ALGEBRA_VIETAS_COMPLEX_ROOTS_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_VIETAS_COMPLEX_ROOTS_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraVietasComplexRootsAssets'
import {
  MATHEMATICS_ALGEBRA_RATIONAL_EXPR_OPS_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_RATIONAL_EXPR_OPS_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraRationalExprOpsAssets'
import {
  MATHEMATICS_ALGEBRA_RAT_INEQ_ABS_VAL_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_RAT_INEQ_ABS_VAL_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraRatIneqAbsValAssets'
import {
  MATHEMATICS_ALGEBRA_ELIM_SUBST_METHOD_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_ELIM_SUBST_METHOD_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraElimSubstMethodAssets'
import {
  MATHEMATICS_ALGEBRA_FRAC_EXP_RADICAL_EQ_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_FRAC_EXP_RADICAL_EQ_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraFracExpRadicalEqAssets'
import {
  MATHEMATICS_ALGEBRA_INEQ2VAR_LOG_SYSTEM3VAR_EXPLANATIONS,
  MATHEMATICS_ALGEBRA_INEQ2VAR_LOG_SYSTEM3VAR_PROBES,
} from '@/lib/teaching/assets/mathematicsAlgebraIneq2varLogSystem3varAssets'
import {
  MATHEMATICS_CALCULUS_LIMIT_LAWS_CONTINUITY_EXPLANATIONS,
  MATHEMATICS_CALCULUS_LIMIT_LAWS_CONTINUITY_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusLimitLawsContinuityAssets'
import {
  MATHEMATICS_CALCULUS_CONTINUITY_TYPES_IVT_DERIV_DEF_EXPLANATIONS,
  MATHEMATICS_CALCULUS_CONTINUITY_TYPES_IVT_DERIV_DEF_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusContinuityTypesIvtDerivDefAssets'
import {
  MATHEMATICS_CALCULUS_DERIV_RULES_DIFF_MVT_EXPLANATIONS,
  MATHEMATICS_CALCULUS_DERIV_RULES_DIFF_MVT_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusDerivRulesDiffMvtAssets'
import {
  MATHEMATICS_CALCULUS_PRODUCT_RULE_CRITICAL_POINTS_INC_DEC_EXPLANATIONS,
  MATHEMATICS_CALCULUS_PRODUCT_RULE_CRITICAL_POINTS_INC_DEC_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusProductRuleCriticalPointsIncDecAssets'
import {
  MATHEMATICS_CALCULUS_LOCAL_EXTREMA_QUOTIENT_HIGHER_ORDER_EXPLANATIONS,
  MATHEMATICS_CALCULUS_LOCAL_EXTREMA_QUOTIENT_HIGHER_ORDER_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusLocalExtremaQuotientHigherOrderAssets'
import {
  MATHEMATICS_CALCULUS_CONCAVITY_OPTIMIZATION_LINEARIZATION_EXPLANATIONS,
  MATHEMATICS_CALCULUS_CONCAVITY_OPTIMIZATION_LINEARIZATION_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusConcavityOptimizationLinearizationAssets'
import {
  MATHEMATICS_CALCULUS_LHOPITAL_LIMITS_INFINITY_ROLLES_EXPLANATIONS,
  MATHEMATICS_CALCULUS_LHOPITAL_LIMITS_INFINITY_ROLLES_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusLhopitalLimitsInfinityRollesAssets'
import {
  MATHEMATICS_CALCULUS_CURVE_SKETCHING_RIEMANN_SQUEEZE_EXPLANATIONS,
  MATHEMATICS_CALCULUS_CURVE_SKETCHING_RIEMANN_SQUEEZE_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusCurveSketchingRiemannSqueezeAssets'
import {
  MATHEMATICS_CALCULUS_DEFINITE_INTEGRAL_TRIG_MULTIVAR_EXPLANATIONS,
  MATHEMATICS_CALCULUS_DEFINITE_INTEGRAL_TRIG_MULTIVAR_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusDefiniteIntegralTrigMultivarAssets'
import {
  MATHEMATICS_CALCULUS_FTC_PART1_INTEGRAL_AREA_PARTIAL_DERIV_EXPLANATIONS,
  MATHEMATICS_CALCULUS_FTC_PART1_INTEGRAL_AREA_PARTIAL_DERIV_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusFtcPart1IntegralAreaPartialDerivAssets'
import {
  MATHEMATICS_CALCULUS_FTC_PART2_GRADIENT_ARC_LENGTH_EXPLANATIONS,
  MATHEMATICS_CALCULUS_FTC_PART2_GRADIENT_ARC_LENGTH_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusFtcPart2GradientArcLengthAssets'
import {
  MATHEMATICS_CALCULUS_DIRECTIONAL_DERIV_USUB_VOLUME_REV_EXPLANATIONS,
  MATHEMATICS_CALCULUS_DIRECTIONAL_DERIV_USUB_VOLUME_REV_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusDirectionalDerivUSubVolumeRevAssets'
import {
  MATHEMATICS_CALCULUS_INTEG_BY_PARTS_MULTIVAR_EXTREMA_IMPROPER_EXPLANATIONS,
  MATHEMATICS_CALCULUS_INTEG_BY_PARTS_MULTIVAR_EXTREMA_IMPROPER_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusIntegByPartsMultivarExtremaImproperAssets'
import {
  MATHEMATICS_CALCULUS_CHAIN_RULE_MULTIVAR_IMPLICIT_DIFF_MULTIPLE_INTEGRALS_EXPLANATIONS,
  MATHEMATICS_CALCULUS_CHAIN_RULE_MULTIVAR_IMPLICIT_DIFF_MULTIPLE_INTEGRALS_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusChainRuleMultivarImplicitDiffMultipleIntegralsAssets'
import {
  MATHEMATICS_CALCULUS_RELATED_RATES_REDUCTION_FORMULAS_DOUBLE_INTEGRALS_EXPLANATIONS,
  MATHEMATICS_CALCULUS_RELATED_RATES_REDUCTION_FORMULAS_DOUBLE_INTEGRALS_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusRelatedRatesReductionFormulasDoubleIntegralsAssets'
import {
  MATHEMATICS_CALCULUS_TRIPLE_INTEGRALS_PARAMETRIC_CURVES_SURFACE_AREA_EXPLANATIONS,
  MATHEMATICS_CALCULUS_TRIPLE_INTEGRALS_PARAMETRIC_CURVES_SURFACE_AREA_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusTripleIntegralsParametricCurvesSurfaceAreaAssets'
import {
  MATHEMATICS_CALCULUS_PARAMETRIC_CALC_LINE_INTEGRALS_VECTOR_FIELDS_EXPLANATIONS,
  MATHEMATICS_CALCULUS_PARAMETRIC_CALC_LINE_INTEGRALS_VECTOR_FIELDS_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusParametricCalcLineIntegralsVectorFieldsAssets'
import {
  MATHEMATICS_CALCULUS_GREENS_THEOREM_CURL_DIVERGENCE_SURFACE_INTEGRALS_EXPLANATIONS,
  MATHEMATICS_CALCULUS_GREENS_THEOREM_CURL_DIVERGENCE_SURFACE_INTEGRALS_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusGreensTheoremCurlDivergenceSurfaceIntegralsAssets'
import {
  MATHEMATICS_CALCULUS_CHANGE_OF_VARIABLES_DIVERGENCE_STOKES_THEOREM_EXPLANATIONS,
  MATHEMATICS_CALCULUS_CHANGE_OF_VARIABLES_DIVERGENCE_STOKES_THEOREM_PROBES,
} from '@/lib/teaching/assets/mathematicsCalculusChangeOfVariablesDivergenceStokesTheoremAssets'
import {
  MATHEMATICS_FUNCTIONS_EXPONENTIAL_INJECTIVITY_SURJECTIVITY_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_EXPONENTIAL_INJECTIVITY_SURJECTIVITY_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsExponentialInjectivitySurjectivityAssets'
import {
  MATHEMATICS_CALC_EXP_DERIV_FUNC_BIJECTION_DOMAIN_RANGE_EXPLANATIONS,
  MATHEMATICS_CALC_EXP_DERIV_FUNC_BIJECTION_DOMAIN_RANGE_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcExpDerivFuncBijectionDomainRangeAssets'
import {
  MATHEMATICS_FUNCTIONS_INVERSE_NOTATION_COMPOSITION_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_INVERSE_NOTATION_COMPOSITION_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsInverseNotationCompositionAssets'
import {
...
} from '@/lib/teaching/assets/mathematicsFunctionsLogarithmicOperationsMonotonicAssets'
import {
  MATHEMATICS_CALC_DERIV_LN_FUNC_PERIODIC_PIECEWISE_EXPLANATIONS,
  MATHEMATICS_CALC_DERIV_LN_FUNC_PERIODIC_PIECEWISE_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcDerivLnFuncPeriodicPiecewiseAssets'
import {
  MATHEMATICS_CALC_LOG_DIFF_TRIG_INVERSE_IDENTITIES_EXPLANATIONS,
  MATHEMATICS_CALC_LOG_DIFF_TRIG_INVERSE_IDENTITIES_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcLogDiffTrigInverseIdentitiesAssets'
import {
  MATHEMATICS_CALC_DERIV_INV_TRIG_HYPERBOLIC_TRIG_EQ_EXPLANATIONS,
  MATHEMATICS_CALC_DERIV_INV_TRIG_HYPERBOLIC_TRIG_EQ_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcDerivInvTrigHyperbolicTrigEqAssets'
import {
  MATHEMATICS_CALC_HYPERBOLIC_DERIV_TRIG_SUM_DIFF_BASIC_RATIOS_EXPLANATIONS,
  MATHEMATICS_CALC_HYPERBOLIC_DERIV_TRIG_SUM_DIFF_BASIC_RATIOS_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcHyperbolicDerivTrigSumDiffBasicRatiosAssets'
import {
  MATHEMATICS_TRIG_DOUBLE_ANGLE_PRODUCT_TO_SUM_SPECIAL_ANGLES_EXPLANATIONS,
  MATHEMATICS_TRIG_DOUBLE_ANGLE_PRODUCT_TO_SUM_SPECIAL_ANGLES_PROBES,
} from '@/lib/teaching/assets/mathematicsTrigDoubleAngleProductToSumSpecialAnglesAssets'
import {
  MATHEMATICS_CALC_TRIG_INTEGRALS_TRIG_POLAR_HALF_ANGLE_EXPLANATIONS,
  MATHEMATICS_CALC_TRIG_INTEGRALS_TRIG_POLAR_HALF_ANGLE_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcTrigIntegralsTrigPolarHalfAngleAssets'
import {
  MATHEMATICS_CALC_TRIG_SUBSTITUTION_DE_MOIVRE_EULERS_FORMULA_EXPLANATIONS,
  MATHEMATICS_CALC_TRIG_SUBSTITUTION_DE_MOIVRE_EULERS_FORMULA_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcTrigSubstitutionDeMoivreEulersFormulaAssets'
import {
  MATHEMATICS_CALC_PARTIAL_FRACTIONS_TRIG_ANGLE_MEASURE_AMPLITUDE_PERIOD_EXPLANATIONS,
  MATHEMATICS_CALC_PARTIAL_FRACTIONS_TRIG_ANGLE_MEASURE_AMPLITUDE_PERIOD_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcPartialFractionsTrigAngleMeasureAmplitudePeriodAssets'
import {
  MATHEMATICS_TRIG_LAW_COSINES_SINES_DEGREE_RADIAN_EXPLANATIONS,
  MATHEMATICS_TRIG_LAW_COSINES_SINES_DEGREE_RADIAN_PROBES,
} from '@/lib/teaching/assets/mathematicsTrigLawCosinesSinesDegreeRadianAssets'
import {
  MATHEMATICS_TRIG_PYTHAGOREAN_RECIPROCAL_REFERENCE_GRAPHS_EXPLANATIONS,
  MATHEMATICS_TRIG_PYTHAGOREAN_RECIPROCAL_REFERENCE_GRAPHS_PROBES,
} from '@/lib/teaching/assets/mathematicsTrigPythagoreanReciprocalReferenceGraphsAssets'
import {
  MATHEMATICS_FUNCTIONS_REAL_VALUED_GRAPH_LINEAR_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_REAL_VALUED_GRAPH_LINEAR_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsRealValuedGraphLinearAssets'
import {
  MATHEMATICS_FUNCTIONS_QUADRATIC_ZERO_TRANSFORMATIONS_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_QUADRATIC_ZERO_TRANSFORMATIONS_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsQuadraticZeroTransformationsAssets'
import {
  MATHEMATICS_FUNCTIONS_POLYNOMIAL_VERTEX_FORM_EVEN_ODD_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_POLYNOMIAL_VERTEX_FORM_EVEN_ODD_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsPolynomialVertexFormEvenOddAssets'
import {
  MATHEMATICS_FUNCTIONS_END_BEHAVIOR_RATIONAL_STEP_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_END_BEHAVIOR_RATIONAL_STEP_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsEndBehaviorRationalStepAssets'
import {
  MATHEMATICS_FUNCTIONS_VERTICAL_HORIZONTAL_ASYMPTOTE_RATIONAL_ROOT_EXPLANATIONS,
  MATHEMATICS_FUNCTIONS_VERTICAL_HORIZONTAL_ASYMPTOTE_RATIONAL_ROOT_PROBES,
} from '@/lib/teaching/assets/mathematicsFunctionsVerticalHorizontalAsymptoteRationalRootAssets'
import {
  MATHEMATICS_SEQ_SEQUENCE_EXPLANATIONS,
  MATHEMATICS_SEQ_SEQUENCE_PROBES,
} from '@/lib/teaching/assets/mathematicsSeqSequenceAssets'
import {
  MATHEMATICS_SEQ_SERIES_CONVERGENT_ARITHMETIC_EXPLANATIONS,
  MATHEMATICS_SEQ_SERIES_CONVERGENT_ARITHMETIC_PROBES,
} from '@/lib/teaching/assets/mathematicsSeqSeriesConvergentArithmeticAssets'
import {
  MATHEMATICS_SEQ_PARTIAL_SUMS_GEOMETRIC_ARITHMETIC_SERIES_EXPLANATIONS,
  MATHEMATICS_SEQ_PARTIAL_SUMS_GEOMETRIC_ARITHMETIC_SERIES_PROBES,
} from '@/lib/teaching/assets/mathematicsSeqPartialSumsGeometricArithmeticSeriesAssets'
import {
  MATHEMATICS_SEQ_SERIES_CONVERGENCE_GEOMETRIC_SERIES_CALC_SEQUENCE_LIMITS_EXPLANATIONS,
  MATHEMATICS_SEQ_SERIES_CONVERGENCE_GEOMETRIC_SERIES_CALC_SEQUENCE_LIMITS_PROBES,
} from '@/lib/teaching/assets/mathematicsSeqSeriesConvergenceGeometricSeriesCalcSequenceLimitsAssets'
import {
  MATHEMATICS_CALC_POWER_SERIES_SEQ_RATIO_TEST_ALTERNATING_SERIES_EXPLANATIONS,
  MATHEMATICS_CALC_POWER_SERIES_SEQ_RATIO_TEST_ALTERNATING_SERIES_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcPowerSeriesSeqRatioTestAlternatingSeriesAssets'
import {
  MATHEMATICS_CALC_RADIUS_CONVERGENCE_TAYLOR_SERIES_FOURIER_SERIES_INTRO_EXPLANATIONS,
  MATHEMATICS_CALC_RADIUS_CONVERGENCE_TAYLOR_SERIES_FOURIER_SERIES_INTRO_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcRadiusConvergenceTaylorSeriesFourierSeriesIntroAssets'
import {
  MATHEMATICS_CALC_MACLAURIN_SERIES_TAYLOR_REMAINDER_SEQ_DIVERGENCE_TEST_EXPLANATIONS,
  MATHEMATICS_CALC_MACLAURIN_SERIES_TAYLOR_REMAINDER_SEQ_DIVERGENCE_TEST_PROBES,
} from '@/lib/teaching/assets/mathematicsCalcMaclaurinSeriesTaylorRemainderSeqDivergenceTestAssets'
import {
  MATHEMATICS_SEQ_COMPARISON_TEST_ROOT_TEST_HARMONIC_SERIES_EXPLANATIONS,
  MATHEMATICS_SEQ_COMPARISON_TEST_ROOT_TEST_HARMONIC_SERIES_PROBES,
} from '@/lib/teaching/assets/mathematicsSeqComparisonTestRootTestHarmonicSeriesAssets'
import {
  MATHEMATICS_SEQ_INTEGRAL_TEST_ABSOLUTE_CONVERGENCE_TELESCOPING_SERIES_EXPLANATIONS,
  MATHEMATICS_SEQ_INTEGRAL_TEST_ABSOLUTE_CONVERGENCE_TELESCOPING_SERIES_PROBES,
} from '@/lib/teaching/assets/mathematicsSeqIntegralTestAbsoluteConvergenceTelescopingSeriesAssets'
import {
...
} from '@/lib/teaching/assets/mathematicsSeqRecursiveSequencesDivergentSequenceInfiniteGeometricSeriesAssets'
import {
  MATHEMATICS_PROB_VARIANCE_INDEPENDENCE_MOMENTS_EXPLANATIONS,
  MATHEMATICS_PROB_VARIANCE_INDEPENDENCE_MOMENTS_PROBES,
} from '@/lib/teaching/assets/mathematicsProbVarianceIndependenceMomentsAssets'
import {
  MATHEMATICS_PROB_TOTAL_PROBABILITY_CHEBYSHEV_MGF_EXPLANATIONS,
  MATHEMATICS_PROB_TOTAL_PROBABILITY_CHEBYSHEV_MGF_PROBES,
} from '@/lib/teaching/assets/mathematicsProbTotalProbabilityChebyshevMgfAssets'
import {
  MATHEMATICS_PROB_BAYES_THEOREM_LLN_MARKOV_CHAIN_EXPLANATIONS,
  MATHEMATICS_PROB_BAYES_THEOREM_LLN_MARKOV_CHAIN_PROBES,
} from '@/lib/teaching/assets/mathematicsProbBayesTheoremLlnMarkovChainAssets'
import {
  MATHEMATICS_PROB_SAMPLE_SPACE_LINEARITY_EXPECTATION_STANDARD_DEVIATION_EXPLANATIONS,
  MATHEMATICS_PROB_SAMPLE_SPACE_LINEARITY_EXPECTATION_STANDARD_DEVIATION_PROBES,
} from '@/lib/teaching/assets/mathematicsProbSampleSpaceLinearityExpectationStandardDeviationAssets'
import {
...
} from '@/lib/teaching/assets/mathematicsProbEventBayesianInferenceLawOfUnconsciousAssets'
import {
  MATHEMATICS_PROB_PROBABILITY_MEASURE_MARKOV_INEQUALITY_EXPLANATIONS,
  MATHEMATICS_PROB_PROBABILITY_MEASURE_MARKOV_INEQUALITY_PROBES,
} from '@/lib/teaching/assets/mathematicsProbProbabilityMeasureMarkovInequalityAssets'
import {
  MATHEMATICS_PROB_PROBABILITY_AXIOMS_EXPLANATIONS,
  MATHEMATICS_PROB_PROBABILITY_AXIOMS_PROBES,
} from '@/lib/teaching/assets/mathematicsProbProbabilityAxiomsAssets'
import {
...
} from '@/lib/teaching/assets/mathematicsLinalgVectorMatrixInverseEigenvaluesAssets'
import {
...
} from '@/lib/teaching/assets/mathematicsLinalgDotProductCramerRuleCharacteristicPolynomialAssets'
import {
  MATHEMATICS_LINALG_MATRIX_NORM_ORTHOGONALITY_EXPLANATIONS,
  MATHEMATICS_LINALG_MATRIX_NORM_ORTHOGONALITY_PROBES,
} from '@/lib/teaching/assets/mathematicsLinalgMatrixNormOrthogonalityAssets'
...
describe('mathematics foundations — newly serving concepts', () => {
  ...
  it('every asset cites the Educational Brain entry it came from', () => {
    for (const a of [...MATHEMATICS_FOUNDATION_EXPLANATIONS, ...MATHEMATICS_FOUNDATION_PROBES, ...MATHEMATICS_ARITHMETIC_PROBES, ...MATHEMATICS_BATCH3_PROBES, ...MATHEMATICS_GEOMETRY_PROBES, ...MATHEMATICS_FRACTION_PROBES, ...MATHEMATICS_PROPORTION_PROBES, ...MATHEMATICS_ALGEBRA_VOCAB_PROBES, ...MATHEMATICS_POWERS_VARIATION_PROBES, ...MATHEMATICS_SET_OPERATIONS_PROBES, ...MATHEMATICS_RELATIONS_NUMBERS_PROBES, ...MATHEMATICS_ORDERS_PROOFS_PROBES, ...MATHEMATICS_LANGUAGE_STRATEGY_PROBES, ...MATHEMATICS_PROOF_MACHINERY_PROBES, ...MATHEMATICS_QUANTIFIER_CRAFT_PROBES, ...MATHEMATICS_FOUNDATIONS_CLOSE_PROBES, ...MATHEMATICS_NUMBER_SYSTEMS_PROBES, ...MATHEMATICS_ALGORITHMS_PRECISION_PROBES, ...MATHEMATICS_ARITH_CLOSE_PROBES, ...MATHEMATICS_MEASUREMENT_PROBES, ...MATHEMATICS_COORDINATE_PROBES, ...MATHEMATICS_NUMBER_THEORY_PROBES, ...MATHEMATICS_TRIANGLE_TRANSFORM_PROBES, ...MATHEMATICS_DIVISIBILITY_MODULAR_PROBES, ...MATHEMATICS_CRYPTO_NUMBER_PROBES, ...MATHEMATICS_ANALYTIC_ALGEBRAIC_PROBES, ...MATHEMATICS_SOLIDS_POLYGONS_PROBES, ...MATHEMATICS_CIRCLES_TRANSFORM_PROBES, ...MATHEMATICS_VECTORS_CONICS_PROBES, ...MATHEMATICS_DIFF_GEOM_PROBES, ...MATHEMATICS_CATEGORY_FOUNDATIONS_PROBES, ...MATHEMATICS_CATEGORY_MORPHISM_PROBES, ...MATHEMATICS_CATEGORY_STRUCTURE_PROBES, ...MATHEMATICS_CATEGORY_LIMITS_PROBES, ...MATHEMATICS_CATEGORY_ADJUNCTION_PROBES, ...MATHEMATICS_CATEGORY_MONAD_PROBES, ...MATHEMATICS_CATEGORY_CLOSURE_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_FOUNDATIONS_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_GROUP_OPS_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_SUBGROUP_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_ORDER_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_RING_HOM_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_ACTION_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_QUOTIENT_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_IDEAL_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_PRIME_EUCLID_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_FIELD_PID_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_UFD_QUOTIENT_RING_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_HOM_ISO_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_FIT_LAGRANGE_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_ISO_FINITE_FIELD_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_ALT_GROUP_FIELD_EXT_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_BURNSIDE_SYLOW_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_ALG_EXT_GALOIS_PROBES, ...MATHEMATICS_ABSTRACT_ALGEBRA_GALOIS_GROUP_CORRESPONDENCE_PROBES, ...MATHEMATICS_ALGEBRA_SIMPLIFY_LINEAR_PROBES, ...MATHEMATICS_ALGEBRA_INEQUALITY_RADICALS_PROBES, ...MATHEMATICS_ALGEBRA_POLY_OPS_EXP_FUNC_PROBES, ...MATHEMATICS_ALGEBRA_COMPLETE_SQUARE_POLY_DIV_PROBES, ...MATHEMATICS_ALGEBRA_SYSTEMS_LOGARITHM_PROBES, ...MATHEMATICS_ALGEBRA_REMAINDER_QUADRATIC_PROBES, ...MATHEMATICS_ALGEBRA_FACTOR_DISCRIMINANT_PROBES, ...MATHEMATICS_ALGEBRA_FACTORING_ROOTS_PROBES, ...MATHEMATICS_ALGEBRA_RATIONAL_FTA_PROBES, ...MATHEMATICS_ALGEBRA_GCF_RATIONAL_EQ_PROBES, ...MATHEMATICS_ALGEBRA_LOG_PROPS_EXP_EQ_PROBES, ...MATHEMATICS_ALGEBRA_LOG_EQ_CHANGE_BASE_PROBES, ...MATHEMATICS_ALGEBRA_POLY_INEQ_SIMPLIFY_RADICALS_PROBES, ...MATHEMATICS_ALGEBRA_BINOMIAL_TRINOMIALS_PROBES, ...MATHEMATICS_ALGEBRA_PASCALS_RATIONALIZING_PROBES, ...MATHEMATICS_ALGEBRA_FACTORING_SPECIAL_ROOT_THEOREM_PROBES, ...MATHEMATICS_ALGEBRA_VIETAS_COMPLEX_ROOTS_PROBES, ...MATHEMATICS_ALGEBRA_RATIONAL_EXPR_OPS_PROBES, ...MATHEMATICS_ALGEBRA_RAT_INEQ_ABS_VAL_PROBES, ...MATHEMATICS_ALGEBRA_ELIM_SUBST_METHOD_PROBES, ...MATHEMATICS_ALGEBRA_FRAC_EXP_RADICAL_EQ_PROBES, ...MATHEMATICS_ALGEBRA_INEQ2VAR_LOG_SYSTEM3VAR_PROBES, ...MATHEMATICS_CALCULUS_LIMIT_LAWS_CONTINUITY_PROBES, ...MATHEMATICS_CALCULUS_CONTINUITY_TYPES_IVT_DERIV_DEF_PROBES, ...MATHEMATICS_CALCULUS_DERIV_RULES_DIFF_MVT_PROBES, ...MATHEMATICS_CALCULUS_PRODUCT_RULE_CRITICAL_POINTS_INC_DEC_PROBES, ...MATHEMATICS_CALCULUS_LOCAL_EXTREMA_QUOTIENT_HIGHER_ORDER_PROBES, ...MATHEMATICS_CALCULUS_CONCAVITY_OPTIMIZATION_LINEARIZATION_PROBES, ...MATHEMATICS_CALCULUS_LHOPITAL_LIMITS_INFINITY_ROLLES_PROBES, ...MATHEMATICS_CALCULUS_CURVE_SKETCHING_RIEMANN_SQUEEZE_PROBES, ...MATHEMATICS_CALCULUS_DEFINITE_INTEGRAL_TRIG_MULTIVAR_PROBES, ...MATHEMATICS_CALCULUS_FTC_PART1_INTEGRAL_AREA_PARTIAL_DERIV_PROBES, ...MATHEMATICS_CALCULUS_FTC_PART2_GRADIENT_ARC_LENGTH_PROBES, ...MATHEMATICS_CALCULUS_DIRECTIONAL_DERIV_USUB_VOLUME_REV_PROBES, ...MATHEMATICS_CALCULUS_INTEG_BY_PARTS_MULTIVAR_EXTREMA_IMPROPER_EXPLANATIONS, ...MATHEMATICS_CALCULUS_INTEG_BY_PARTS_MULTIVAR_EXTREMA_IMPROPER_PROBES, ...MATHEMATICS_CALCULUS_CHAIN_RULE_MULTIVAR_IMPLICIT_DIFF_MULTIPLE_INTEGRALS_EXPLANATIONS, ...MATHEMATICS_CALCULUS_CHAIN_RULE_MULTIVAR_IMPLICIT_DIFF_MULTIPLE_INTEGRALS_PROBES, ...MATHEMATICS_CALCULUS_RELATED_RATES_REDUCTION_FORMULAS_DOUBLE_INTEGRALS_EXPLANATIONS, ...MATHEMATICS_CALCULUS_RELATED_RATES_REDUCTION_FORMULAS_DOUBLE_INTEGRALS_PROBES, ...MATHEMATICS_CALCULUS_TRIPLE_INTEGRALS_PARAMETRIC_CURVES_SURFACE_AREA_EXPLANATIONS, ...MATHEMATICS_CALCULUS_TRIPLE_INTEGRALS_PARAMETRIC_CURVES_SURFACE_AREA_PROBES, ...MATHEMATICS_CALCULUS_PARAMETRIC_CALC_LINE_INTEGRALS_VECTOR_FIELDS_EXPLANATIONS, ...MATHEMATICS_CALCULUS_PARAMETRIC_CALC_LINE_INTEGRALS_VECTOR_FIELDS_PROBES, ...MATHEMATICS_CALCULUS_GREENS_THEOREM_CURL_DIVERGENCE_SURFACE_INTEGRALS_EXPLANATIONS, ...MATHEMATICS_CALCULUS_GREENS_THEOREM_CURL_DIVERGENCE_SURFACE_INTEGRALS_PROBES, ...MATHEMATICS_CALCULUS_CHANGE_OF_VARIABLES_DIVERGENCE_STOKES_THEOREM_EXPLANATIONS, ...MATHEMATICS_CALCULUS_CHANGE_OF_VARIABLES_DIVERGENCE_STOKES_THEOREM_PROBES, ...MATHEMATICS_FUNCTIONS_EXPONENTIAL_INJECTIVITY_SURJECTIVITY_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_EXPONENTIAL_INJECTIVITY_SURJECTIVITY_PROBES, ...MATHEMATICS_CALC_EXP_DERIV_FUNC_BIJECTION_DOMAIN_RANGE_EXPLANATIONS, ...MATHEMATICS_CALC_EXP_DERIV_FUNC_BIJECTION_DOMAIN_RANGE_PROBES, ...MATHEMATICS_FUNCTIONS_INVERSE_NOTATION_COMPOSITION_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_INVERSE_NOTATION_COMPOSITION_PROBES, ...MATHEMATICS_FUNCTIONS_LOGARITHMIC_OPERATIONS_MONOTONIC_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_LOGARITHMIC_OPERATIONS_MONOTONIC_PROBES, ...MATHEMATICS_CALC_DERIV_LN_FUNC_PERIODIC_PIECEWISE_EXPLANATIONS, ...MATHEMATICS_CALC_DERIV_LN_FUNC_PERIODIC_PIECEWISE_PROBES, ...MATHEMATICS_CALC_LOG_DIFF_TRIG_INVERSE_IDENTITIES_EXPLANATIONS, ...MATHEMATICS_CALC_LOG_DIFF_TRIG_INVERSE_IDENTITIES_PROBES, ...MATHEMATICS_CALC_DERIV_INV_TRIG_HYPERBOLIC_TRIG_EQ_EXPLANATIONS, ...MATHEMATICS_CALC_DERIV_INV_TRIG_HYPERBOLIC_TRIG_EQ_PROBES, ...MATHEMATICS_CALC_HYPERBOLIC_DERIV_TRIG_SUM_DIFF_BASIC_RATIOS_EXPLANATIONS, ...MATHEMATICS_CALC_HYPERBOLIC_DERIV_TRIG_SUM_DIFF_BASIC_RATIOS_PROBES, ...MATHEMATICS_TRIG_DOUBLE_ANGLE_PRODUCT_TO_SUM_SPECIAL_ANGLES_EXPLANATIONS, ...MATHEMATICS_TRIG_DOUBLE_ANGLE_PRODUCT_TO_SUM_SPECIAL_ANGLES_PROBES, ...MATHEMATICS_CALC_TRIG_INTEGRALS_TRIG_POLAR_HALF_ANGLE_EXPLANATIONS, ...MATHEMATICS_CALC_TRIG_INTEGRALS_TRIG_POLAR_HALF_ANGLE_PROBES, ...MATHEMATICS_CALC_TRIG_SUBSTITUTION_DE_MOIVRE_EULERS_FORMULA_EXPLANATIONS, ...MATHEMATICS_CALC_TRIG_SUBSTITUTION_DE_MOIVRE_EULERS_FORMULA_PROBES, ...MATHEMATICS_CALC_PARTIAL_FRACTIONS_TRIG_ANGLE_MEASURE_AMPLITUDE_PERIOD_EXPLANATIONS, ...MATHEMATICS_CALC_PARTIAL_FRACTIONS_TRIG_ANGLE_MEASURE_AMPLITUDE_PERIOD_PROBES, ...MATHEMATICS_TRIG_LAW_COSINES_SINES_DEGREE_RADIAN_EXPLANATIONS, ...MATHEMATICS_TRIG_LAW_COSINES_SINES_DEGREE_RADIAN_PROBES, ...MATHEMATICS_TRIG_PYTHAGOREAN_RECIPROCAL_REFERENCE_GRAPHS_EXPLANATIONS, ...MATHEMATICS_TRIG_PYTHAGOREAN_RECIPROCAL_REFERENCE_GRAPHS_PROBES, ...MATHEMATICS_FUNCTIONS_REAL_VALUED_GRAPH_LINEAR_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_REAL_VALUED_GRAPH_LINEAR_PROBES, ...MATHEMATICS_FUNCTIONS_QUADRATIC_ZERO_TRANSFORMATIONS_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_QUADRATIC_ZERO_TRANSFORMATIONS_PROBES, ...MATHEMATICS_FUNCTIONS_POLYNOMIAL_VERTEX_FORM_EVEN_ODD_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_POLYNOMIAL_VERTEX_FORM_EVEN_ODD_PROBES, ...MATHEMATICS_FUNCTIONS_END_BEHAVIOR_RATIONAL_STEP_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_END_BEHAVIOR_RATIONAL_STEP_PROBES, ...MATHEMATICS_FUNCTIONS_VERTICAL_HORIZONTAL_ASYMPTOTE_RATIONAL_ROOT_EXPLANATIONS, ...MATHEMATICS_FUNCTIONS_VERTICAL_HORIZONTAL_ASYMPTOTE_RATIONAL_ROOT_PROBES, ...MATHEMATICS_SEQ_SEQUENCE_EXPLANATIONS, ...MATHEMATICS_SEQ_SEQUENCE_PROBES, ...MATHEMATICS_SEQ_SERIES_CONVERGENT_ARITHMETIC_EXPLANATIONS, ...MATHEMATICS_SEQ_SERIES_CONVERGENT_ARITHMETIC_PROBES, ...MATHEMATICS_SEQ_PARTIAL_SUMS_GEOMETRIC_ARITHMETIC_SERIES_EXPLANATIONS, ...MATHEMATICS_SEQ_PARTIAL_SUMS_GEOMETRIC_ARITHMETIC_SERIES_PROBES, ...MATHEMATICS_SEQ_SERIES_CONVERGENCE_GEOMETRIC_SERIES_CALC_SEQUENCE_LIMITS_EXPLANATIONS, ...MATHEMATICS_SEQ_SERIES_CONVERGENCE_GEOMETRIC_SERIES_CALC_SEQUENCE_LIMITS_PROBES, ...MATHEMATICS_CALC_POWER_SERIES_SEQ_RATIO_TEST_ALTERNATING_SERIES_EXPLANATIONS, ...MATHEMATICS_CALC_POWER_SERIES_SEQ_RATIO_TEST_ALTERNATING_SERIES_PROBES, ...MATHEMATICS_CALC_RADIUS_CONVERGENCE_TAYLOR_SERIES_FOURIER_SERIES_INTRO_EXPLANATIONS, ...MATHEMATICS_CALC_RADIUS_CONVERGENCE_TAYLOR_SERIES_FOURIER_SERIES_INTRO_PROBES, ...MATHEMATICS_CALC_MACLAURIN_SERIES_TAYLOR_REMAINDER_SEQ_DIVERGENCE_TEST_EXPLANATIONS, ...MATHEMATICS_CALC_MACLAURIN_SERIES_TAYLOR_REMAINDER_SEQ_DIVERGENCE_TEST_PROBES, ...MATHEMATICS_SEQ_COMPARISON_TEST_ROOT_TEST_HARMONIC_SERIES_EXPLANATIONS, ...MATHEMATICS_SEQ_COMPARISON_TEST_ROOT_TEST_HARMONIC_SERIES_PROBES, ...MATHEMATICS_SEQ_INTEGRAL_TEST_ABSOLUTE_CONVERGENCE_TELESCOPING_SERIES_EXPLANATIONS, ...MATHEMATICS_SEQ_INTEGRAL_TEST_ABSOLUTE_CONVERGENCE_TELESCOPING_SERIES_PROBES, ...MATHEMATICS_SEQ_RECURSIVE_SEQUENCES_DIVERGENT_SEQUENCE_INFINITE_GEOMETRIC_SERIES_EXPLANATIONS, ...MATHEMATICS_SEQ_RECURSIVE_SEQUENCES_DIVERGENT_SEQUENCE_INFINITE_GEOMETRIC_SERIES_PROBES, ...MATHEMATICS_PROB_VARIANCE_INDEPENDENCE_MOMENTS_EXPLANATIONS, ...MATHEMATICS_PROB_VARIANCE_INDEPENDENCE_MOMENTS_PROBES, ...MATHEMATICS_PROB_TOTAL_PROBABILITY_CHEBYSHEV_MGF_EXPLANATIONS, ...MATHEMATICS_PROB_TOTAL_PROBABILITY_CHEBYSHEV_MGF_PROBES, ...MATHEMATICS_PROB_BAYES_THEOREM_LLN_MARKOV_CHAIN_EXPLANATIONS, ...MATHEMATICS_PROB_BAYES_THEOREM_LLN_MARKOV_CHAIN_PROBES, ...MATHEMATICS_PROB_SAMPLE_SPACE_LINEARITY_EXPECTATION_STANDARD_DEVIATION_EXPLANATIONS, ...MATHEMATICS_PROB_SAMPLE_SPACE_LINEARITY_EXPECTATION_STANDARD_DEVIATION_PROBES, ...MATHEMATICS_PROB_EVENT_BAYESIAN_INFERENCE_LAW_OF_UNCONSCIOUS_EXPLANATIONS, ...MATHEMATICS_PROB_EVENT_BAYESIAN_INFERENCE_LAW_OF_UNCONSCIOUS_PROBES, ...MATHEMATICS_PROB_PROBABILITY_MEASURE_MARKOV_INEQUALITY_EXPLANATIONS, ...MATHEMATICS_PROB_PROBABILITY_MEASURE_MARKOV_INEQUALITY_PROBES, ...MATHEMATICS_PROB_PROBABILITY_AXIOMS_EXPLANATIONS, ...MATHEMATICS_PROB_PROBABILITY_AXIOMS_PROBES, ...MATHEMATICS_LINALG_VECTOR_MATRIX_INVERSE_EIGENVALUES_EXPLANATIONS, ...MATHEMATICS_LINALG_VECTOR_MATRIX_INVERSE_EIGENVALUES_PROBES, ...MATHEMATICS_LINALG_DOT_PRODUCT_CRAMER_RULE_CHARACTERISTIC_POLYNOMIAL_EXPLANATIONS, ...MATHEMATICS_LINALG_DOT_PRODUCT_CRAMER_RULE_CHARACTERISTIC_POLYNOMIAL_PROBES, ...MATHEMATICS_LINALG_MATRIX_NORM_ORTHOGONALITY_EXPLANATIONS, ...MATHEMATICS_LINALG_MATRIX_NORM_ORTHOGONALITY_PROBES]) {
