...
import { weakCorrectAnswer, weakWrongAnswer } from './weakLearnerAnswers'
...
// The answer generator lives in its own module so a test can import it without
// executing this harness, and so the two can never drift. See its header for
// why it has been repaired twice — the second time because word-boundary
// truncation still produced fragments no human would type.
interface TurnRow {
