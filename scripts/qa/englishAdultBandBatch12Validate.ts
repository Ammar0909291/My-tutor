...
const ENGLISH_BEFORE = [
  ...
  ...ENGLISH_ADULT_BAND_BATCH_2, ...ENGLISH_ADULT_BAND_BATCH_3, ...ENGLISH_ADULT_BAND_BATCH_4,
  ...ENGLISH_ADULT_BAND_BATCH_5, ...ENGLISH_ADULT_BAND_BATCH_6, ...ENGLISH_ADULT_BAND_BATCH_7,
  ...ENGLISH_ADULT_BAND_BATCH_8, ...ENGLISH_ADULT_BAND_BATCH_9, ...ENGLISH_ADULT_BAND_BATCH_10,
  ...ENGLISH_ADULT_BAND_BATCH_11,
]
const ENGLISH_AFTER = [...ENGLISH_BEFORE, ...ENGLISH_ADULT_BAND_BATCH_12]
...
console.log(`Batch size: ${ENGLISH_ADULT_BAND_BATCH_12.length} (expect 27)`)
check(ENGLISH_ADULT_BAND_BATCH_12.length === 27, 'batch size')

for (const p of ENGLISH_ADULT_BAND_BATCH_12) {
...
for (const p of ENGLISH_ADULT_BAND_BATCH_12) stems.set(p.stem, (stems.get(p.stem) ?? 0) + 1)
