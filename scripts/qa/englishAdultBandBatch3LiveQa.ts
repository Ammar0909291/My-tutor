/**
 * Real-learner QA driver for the English ADULT-band probe-contract Batch 3
 * (10 concepts: 6 vocab + 4 grammar, see englishAdultBandBatch3.ts).
 *
 * Same persona and technique as Batch 1/2's live-QA drivers. Deliberately
 ...
 *
 * Run: QA_PASSWORD=... npx tsx scripts/qa/englishAdultBandBatch3LiveQa.ts
 */
...
async function run(): Promise<void> {
  ...
  // Lesson A: eng.grammar.verbs -- nuanced (tense/aspect confusion is a very
  // common weak-learner failure mode), good for genuine confusion + wrong-
  // then-right flow, and a real adult-register grammar concept.
  await runLesson(cookie, 'english', 'eng.grammar.verbs', [
    { msg: "hi, verbs are confusing for me, can you go slow please" },
    { msg: "so a verb is just an action word right?" },
    { msg: "wait, what about words like 'is' or 'seems', those arent actions" },
    { msg: "i dont get it, can you explain differently" },
    { msg: "ok let me try", pickWrong: true },
    { msg: "hmm i think i picked the wrong one, let me think again" },
    { msg: "ok i think i understand now", pickCorrect: true },
    { msg: "thanks that helped" },
    { msg: "can you show me a diagram or chart for this" },
    { msg: "got it, next question please", pickCorrect: true },
  ])

  // Lesson B: eng.vocab.idioms -- nuanced (figurative vs literal meaning is
  // genuinely hard for a weak learner, natural source of confusion).
  await runLesson(cookie, 'english', 'eng.vocab.idioms', [
    { msg: "hi, what is an idiom, im not confident with english" },
    { msg: "so if i say something and mean it literally that IS an idiom right?" },
    { msg: "i dont understand the difference, can you give simple example" },
    { msg: "explain it again in a different way please" },
    { msg: "i dont know", pickWrong: true },
    { msg: "oh wait, i think i misunderstood, let me try again" },
