/**
 * Real-learner QA driver for the English ADULT-band probe-contract Batch 2
 * (10 concepts: 4 phonics/phonetics + 6 vocab, see englishAdultBandBatch2.ts).
 *
 * Same persona and technique as englishAdultBandBatch1LiveQa.ts. Deliberately
 ...
 *
 * Run: QA_PASSWORD=... npx tsx scripts/qa/englishAdultBandBatch2LiveQa.ts
 */
...
async function run(): Promise<void> {
  ...
  // Lesson A: eng.vocab.context-clues -- nuanced (guessing from context vs.
  // revising a guess), good for genuine confusion + wrong-then-right flow.
  await runLesson(cookie, 'english', 'eng.vocab.context-clues', [
    { msg: "hi, im not very confident with vocabulary, please go slow" },
    { msg: "so context clues means guessing a word from nearby words?" },
    { msg: "hmm i dont really get it" },
    { msg: "can you give a simple example" },
    { msg: "i dont know", pickWrong: true },
    { msg: "oh wait, i think i understand it differently now" },
  ...
  // Lesson B: eng.phonetics.articulation-organs -- nuanced (place/manner/
  // voicing), a genuinely difficult concept for a weak learner.
  await runLesson(cookie, 'english', 'eng.phonetics.articulation-organs', [
    { msg: "hi, this sounds hard, what is articulation organs" },
    { msg: "explain simple please, with an example" },
    { msg: "i dont understand voiced vs voiceless" },
    { msg: "can you explain again in a different way" },
    { msg: "ok i think i get it now", pickWrong: true },
    { msg: "oh, i think i picked wrong, let me look again" },
