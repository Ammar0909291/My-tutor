...
const FIGURE_CLAIM_RE = /\b(?:in|on|from) the (?:diagram|figure|picture|animation|graph)\b|\b(?:diagram|figure|picture|animation) (?:above|below|shows|on (?:your|the) screen)\b/i
