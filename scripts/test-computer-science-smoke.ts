/**
 * Phase 4: Computer Science Teaching Engine smoke test — through generic adapter
 * Run: npx tsx scripts/test-computer-science-smoke.ts
 */
import fs from 'fs'
...
const raw = JSON.parse(fs.readFileSync(path.join(ROOT, 'docs/computer-science/kg/graph.json'), 'utf-8'))
...
console.log('\n═══════════════════════════════════════════════════════════')
console.log('PHASE 4 — COMPUTER SCIENCE TEACHING ENGINE SMOKE TEST (10 concepts)')
...
console.log(`\nPhase 4 Computer Science: ${pass ? 'ALL PASS ✓' : 'FAIL ✗'}`)
