...
| `learner-intent-interpreter-ab-experiment.md` | The 2026-09-25 AI learner-intent interpreter A/B experiment (header + `modelOverrideAllowed` gated, deployed inert): design, live 6×2 results, trace-backed root causes (concept-resolver word collisions, example/diagram misreads, follow-ups graded against model-invented MCQs), cleanup. Status: promising evidence, not adopted. |
