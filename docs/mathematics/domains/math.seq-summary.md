...
| Metric | Value |
|--------|-------|
| Domains complete | 8 / 24 |
| Concepts authored | 379 / 908 |
| Concepts remaining | 529 |
| Completion | 41.7% |
...
| Remaining concepts | 529 |
| Avg concepts/domain (remaining) | 33 |
| Estimated sessions at current pace | ~16 (1 domain/session) |
