...
**Status: design only.** Catalog of high-frequency learner misconceptions, the lesson(s) where each
must be confronted, and the correction strategy. This feeds (later, not now) the runtime
`MistakeRecord` categories and Tutor Max remediation — no code here.
...
- **"Energy–time uncertainty means energy isn't conserved."**
  ...
  → Strategy: lifetime–linewidth examples. Anchor: **L17.2**.
...
- **"Collapse is a physical force/signal that propagates."**
  ...
  → Strategy: contrast with entanglement + no-signaling. Anchor: **L10.3, L19.3**.
- **"The system 'decides' its value only because a conscious observer looks."**
  ...
  → Strategy: decoherence framing. Anchor: **L10.3, L26.3**.
...
- **"Entanglement lets you send information faster than light."**
  ...
  → Strategy: no-signaling theorem, reduced density matrix. Anchor: **L19.2, L19.4, L23.2**.
- **"Entangled particles each secretly carry predetermined values (local hidden variables)."**
  ...
  → Strategy: walk through a Bell/CHSH bound and its experimental violation. Anchor: **L19.3**.
- **"Measuring one particle physically yanks the other."**
  ...
  → Strategy: correlation-vs-causation emphasis. Anchor: **L19.2, L19.3**.
...
- **"Tunneling is instantaneous / faster-than-light."**
  ...
  → Strategy: caution against naive speed claims; focus on transmission probability. Anchor: **L8.3, L16.4**.
- **"Wider/taller barriers only change speed, not probability."**
  ...
  → Strategy: parameter-sweep intuition. Anchor: **L8.3, L16.4**.
...
- **"A quantum computer tries all answers simultaneously and reads them out."**
  ...
  → Strategy: amplitude amplification (Grover) framing. Anchor: **L21.4, L20.1**.
- **"Qubits are just probabilistic bits."**
  ...
  randomness.
  → Strategy: Bloch sphere + interference. Anchor: **L20.1, L21.3**.
- **"More qubits always means exponentially faster for everything."**
  ...
  → Strategy: contrast Shor/Grover scope vs. general tasks. Anchor: **L21.5, L24.4**.
- **"Quantum computers are noise-free and you can copy qubits to back them up."**
  ...
  → Strategy: no-cloning + QEC motivation. Anchor: **L20.4, L22.1, L22.2**.
- **"Error correction just means measuring and re-checking the qubit."**
  ...
  → Strategy: syndrome-measurement walkthrough. Anchor: **L22.2, L22.3**.
